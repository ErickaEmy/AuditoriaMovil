...
public class DNSQuestion extends DNSEntry {
    ...
    private static class Pointer extends DNSQuestion {
        ...
        public void addAnswers(JmDNSImpl jmDNSImpl, Set set) {
            ...
            if (isServicesDiscoveryMetaQuery()) {
                ...
                String str = (String) getQualifiedNameMap().get(ServiceInfo.Fields.Instance);
    ...
    protected void addAnswersForServiceInfo(JmDNSImpl jmDNSImpl, Set set, ServiceInfoImpl serviceInfoImpl) {
        ...
        if (getName().equalsIgnoreCase(serviceInfoImpl.getQualifiedName()) || getName().equalsIgnoreCase(serviceInfoImpl.getType()) || getName().equalsIgnoreCase(serviceInfoImpl.getTypeWithSubtype())) {
            ...
            set.addAll(localHost.answers(recordClass, true, i));
            set.addAll(serviceInfoImpl.answers(getRecordClass(), true, i, jmDNSImpl.getLocalHost()));
        }
