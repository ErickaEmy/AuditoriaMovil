        ...
        public String readName() {
            ...
            while (!z) {
                ...
                if (i == 1) {
                    ...
                    String str2 = (String) this._names.get(Integer.valueOf(labelValue));
                    if (str2 == null) {
                        logger1.warn("Bad domain name: possible circular name detected. Bad offset: 0x{} at 0x{}", Integer.toHexString(labelValue), Integer.toHexString(((ByteArrayInputStream) this).pos - 2));
                        str2 = "";
                    }
                    sb.append(str2);
