...
jadx.core.utils.exceptions.JadxRuntimeException: Init of enum PROBING_1 uses external variables
...
public final class DNSState {
    ...
    private DNSState(String str, int i, String str2, StateClass stateClass) {
        this._name = str2;
