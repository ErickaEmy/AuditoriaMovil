...
public final class JsonObject extends JsonElement implements Map, KMappedMarker {
    ...
    public String toString() {
        ...
        joinToString$default = CollectionsKt___CollectionsKt.joinToString$default(this.content.entrySet(), ",", "{", "}", 0, null, new Function1() { // from class: kotlinx.serialization.json.JsonObject$toString$1
