...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo2291scheduleResumeAfterDelay(long j, CancellableContinuation cancellableContinuation) {
        this.$$delegate_0.mo2291scheduleResumeAfterDelay(j, cancellableContinuation);
    }
    ...
    public void mo2290dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        this.dispatcher.mo2290dispatch(this, new Worker(obtainTaskOrDeallocateWorker));
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo2290dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
