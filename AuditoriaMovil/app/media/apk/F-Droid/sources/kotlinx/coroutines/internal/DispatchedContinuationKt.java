    ...
    public static final void resumeCancellableWith(Continuation continuation, Object obj, Function1 function1) {
        if (continuation instanceof DispatchedContinuation) {
            ...
            if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
                ...
                dispatchedContinuation.dispatcher.mo2290dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
                return;
            }
            ...
            if (!eventLoop$kotlinx_coroutines_core.isUnconfinedLoopActive()) {
                ...
                try {
                    ...
                    if (job != null && !job.isActive()) {
                        ...
                        dispatchedContinuation.resumeWith(Result.m2081constructorimpl(ResultKt.createFailure(cancellationException)));
                    } else {
