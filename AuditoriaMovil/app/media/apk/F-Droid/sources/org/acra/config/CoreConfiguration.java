...
public final class CoreConfiguration implements Serializable, Configuration {
    ...
    public /* synthetic */ CoreConfiguration(String str, boolean z, List list, int i, List list2, List list3, boolean z2, boolean z3, List list4, boolean z4, boolean z5, boolean z6, List list5, List list6, Class cls, String str2, int i2, Directory directory, Class cls2, boolean z7, List list7, Class cls3, String str3, String str4, StringFormat stringFormat, boolean z8, PluginLoader pluginLoader, List list8, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : str, (i3 & 2) != 0 ? false : z, (i3 & 4) != 0 ? CollectionsKt__CollectionsKt.emptyList() : list, (i3 & 8) != 0 ? 5 : i, (i3 & 16) != 0 ? CollectionsKt__CollectionsKt.listOf((Object[]) new String[]{"-t", "100", "-v", "time"}) : list2, (i3 & 32) != 0 ? CollectionsKt___CollectionsKt.toList(ACRAConstants.DEFAULT_REPORT_FIELDS) : list3, (i3 & 64) != 0 ? true : z2, (i3 & 128) != 0 ? false : z3, (i3 & 256) != 0 ? CollectionsKt__CollectionsKt.emptyList() : list4, (i3 & 512) != 0 ? true : z4, (i3 & 1024) != 0 ? false : z5, (i3 & 2048) != 0 ? true : z6, (i3 & PKIFailureInfo.certConfirmed) != 0 ? CollectionsKt__CollectionsKt.emptyList() : list5, (i3 & 8192) != 0 ? CollectionsKt__CollectionsKt.emptyList() : list6, (i3 & 16384) != 0 ? null : cls, (i3 & 32768) != 0 ? null : str2, (i3 & PKIFailureInfo.notAuthorized) != 0 ? 100 : i2, (i3 & PKIFailureInfo.unsupportedVersion) != 0 ? Directory.FILES_LEGACY : directory, (i3 & PKIFailureInfo.transactionIdInUse) != 0 ? DefaultRetryPolicy.class : cls2, (i3 & PKIFailureInfo.signerNotTrusted) != 0 ? false : z7, (i3 & PKIFailureInfo.badCertTemplate) != 0 ? CollectionsKt__CollectionsKt.emptyList() : list7, (i3 & PKIFailureInfo.badSenderNonce) != 0 ? DefaultAttachmentProvider.class : cls3, (i3 & 4194304) != 0 ? null : str3, (i3 & 8388608) != 0 ? null : str4, (i3 & 16777216) != 0 ? StringFormat.JSON : stringFormat, (i3 & 33554432) != 0 ? true : z8, (i3 & 67108864) != 0 ? new ServicePluginLoader() : pluginLoader, (i3 & 134217728) != 0 ? CollectionsKt__CollectionsKt.emptyList() : list8);
    }
}
