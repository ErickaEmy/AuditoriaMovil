...
public class SecP256R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (!isOne) {
            ...
            SecP256R1Field.multiply(iArr6, secP256R1FieldElement5.x, iArr6, createExt);
        }
        if (!isOne2) {
            int[] iArr7 = secP256R1FieldElement9.x;
            SecP256R1Field.multiply(iArr7, secP256R1FieldElement6.x, iArr7, createExt);
        }
    ...
    public ECPoint twice() {
        ...
        if (!isOne) {
            ...
            SecP256R1Field.multiply(iArr6, secP256R1FieldElement3.x, iArr6, createExt);
        }
