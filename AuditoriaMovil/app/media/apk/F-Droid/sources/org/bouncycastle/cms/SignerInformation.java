...
public class SignerInformation {
    ...
    protected final SignerInfo f45info;
    ...
    public SignerInformation(SignerInformation signerInformation) {
        this(signerInformation, signerInformation.f45info);
    }
    ...
    public static SignerInformation addCounterSigners(SignerInformation signerInformation, SignerInformationStore signerInformationStore) {
        SignerInfo signerInfo = signerInformation.f45info;
    ...
    private boolean doVerify(SignerInformationVerifier signerInformationVerifier) throws CMSException {
        ...
        try {
            ContentVerifier contentVerifier = signerInformationVerifier.getContentVerifier(this.encryptionAlgorithm, this.f45info.getDigestAlgorithm());
            try {
    ...
    private void verifyAlgorithmIdentifierProtectionAttribute(AttributeTable attributeTable) throws CMSException {
        ...
        if (attributeTable != null) {
            ...
            if (all.size() > 0) {
                ...
                if (!CMSUtils.isEquivalent(cMSAlgorithmProtection.getDigestAlgorithm(), this.f45info.getDigestAlgorithm())) {
                    throw new CMSException("CMS Algorithm Identifier Protection check failed for digestAlgorithm");
                }
                if (!CMSUtils.isEquivalent(cMSAlgorithmProtection.getSignatureAlgorithm(), this.f45info.getDigestEncryptionAlgorithm())) {
    ...
    public int getVersion() {
        return this.f45info.getVersion().intValueExact();
    }
