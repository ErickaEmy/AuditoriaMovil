...
class ErrorCorrection {
    ...
    public static void helpRec(short[] sArr, short[] sArr2, byte[] bArr, byte b) {
        ...
        while (i < 256) {
            ...
            int i6 = ~f;
            int i7 = (iArr[1] & i6) ^ (iArr[5] & f);
            int i8 = (iArr[2] & i6) ^ (iArr[6] & f);
            int i9 = (iArr[7] & f) ^ (iArr[3] & i6);
            sArr[i] = (short) ((((i6 & iArr[0]) ^ (iArr[4] & f)) - i9) & 3);
            sArr[i3] = (short) ((i7 - i9) & 3);
            sArr[i4] = (short) ((i8 - i9) & 3);
            sArr[i5] = (short) (((-f) + (i9 * 2)) & 3);
            i++;
            s = 8;
        }
    }
    ...
    public static void rec(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            int i6 = i + 512;
            int i7 = i >>> 3;
            bArr[i7] = (byte) ((LDDecode(i3, i5, ((sArr[i6] * 8) + 196624) - (((sArr2[i6] * 2) + s) * 12289), ((sArr[i2] * 8) + 196624) - (s * 12289)) << (i & 7)) | bArr[i7]);
        }
    }
}
