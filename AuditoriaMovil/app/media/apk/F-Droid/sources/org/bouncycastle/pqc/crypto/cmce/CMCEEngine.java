        ...
        if (j3 <= 10) {
            ...
            for (long j23 = 1; j22 < j3 - j23; j23 = 1) {
                ...
                for (long j28 = 0; j28 < j6; j28++) {
                    int i21 = (int) (j6 + j28);
                    int i22 = iArr[i21];
                    int i23 = (i22 & (-65536)) | (iArr[(int) j28] & 65535);
                    if (i23 < i22) {
                        iArr[i21] = i23;
                    }
                }
    ...
    private int mov_columns(byte[][] bArr, short[] sArr, long[] jArr) {
        ...
        if (this.usePadding) {
            for (int i7 = 0; i7 < 32; i7++) {
                ...
                while (i9 < 8) {
                    int i10 = i9 + 1;
                    bArr3[i9] = (byte) (((bArr3[i9] & 255) >> i6) | (bArr3[i10] << (8 - i6)));
                    i9 = i10;
                }
        ...
        while (i20 < this.PK_NROWS) {
            if (this.usePadding) {
                ...
                while (i22 < 8) {
                    int i23 = i22 + 1;
                    bArr4[i22] = (byte) (((bArr4[i22] & 255) >> i6) | (bArr4[i23] << (8 - i6)));
                    i22 = i23;
                }
                bArr2 = bArr4;
            ...
            if (this.usePadding) {
                ...
                int i25 = i5 + 8;
                int i26 = 8 - i6;
                bArr5[i25] = (byte) ((((bArr5[i25] & 255) >>> i6) << i6) | ((bArr2[7] & 255) >>> i26));
                bArr5[i5] = (byte) (((bArr2[0] & 255) << i6) | (((bArr5[i5] & 255) << i26) >>> i26));
                for (int i27 = 7; i27 >= 1; i27--) {
                    bArr[i20][i5 + i27] = (byte) (((bArr2[i27] & 255) << i6) | ((bArr2[i27 - 1] & 255) >>> i26));
                }
            } else {
    ...
    private int pk_gen(byte[] bArr, byte[] bArr2, int[] iArr, short[] sArr, long[] jArr) {
        ...
        while (true) {
                    ...
                    if (this.usePadding) {
                        ...
                        while (true) {
                            ...
                            while (i24 < (this.SYS_N / 8) - 1) {
                                ...
                                i24++;
                                bArr[i22] = (byte) ((bArr4[i24] << (8 - i20)) | ((bArr4[i24] & 255) >>> i20));
                                i22++;
                            }
                        ...
                        for (int i25 = 0; i25 < this.PK_NROWS; i25++) {
                            ...
                            while (true) {
                                ...
                                if (i26 < ((i28 - i29) + 7) / 8) {
                                    bArr[((((i28 - i29) + 7) / 8) * i25) + i27] = bArr3[i25][(i29 / 8) + i26];
                                    i27++;
                                    i26++;
                                }
                            }
            ...
            for (int i30 = 0; i30 < 8; i30++) {
                int i31 = (i18 * 8) + i30;
                int i32 = this.PK_NROWS;
                if (i31 >= i32) {
                    break;
                }
                if (this.usePivots && i31 == i32 - 32) {
                    if (mov_columns(bArr3, sArr, jArr) != 0) {
                        return -1;
                    }
                }
                for (int i33 = i31 + 1; i33 < this.PK_NROWS; i33++) {
                    byte b = (byte) (-((byte) (((byte) (((byte) (bArr3[i31][i18] ^ bArr3[i33][i18])) >> i30)) & 1)));
                    for (int i34 = 0; i34 < this.SYS_N / 8; i34++) {
                        byte[] bArr5 = bArr3[i31];
                        bArr5[i34] = (byte) (bArr5[i34] ^ (bArr3[i33][i34] & b));
                    }
                }
                if (((bArr3[i31][i18] >> i30) & 1) == 0) {
                    return -1;
                }
                for (int i35 = 0; i35 < this.PK_NROWS; i35++) {
                    if (i35 != i31) {
                        byte b2 = (byte) (-((byte) (((byte) (bArr3[i35][i18] >> i30)) & 1)));
                        for (int i36 = 0; i36 < this.SYS_N / 8; i36++) {
                            byte[] bArr6 = bArr3[i35];
                            bArr6[i36] = (byte) (bArr6[i36] ^ (bArr3[i31][i36] & b2));
                        }
                    }
                }
            }
        ...
        if (length <= i9 + 40) {
            ...
            if (this.usePivots) {
                ...
                for (int i14 = 0; i14 < (1 << this.GFBITS); i14++) {
                    ...
                    long j3 = j2 | i14;
                    jArr[i14] = j3;
                    jArr[i14] = j3 & Preferences.UPDATE_INTERVAL_DISABLED;
                }
                sort64(jArr, 0, i13);
