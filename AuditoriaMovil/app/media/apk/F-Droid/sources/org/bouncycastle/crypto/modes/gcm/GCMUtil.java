...
public abstract class GCMUtil {
    ...
    public static int areEqual(int[] iArr, int[] iArr2) {
        int i = iArr[0];
        int i2 = iArr[2];
        int i3 = (iArr[3] ^ iArr2[3]) | (iArr2[0] ^ i) | (iArr[1] ^ iArr2[1]) | (iArr2[2] ^ i2);
    ...
    public static void multiply(byte[] bArr, long[] jArr) {
        ...
        long j4 = implMul643 >>> 2;
        Pack.longToBigEndian(reverse5 ^ ((j4 ^ ((implMul643 >>> 1) ^ implMul643)) ^ (implMul643 >>> 7)), bArr, 0);
        Pack.longToBigEndian(((Longs.reverse(implMul64(reverse ^ reverse2, reverse3 ^ reverse4)) ^ ((implMul64 ^ reverse5) ^ reverse6)) ^ (((j3 ^ (j3 >>> 1)) ^ (j3 >>> 2)) ^ (j3 >>> 7))) ^ ((implMul643 << 57) ^ ((implMul643 << 63) ^ (implMul643 << 62))), bArr, 8);
    }
    ...
    public static void multiply(long[] jArr, long[] jArr2) {
        ...
        jArr[1] = j7 ^ ((Longs.reverse(implMul64(reverse ^ reverse2, reverse3 ^ reverse4)) ^ ((implMul64 ^ reverse5) ^ reverse6)) ^ (((j5 ^ (j5 >>> 1)) ^ (j5 >>> 2)) ^ (j5 >>> 7)));
    }
