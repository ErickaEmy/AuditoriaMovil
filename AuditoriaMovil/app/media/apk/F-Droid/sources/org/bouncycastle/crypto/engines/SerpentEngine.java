...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int[] iArr = {this.wKey[128] ^ Pack.littleEndianToInt(bArr, i), this.wKey[129] ^ Pack.littleEndianToInt(bArr, i + 4), this.wKey[130] ^ Pack.littleEndianToInt(bArr, i + 8), Pack.littleEndianToInt(bArr, i + 12) ^ this.wKey[131]};
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToLittleEndian(this.wKey[0] ^ iArr[0], bArr2, i2);
