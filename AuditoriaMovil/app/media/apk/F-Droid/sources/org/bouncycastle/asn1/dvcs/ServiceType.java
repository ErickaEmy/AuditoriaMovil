...
public class ServiceType extends ASN1Object {
    ...
    public String toString() {
        ...
        sb.append(intValueExact == CPD.value.intValueExact() ? "(CPD)" : intValueExact == VSD.value.intValueExact() ? "(VSD)" : intValueExact == VPKC.value.intValueExact() ? "(VPKC)" : intValueExact == CCPD.value.intValueExact() ? "(CCPD)" : CallerData.NA);
        return sb.toString();
    }
}
