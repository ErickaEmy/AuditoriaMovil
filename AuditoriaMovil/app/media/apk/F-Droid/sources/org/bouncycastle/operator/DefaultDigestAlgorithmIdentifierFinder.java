...
public class DefaultDigestAlgorithmIdentifierFinder implements DigestAlgorithmIdentifierFinder {
    ...
    static {
        ...
        digestNameToOids.put("SHAKE128", aSN1ObjectIdentifier46);
        digestNameToOids.put("SHAKE256", aSN1ObjectIdentifier42);
        digestNameToOids.put("SHAKE-128", aSN1ObjectIdentifier46);
        ...
        digestNameToOids.put("SM3", aSN1ObjectIdentifier44);
