...
public class RijndaelEngine implements BlockCipher {
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            j |= ((((mul0xe(i7) ^ mul0xb(i8)) ^ mul0xd(i9)) ^ mul0x9(i6)) & GF2Field.MASK) << i;
            j4 |= ((((mul0xe(i8) ^ mul0xb(i9)) ^ mul0xd(i6)) ^ mul0x9(i7)) & GF2Field.MASK) << i;
            j2 |= ((((mul0xe(i9) ^ mul0xb(i6)) ^ mul0xd(i7)) ^ mul0x9(i8)) & GF2Field.MASK) << i;
            j3 = (((((mul0xe(i6) ^ mul0xb(i7)) ^ mul0xd(i8)) ^ mul0x9(i9)) & GF2Field.MASK) << i) | j5;
        }
        this.A0 = j;
        this.A1 = j4;
        this.A2 = j2;
    ...
    private void MixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            long j5 = j3;
            int i5 = (int) ((this.A3 >> i) & 255);
            j |= ((((mul0x2(i2) ^ mul0x3(i3)) ^ i4) ^ i5) & GF2Field.MASK) << i;
            j4 |= ((((mul0x2(i3) ^ mul0x3(i4)) ^ i5) ^ i2) & GF2Field.MASK) << i;
            j2 |= ((((mul0x2(i4) ^ mul0x3(i5)) ^ i2) ^ i3) & GF2Field.MASK) << i;
            j3 = (((((mul0x2(i5) ^ mul0x3(i2)) ^ i3) ^ i4) & GF2Field.MASK) << i) | j5;
        }
        this.A0 = j;
        this.A1 = j4;
        this.A2 = j2;
