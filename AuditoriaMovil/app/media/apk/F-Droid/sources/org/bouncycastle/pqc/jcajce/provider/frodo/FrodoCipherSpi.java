    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws InvalidKeyException, NoSuchAlgorithmException {
        if (i == 3) {
            try {
                ...
                byte[] extractSecret = frodoKEMExtractor.extractSecret(Arrays.copyOfRange(bArr, 0, frodoKEMExtractor.getInputSize()));
                ...
                byte[] copyOfRange = Arrays.copyOfRange(bArr, frodoKEMExtractor.getInputSize(), bArr.length);
