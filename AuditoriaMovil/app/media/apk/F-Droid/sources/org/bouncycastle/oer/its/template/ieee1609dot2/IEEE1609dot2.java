...
public class IEEE1609dot2 {
    ...
    static {
        ...
        OERDefinition.Builder typeName22 = OERDefinition.choice(typeName21.label("linkageData"), Ieee1609Dot2BaseTypes.Hostname.label("name"), OERDefinition.octets(1, 64).label("binaryId"), OERDefinition.nullValue().label(ZipSigner.KEY_NONE), OERDefinition.extension(new Object[0])).typeName("CertificateId");
        ...
        OERDefinition.Builder typeName24 = OERDefinition.choice(builder3.label("sha256AndDigest"), builder5.label("self"), OERDefinition.extension(builder3.label("sha384AndDigest"))).typeName("IssuerIdentifier");
        ...
        OERDefinition.Builder typeName26 = OERDefinition.seq(builder6.label("version"), typeName25.label(BonjourPeer.TYPE), typeName24.label("issuer"), typeName23.label("toBeSigned"), OERDefinition.optional(builder7.label("signature"))).label("signature").typeName("CertificateBase");
        CertificateBase = typeName26;
        OERDefinition.Builder typeName27 = typeName26.copy().typeName("Certificate");
        Certificate = typeName27;
        ExplicitCertificate = typeName26.typeName("ExplicitCertificate").replaceChild(1, typeName25.validSwitchValue(explicitOrdinal).label(BonjourPeer.TYPE));
        ImplicitCertificate = typeName26.typeName("ImplicitCertificate").replaceChild(1, typeName25.validSwitchValue(implicitOrdinal).label(BonjourPeer.TYPE));
