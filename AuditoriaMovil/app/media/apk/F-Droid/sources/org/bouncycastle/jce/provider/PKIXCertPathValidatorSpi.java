                    ...
                    if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) ((X509Certificate) certificates.get(0)))) {
                        ...
                        while (size2 >= 0) {
                            ...
                            try {
                                ...
                                int i19 = i8;
                                RFC3280CertPathUtilities.processCertA(certPath, build, date, provCrlRevocationChecker2, i18, r7, r8, x500Name, trustedCert);
                                ...
                                if (x500Name != i15) {
                                    ...
                                    } else if (x500Name != i19 || !x509Certificate2.equals(trustAnchor2.getTrustedCert())) {
                        ...
                        int i21 = size2;
                        int i22 = i21 + 1;
                        int wrapupCertB = RFC3280CertPathUtilities.wrapupCertB(certPath, i22, RFC3280CertPathUtilities.wrapupCertA(i12, x509Certificate));
                        ...
                        RFC3280CertPathUtilities.wrapupCertF(certPath, i22, list5, hashSet);
                        PKIXPolicyNode wrapupCertG = RFC3280CertPathUtilities.wrapupCertG(certPath, pKIXExtendedParameters3, initialPolicies, i22, arrayListArr4, pKIXPolicyNode, hashSet4);
