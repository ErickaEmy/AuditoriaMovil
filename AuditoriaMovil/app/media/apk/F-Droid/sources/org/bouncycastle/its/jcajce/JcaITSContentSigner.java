    ...
    */
    private JcaITSContentSigner(java.security.interfaces.ECPrivateKey r3, org.bouncycastle.its.ITSCertificate r4, org.bouncycastle.jcajce.util.JcaJceHelper r5) {
        ...
        L45:
            ...
            r2.signer = r3
        L5a:
            org.bouncycastle.operator.jcajce.JcaDigestCalculatorProviderBuilder r3 = new org.bouncycastle.operator.jcajce.JcaDigestCalculatorProviderBuilder     // Catch: java.lang.Exception -> Lce
            r3.<init>()     // Catch: java.lang.Exception -> Lce
            org.bouncycastle.operator.jcajce.JcaDigestCalculatorProviderBuilder r3 = r3.setHelper(r5)     // Catch: java.lang.Exception -> Lce
            org.bouncycastle.operator.DigestCalculatorProvider r3 = r3.build()     // Catch: java.lang.Exception -> Lce
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r5 = r2.digestAlgo     // Catch: org.bouncycastle.operator.OperatorCreationException -> Lb0
            org.bouncycastle.operator.DigestCalculator r3 = r3.get(r5)     // Catch: org.bouncycastle.operator.OperatorCreationException -> Lb0
            r2.digest = r3     // Catch: org.bouncycastle.operator.OperatorCreationException -> Lb0
            if (r4 == 0) goto La6
