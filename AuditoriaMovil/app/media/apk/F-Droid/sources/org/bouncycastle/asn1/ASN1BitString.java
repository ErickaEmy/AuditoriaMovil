...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String, ASN1BitStringParser {
    ...
    public static byte[] getBytes(int i) {
        ...
        int i2 = 4;
        for (int i3 = 3; i3 >= 1 && ((GF2Field.MASK << (i3 * 8)) & i) == 0; i3--) {
            i2--;
        }
    ...
    public boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        if (aSN1Primitive instanceof ASN1BitString) {
            ...
            byte b = bArr[i];
            int i3 = GF2Field.MASK << (bArr[0] & 255);
    ...
    public byte[] getBytes() {
        ...
        copyOfRange[length] = (byte) (((byte) (GF2Field.MASK << (bArr[0] & 255))) & copyOfRange[length]);
        return copyOfRange;
    }
    ...
    public int hashCode() {
        ...
        byte b = bArr[length];
        return (Arrays.hashCode(bArr, 0, length) * 257) ^ ((byte) ((GF2Field.MASK << (bArr[0] & 255)) & b));
    }
    ...
    public int intValue() {
        ...
        byte[] bArr = this.contents;
        return i | ((((byte) (bArr[min] & (GF2Field.MASK << (bArr[0] & 255)))) & 255) << ((min - 1) * 8));
    }
