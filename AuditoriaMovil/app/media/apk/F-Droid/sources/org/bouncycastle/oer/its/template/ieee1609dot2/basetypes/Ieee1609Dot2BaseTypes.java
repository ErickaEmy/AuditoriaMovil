...
public class Ieee1609Dot2BaseTypes {
    ...
    static {
        ...
        Hostname = OERDefinition.utf8String(0, GF2Field.MASK).typeName("Hostname");
        LinkageValue = OERDefinition.octets(9).typeName("LinkageValue");
        GroupLinkageValue = OERDefinition.seq(OERDefinition.octets(4).label("jValue"), OERDefinition.octets(9).label(Action.VALUE_ATTRIBUTE)).typeName("GroupLinkageValue");
