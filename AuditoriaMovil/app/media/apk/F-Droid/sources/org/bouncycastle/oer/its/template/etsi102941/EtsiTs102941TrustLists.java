...
public class EtsiTs102941TrustLists {
    ...
    static {
        ...
        ToBeSignedCrl = OERDefinition.seq(builder2.label("version"), builder3.label("thisUpdate"), builder3.label("nextUpdate"), typeName2.label("entries"), OERDefinition.extension(new Object[0])).typeName("ToBeSignedCrl");
