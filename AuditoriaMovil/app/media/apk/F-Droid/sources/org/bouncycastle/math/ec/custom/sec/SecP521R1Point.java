...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (!isOne) {
            ...
            SecP521R1Field.multiply(iArr8, secP521R1FieldElement5.x, iArr8, create);
        }
        if (!isOne2) {
            int[] iArr9 = secP521R1FieldElement9.x;
            SecP521R1Field.multiply(iArr9, secP521R1FieldElement6.x, iArr9, create);
        }
    ...
    public ECPoint twice() {
        ...
        if (!isOne) {
            ...
            SecP521R1Field.multiply(iArr6, secP521R1FieldElement3.x, iArr6, create);
        }
