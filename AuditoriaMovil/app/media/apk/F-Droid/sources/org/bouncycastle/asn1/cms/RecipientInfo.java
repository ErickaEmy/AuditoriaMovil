...
public class RecipientInfo extends ASN1Object implements ASN1Choice {
    ...
    ASN1Encodable f38info;

    public RecipientInfo(ASN1Primitive aSN1Primitive) {
        this.f38info = aSN1Primitive;
    }

    public RecipientInfo(KEKRecipientInfo kEKRecipientInfo) {
        this.f38info = new DERTaggedObject(false, 2, (ASN1Encodable) kEKRecipientInfo);
    }

    public RecipientInfo(KeyAgreeRecipientInfo keyAgreeRecipientInfo) {
        this.f38info = new DERTaggedObject(false, 1, (ASN1Encodable) keyAgreeRecipientInfo);
    }

    public RecipientInfo(KeyTransRecipientInfo keyTransRecipientInfo) {
        this.f38info = keyTransRecipientInfo;
    }

    public RecipientInfo(OtherRecipientInfo otherRecipientInfo) {
        this.f38info = new DERTaggedObject(false, 4, (ASN1Encodable) otherRecipientInfo);
    }

    public RecipientInfo(PasswordRecipientInfo passwordRecipientInfo) {
        this.f38info = new DERTaggedObject(false, 3, (ASN1Encodable) passwordRecipientInfo);
    }
    ...
    public ASN1Encodable getInfo() {
        ASN1Encodable aSN1Encodable = this.f38info;
    ...
    public boolean isTagged() {
        return this.f38info instanceof ASN1TaggedObject;
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.f38info.toASN1Primitive();
    }
}
