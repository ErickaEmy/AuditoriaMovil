...
public class Ieee1609Dot2Dot1EeRaInterface {
    ...
    static {
        ...
        OERDefinition.Builder typeName2 = OERDefinition.seq(typeName.label("signingExpansion"), builder.label("encryptionKey"), typeName.label("encryptionExpansion")).typeName("ButterflyParamsOriginal");
        ...
        EeRaCertRequest = OERDefinition.seq(Ieee1609Dot2BaseTypes.UINT8.label("version").validSwitchValue(new ASN1Integer(2L)), Ieee1609Dot2BaseTypes.Time32.label("generationTime"), IEEE1609dot2.CertificateType.label(BonjourPeer.TYPE), IEEE1609dot2.ToBeSignedCertificate.label("tbsCert"), OERDefinition.optional(typeName3.label("additionalParams")), OERDefinition.extension(new Object[0])).typeName("EeRaCertRequest");
    }
}
