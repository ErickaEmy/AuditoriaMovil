                ...
                if (this.forEncryption || i2 >= getInputBlockSize()) {
                    ...
                    for (int i3 = 0; i3 < smallPrimes.size(); i3++) {
                        ...
                        if (indexOf == -1) {
                            if (this.debug) {
                                PrintStream printStream = System.out;
                                printStream.println("Actual prime is " + smallPrimes.elementAt(i3));
                                printStream.println("Decrypted value is " + modPow);
                                printStream.println("LookupList for " + smallPrimes.elementAt(i3) + " with size " + this.lookup[i3].size() + " is: ");
