...
class SP80038G {
    ...
    private static short[] encFF1(BlockCipher blockCipher, int i, byte[] bArr, int i2, int i3, int i4, short[] sArr, short[] sArr2) {
        ...
        while (i7 < 10) {
            ...
            short[] sArr5 = sArr3;
            sArr3 = sArr4;
            BigInteger calculateY_FF1 = calculateY_FF1(blockCipher, valueOf, bArr, ceil, i5, i7, calculateP_FF1, sArr3);
            int i9 = i2 - i6;
            str(valueOf, num(valueOf, sArr5).add(calculateY_FF1).mod(calculateModUV[i8 & 1]), i9, sArr5, 0);
            i7 = i8 + 1;
            i6 = i9;
            sArr4 = sArr5;
        }
