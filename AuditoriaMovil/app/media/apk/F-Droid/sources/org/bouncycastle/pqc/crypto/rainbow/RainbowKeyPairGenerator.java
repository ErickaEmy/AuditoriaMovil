...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private void computePublicKey() {
        ...
        short[][][] sArr14 = (short[][][]) Array.newInstance(cls2, i2, i3, i3);
        short[][] sArr15 = (short[][]) Array.newInstance(cls2, i2, i3);
    ...
    private void generateL2() {
        int[] iArr;
        int i;
        int i2 = this.vi[iArr.length - 1];
        this.A2 = (short[][]) Array.newInstance(Short.TYPE, i2, i2);
        this.A2inv = null;
        ComputeInField computeInField = new ComputeInField();
        while (true) {
            if (this.A2inv != null) {
