...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int bigEndianToInt = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i);
        int bigEndianToInt2 = this.wKey[130] ^ Pack.bigEndianToInt(bArr, i + 4);
        int[] iArr = {Pack.bigEndianToInt(bArr, i + 12) ^ this.wKey[128], this.wKey[129] ^ Pack.bigEndianToInt(bArr, i + 8), bigEndianToInt2, bigEndianToInt};
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToBigEndian(this.wKey[3] ^ iArr[3], bArr2, i2);
        Pack.intToBigEndian(this.wKey[2] ^ iArr[2], bArr2, i2 + 4);
        Pack.intToBigEndian(this.wKey[1] ^ iArr[1], bArr2, i2 + 8);
    ...
    protected void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int[] iArr = {Pack.bigEndianToInt(bArr, i + 12), Pack.bigEndianToInt(bArr, i + 8), bigEndianToInt2, bigEndianToInt};
        int[] iArr2 = this.wKey;
        ...
        Pack.intToBigEndian(iArr[0] ^ this.wKey[128], bArr2, i2 + 12);
    }
