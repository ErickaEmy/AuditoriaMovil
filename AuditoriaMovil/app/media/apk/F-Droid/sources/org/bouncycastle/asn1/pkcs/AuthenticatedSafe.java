...
public class AuthenticatedSafe extends ASN1Object {
    ...
    private ContentInfo[] f39info;
    private boolean isBer;

    private AuthenticatedSafe(ASN1Sequence aSN1Sequence) {
        this.isBer = true;
        this.f39info = new ContentInfo[aSN1Sequence.size()];
        int i = 0;
        while (true) {
            ContentInfo[] contentInfoArr = this.f39info;
    ...
    public AuthenticatedSafe(ContentInfo[] contentInfoArr) {
        this.isBer = true;
        this.f39info = copy(contentInfoArr);
    }
    ...
    public ContentInfo[] getContentInfo() {
        return copy(this.f39info);
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.isBer ? new BERSequence(this.f39info) : new DLSequence(this.f39info);
    }
}
