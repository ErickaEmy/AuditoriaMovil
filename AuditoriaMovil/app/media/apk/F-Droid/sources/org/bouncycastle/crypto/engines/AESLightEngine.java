...
public class AESLightEngine implements BlockCipher, StatelessProcessing {
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        while (true) {
            byte[] bArr3 = Si;
            if (i8 <= i5) {
                int inv_mcol = inv_mcol((((bArr3[i4 & GF2Field.MASK] & 255) ^ ((bArr3[(i9 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i7 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i6 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][0];
                int inv_mcol2 = inv_mcol((((bArr3[i6 & GF2Field.MASK] & 255) ^ ((bArr3[(i4 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i9 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i7 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][1];
                int inv_mcol3 = inv_mcol((((bArr3[i7 & GF2Field.MASK] & 255) ^ ((bArr3[(i6 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i4 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i9 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][2];
                int inv_mcol4 = inv_mcol((((bArr3[i9 & GF2Field.MASK] & 255) ^ ((bArr3[(i7 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i6 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i4 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][3];
                int[] iArr3 = iArr[0];
                int i10 = ((((bArr3[inv_mcol & GF2Field.MASK] & 255) ^ ((bArr3[(inv_mcol4 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(inv_mcol3 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol2 >> 24) & GF2Field.MASK] << 24)) ^ iArr3[0];
                int i11 = ((((bArr3[inv_mcol2 & GF2Field.MASK] & 255) ^ ((bArr3[(inv_mcol >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(inv_mcol4 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol3 >> 24) & GF2Field.MASK] << 24)) ^ iArr3[1];
                int i12 = ((((bArr3[inv_mcol3 & GF2Field.MASK] & 255) ^ ((bArr3[(inv_mcol2 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(inv_mcol >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol4 >> 24) & GF2Field.MASK] << 24)) ^ iArr3[2];
                Pack.intToLittleEndian(i10, bArr2, i2);
                Pack.intToLittleEndian(i11, bArr2, i2 + 4);
                Pack.intToLittleEndian(i12, bArr2, i2 + 8);
                Pack.intToLittleEndian(((((bArr3[inv_mcol4 & GF2Field.MASK] & 255) ^ ((bArr3[(inv_mcol3 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(inv_mcol2 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol >> 24) & GF2Field.MASK] << 24)) ^ iArr3[3], bArr2, i2 + 12);
                return;
            }
            int inv_mcol5 = inv_mcol((((bArr3[i4 & GF2Field.MASK] & 255) ^ ((bArr3[(i9 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i7 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i6 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][c];
            int inv_mcol6 = inv_mcol((((bArr3[i6 & GF2Field.MASK] & 255) ^ ((bArr3[(i4 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i9 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i7 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][i5];
            int inv_mcol7 = inv_mcol(((((bArr3[(i6 >> 8) & GF2Field.MASK] & 255) << 8) ^ (bArr3[i7 & GF2Field.MASK] & 255)) ^ ((bArr3[(i4 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i9 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][2];
            int i13 = i8 - 1;
            int inv_mcol8 = inv_mcol((((bArr3[i9 & GF2Field.MASK] & 255) ^ ((bArr3[(i7 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i6 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i4 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i8][3];
            int inv_mcol9 = inv_mcol((((bArr3[inv_mcol5 & GF2Field.MASK] & 255) ^ ((bArr3[(inv_mcol8 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(inv_mcol7 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol6 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i13][c];
            int inv_mcol10 = inv_mcol((((bArr3[inv_mcol6 & GF2Field.MASK] & 255) ^ ((bArr3[(inv_mcol5 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(inv_mcol8 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol7 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i13][1];
            int i14 = (bArr3[(inv_mcol6 >> 8) & GF2Field.MASK] & 255) << 8;
            i8 -= 2;
            i9 = inv_mcol((((bArr3[inv_mcol8 & GF2Field.MASK] & 255) ^ ((bArr3[(inv_mcol7 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(inv_mcol6 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol5 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i13][3];
            i4 = inv_mcol9;
            i6 = inv_mcol10;
            i7 = inv_mcol(((i14 ^ (bArr3[inv_mcol7 & GF2Field.MASK] & 255)) ^ ((bArr3[(inv_mcol5 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(inv_mcol8 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i13][2];
            c = 0;
            i5 = 1;
        }
    }
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        for (int i8 = 1; i7 < this.ROUNDS - i8; i8 = 1) {
            byte[] bArr3 = S;
            int mcol = mcol((((bArr3[i3 & GF2Field.MASK] & 255) ^ ((bArr3[(i4 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i5 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i6 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][c];
            int mcol2 = mcol((((bArr3[i4 & GF2Field.MASK] & 255) ^ ((bArr3[(i5 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i6 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i3 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][i8];
            int mcol3 = mcol(((((bArr3[(i6 >> 8) & GF2Field.MASK] & 255) << 8) ^ (bArr3[i5 & GF2Field.MASK] & 255)) ^ ((bArr3[(i3 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i4 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][2];
            int i9 = i7 + 1;
            int mcol4 = mcol((((bArr3[i6 & GF2Field.MASK] & 255) ^ ((bArr3[(i3 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(i4 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(i5 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][3];
            int mcol5 = mcol((((bArr3[mcol & GF2Field.MASK] & 255) ^ ((bArr3[(mcol2 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(mcol3 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(mcol4 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i9][c];
            int mcol6 = mcol((((bArr3[mcol2 & GF2Field.MASK] & 255) ^ ((bArr3[(mcol3 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(mcol4 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(mcol >> 24) & GF2Field.MASK] << 24)) ^ iArr[i9][1];
            int i10 = (bArr3[(mcol4 >> 8) & GF2Field.MASK] & 255) << 8;
            i7 += 2;
            i6 = mcol((((bArr3[mcol4 & GF2Field.MASK] & 255) ^ ((bArr3[(mcol >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(mcol2 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(mcol3 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i9][3];
            i3 = mcol5;
            i4 = mcol6;
            i5 = mcol(((i10 ^ (bArr3[mcol3 & GF2Field.MASK] & 255)) ^ ((bArr3[(mcol >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(mcol2 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i9][2];
            c = 0;
        }
        byte[] bArr4 = S;
        int mcol7 = mcol((((bArr4[i3 & GF2Field.MASK] & 255) ^ ((bArr4[(i4 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(i5 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(i6 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][0];
        int mcol8 = mcol((((bArr4[i4 & GF2Field.MASK] & 255) ^ ((bArr4[(i5 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(i6 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(i3 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][1];
        int mcol9 = mcol((((bArr4[i5 & GF2Field.MASK] & 255) ^ ((bArr4[(i6 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(i3 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(i4 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][2];
        int mcol10 = mcol((((bArr4[i6 & GF2Field.MASK] & 255) ^ ((bArr4[(i3 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(i4 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(i5 >> 24) & GF2Field.MASK] << 24)) ^ iArr[i7][3];
        int[] iArr3 = iArr[i7 + 1];
        int i11 = ((((bArr4[mcol7 & GF2Field.MASK] & 255) ^ ((bArr4[(mcol8 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(mcol9 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(mcol10 >> 24) & GF2Field.MASK] << 24)) ^ iArr3[0];
        int i12 = ((((bArr4[mcol8 & GF2Field.MASK] & 255) ^ ((bArr4[(mcol9 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(mcol10 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(mcol7 >> 24) & GF2Field.MASK] << 24)) ^ iArr3[1];
        int i13 = iArr3[2];
        int i14 = ((((bArr4[mcol10 & GF2Field.MASK] & 255) ^ ((bArr4[(mcol7 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(mcol8 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(mcol9 >> 24) & GF2Field.MASK] << 24)) ^ iArr3[3];
        Pack.intToLittleEndian(i11, bArr2, i2);
        Pack.intToLittleEndian(i12, bArr2, i2 + 4);
        Pack.intToLittleEndian(i13 ^ ((((bArr4[mcol9 & GF2Field.MASK] & 255) ^ ((bArr4[(mcol10 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(mcol7 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(mcol8 >> 24) & GF2Field.MASK] << 24)), bArr2, i2 + 8);
