...
public class SABEREngine {
    ...
    private void indcpa_kem_dec(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        short[][] sArr = (short[][]) Array.newInstance(cls, this.SABER_L, 256);
        short[][] sArr2 = (short[][]) Array.newInstance(cls, this.SABER_L, 256);
    ...
    private void indcpa_kem_enc(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        int i = this.SABER_L;
        Class cls = Short.TYPE;
        short[][][] sArr = (short[][][]) Array.newInstance(cls, i, i, 256);
        short[][] sArr2 = (short[][]) Array.newInstance(cls, this.SABER_L, 256);
        short[][] sArr3 = (short[][]) Array.newInstance(cls, this.SABER_L, 256);
        short[][] sArr4 = (short[][]) Array.newInstance(cls, this.SABER_L, 256);
        ...
        for (int i2 = 0; i2 < this.SABER_L; i2++) {
            for (int i3 = 0; i3 < 256; i3++) {
                ...
                sArr7[i3] = (short) (((sArr7[i3] + this.h1) & 65535) >>> 3);
            }
        }
