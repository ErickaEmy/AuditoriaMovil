    ...
    private void isaac() {
        ...
        for (int i5 = 0; i5 < 256; i5++) {
            ...
            if (i7 == 0) {
                ...
                int i8 = this.a + iArr[(i5 + 128) & GF2Field.MASK];
                this.a = i8;
                int i9 = iArr[(i6 >>> 2) & GF2Field.MASK] + i8 + this.b;
                iArr[i5] = i9;
            ...
            this.a = i ^ i2;
            int i82 = this.a + iArr[(i5 + 128) & GF2Field.MASK];
            this.a = i82;
            int i92 = iArr[(i6 >>> 2) & GF2Field.MASK] + i82 + this.b;
            iArr[i5] = i92;
            int[] iArr22 = this.results;
            int i102 = iArr[(i92 >>> 10) & GF2Field.MASK] + i6;
            this.b = i102;
            iArr22[i5] = i102;
        }
    }
