...
public class LongArray implements Cloneable {
    ...
    private static long interleave2_32to64(int i) {
        ...
        int i2 = sArr[i & GF2Field.MASK] | (sArr[(i >>> 8) & GF2Field.MASK] << 16);
        short s = sArr[(i >>> 16) & GF2Field.MASK];
    ...
    private static long interleave4_16to64(int i) {
        ...
        return (iArr[i & GF2Field.MASK] & BodyPartID.bodyIdMax) | ((iArr[i >>> 8] & BodyPartID.bodyIdMax) << 32);
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (i17 < i7) {
            ...
            while (true) {
                i4 = i16;
                i5 = i17;
                addBoth(jArr7, i18, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[((int) (j2 >>> 4)) & 15], i10);
                j2 >>>= 8;
                if (j2 == 0) {
                    break;
                }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        while (i14 < 8) {
            int i15 = i13 + i7;
            shiftUp(jArr2, i4, jArr2, i15, i7, i14);
            i14++;
            i13 = i15;
        }
        int i16 = 15;
        ...
        while (true) {
            ...
            while (true) {
                int i19 = i4;
                long j2 = jArr2[i18] >>> i17;
                int i20 = i11;
                while (true) {
                    int i21 = ((int) j2) & i16;
                    if (i21 != 0) {
                        add(jArr2, iArr2[i21] + i18, jArr2, i19, i7);
                    }
                    i20++;
                    if (i20 == 8) {
                        break;
        ...
        while (true) {
            ...
            if ((i24 & 1) == 0) {
                addShiftedUp(jArr2, iArr2[i24 >>> 1], jArr2, iArr2[i24], i6, 16);
            } else {
                distribute(jArr2, iArr2[i24], iArr2[i23 - 2], iArr2[1], i6);
            }
            i23 = i24;
        }
    }
