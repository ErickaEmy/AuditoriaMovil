...
public class AESEngine implements BlockCipher, StatelessProcessing {
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        for (int i9 = 1; i7 > i9; i9 = 1) {
            int[] iArr3 = Tinv0;
            int shift = (((shift(iArr3[(i8 >> 8) & GF2Field.MASK], 24) ^ iArr3[i4 & GF2Field.MASK]) ^ shift(iArr3[(i6 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i5 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][c];
            int shift2 = (((shift(iArr3[(i4 >> 8) & GF2Field.MASK], 24) ^ iArr3[i5 & GF2Field.MASK]) ^ shift(iArr3[(i8 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i6 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][i9];
            int shift3 = (((shift(iArr3[(i5 >> 8) & GF2Field.MASK], 24) ^ iArr3[i6 & GF2Field.MASK]) ^ shift(iArr3[(i4 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i8 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][2];
            int shift4 = ((iArr3[i8 & GF2Field.MASK] ^ shift(iArr3[(i6 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(i5 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i4 >> 24) & GF2Field.MASK], 8);
            int i10 = i7 - 1;
            int i11 = shift4 ^ iArr[i7][3];
            int shift5 = (((iArr3[shift & GF2Field.MASK] ^ shift(iArr3[(i11 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(shift3 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(shift2 >> 24) & GF2Field.MASK], 8)) ^ iArr[i10][0];
            int shift6 = (((iArr3[shift2 & GF2Field.MASK] ^ shift(iArr3[(shift >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(i11 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(shift3 >> 24) & GF2Field.MASK], 8)) ^ iArr[i10][1];
            i7 -= 2;
            i8 = (((iArr3[i11 & GF2Field.MASK] ^ shift(iArr3[(shift3 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(shift2 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(shift >> 24) & GF2Field.MASK], 8)) ^ iArr[i10][3];
            i4 = shift5;
            i5 = shift6;
            i6 = (((iArr3[shift3 & GF2Field.MASK] ^ shift(iArr3[(shift2 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(shift >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i11 >> 24) & GF2Field.MASK], 8)) ^ iArr[i10][2];
            c = 0;
        }
        int[] iArr4 = Tinv0;
        int shift7 = (((iArr4[i4 & GF2Field.MASK] ^ shift(iArr4[(i8 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i6 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i5 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][0];
        int shift8 = (((iArr4[i5 & GF2Field.MASK] ^ shift(iArr4[(i4 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i8 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i6 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][1];
        int shift9 = (((iArr4[i6 & GF2Field.MASK] ^ shift(iArr4[(i5 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i4 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i8 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][2];
        int shift10 = (((iArr4[i8 & GF2Field.MASK] ^ shift(iArr4[(i6 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i5 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i4 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][3];
        byte[] bArr3 = Si;
        byte[] bArr4 = this.s;
        int[] iArr5 = iArr[0];
        int i12 = ((((bArr3[shift7 & GF2Field.MASK] & 255) ^ ((bArr4[(shift10 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(shift9 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(shift8 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[0];
        int i13 = ((((bArr4[shift8 & GF2Field.MASK] & 255) ^ ((bArr4[(shift7 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(shift10 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(shift9 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[1];
        int i14 = ((((bArr3[shift10 & GF2Field.MASK] & 255) ^ ((bArr4[(shift9 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(shift8 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(shift7 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[3];
        Pack.intToLittleEndian(i12, bArr2, i2);
        Pack.intToLittleEndian(i13, bArr2, i2 + 4);
        Pack.intToLittleEndian(((((bArr4[shift9 & GF2Field.MASK] & 255) ^ ((bArr3[(shift8 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(shift7 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(shift10 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[2], bArr2, i2 + 8);
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2, int[][] iArr) {
        ...
        for (int i8 = 1; i7 < this.ROUNDS - i8; i8 = 1) {
            int[] iArr3 = T0;
            int shift = (((shift(iArr3[(i4 >> 8) & GF2Field.MASK], 24) ^ iArr3[i3 & GF2Field.MASK]) ^ shift(iArr3[(i5 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i6 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][c];
            int shift2 = (((shift(iArr3[(i5 >> 8) & GF2Field.MASK], 24) ^ iArr3[i4 & GF2Field.MASK]) ^ shift(iArr3[(i6 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i3 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][i8];
            int shift3 = (((shift(iArr3[(i6 >> 8) & GF2Field.MASK], 24) ^ iArr3[i5 & GF2Field.MASK]) ^ shift(iArr3[(i3 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i4 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][2];
            int shift4 = ((iArr3[i6 & GF2Field.MASK] ^ shift(iArr3[(i3 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(i4 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i5 >> 24) & GF2Field.MASK], 8);
            int i9 = i7 + 1;
            int i10 = shift4 ^ iArr[i7][3];
            int shift5 = (((iArr3[shift & GF2Field.MASK] ^ shift(iArr3[(shift2 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(shift3 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(i10 >> 24) & GF2Field.MASK], 8)) ^ iArr[i9][0];
            int shift6 = (((iArr3[shift2 & GF2Field.MASK] ^ shift(iArr3[(shift3 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(i10 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(shift >> 24) & GF2Field.MASK], 8)) ^ iArr[i9][1];
            i7 += 2;
            i6 = (((iArr3[i10 & GF2Field.MASK] ^ shift(iArr3[(shift >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(shift2 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(shift3 >> 24) & GF2Field.MASK], 8)) ^ iArr[i9][3];
            i3 = shift5;
            i4 = shift6;
            i5 = (((iArr3[shift3 & GF2Field.MASK] ^ shift(iArr3[(i10 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr3[(shift >> 16) & GF2Field.MASK], 16)) ^ shift(iArr3[(shift2 >> 24) & GF2Field.MASK], 8)) ^ iArr[i9][2];
            c = 0;
        }
        int[] iArr4 = T0;
        int shift7 = (((iArr4[i3 & GF2Field.MASK] ^ shift(iArr4[(i4 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i5 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i6 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][0];
        int shift8 = (((iArr4[i4 & GF2Field.MASK] ^ shift(iArr4[(i5 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i6 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i3 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][1];
        int shift9 = (((iArr4[i5 & GF2Field.MASK] ^ shift(iArr4[(i6 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i3 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i4 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][2];
        int shift10 = (((iArr4[i6 & GF2Field.MASK] ^ shift(iArr4[(i3 >> 8) & GF2Field.MASK], 24)) ^ shift(iArr4[(i4 >> 16) & GF2Field.MASK], 16)) ^ shift(iArr4[(i5 >> 24) & GF2Field.MASK], 8)) ^ iArr[i7][3];
        byte[] bArr3 = S;
        int i11 = (bArr3[shift7 & GF2Field.MASK] & 255) ^ ((bArr3[(shift8 >> 8) & GF2Field.MASK] & 255) << 8);
        byte[] bArr4 = this.s;
        int[] iArr5 = iArr[i7 + 1];
        int i12 = ((i11 ^ ((bArr4[(shift9 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(shift10 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[0];
        int i13 = ((((bArr4[shift8 & GF2Field.MASK] & 255) ^ ((bArr3[(shift9 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(shift10 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr4[(shift7 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[1];
        int i14 = ((((bArr4[shift10 & GF2Field.MASK] & 255) ^ ((bArr4[(shift7 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr4[(shift8 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(shift9 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[3];
        Pack.intToLittleEndian(i12, bArr2, i2);
        Pack.intToLittleEndian(i13, bArr2, i2 + 4);
        Pack.intToLittleEndian(((((bArr4[shift9 & GF2Field.MASK] & 255) ^ ((bArr3[(shift10 >> 8) & GF2Field.MASK] & 255) << 8)) ^ ((bArr3[(shift7 >> 16) & GF2Field.MASK] & 255) << 16)) ^ (bArr3[(shift8 >> 24) & GF2Field.MASK] << 24)) ^ iArr5[2], bArr2, i2 + 8);
        Pack.intToLittleEndian(i14, bArr2, i2 + 12);
    }
