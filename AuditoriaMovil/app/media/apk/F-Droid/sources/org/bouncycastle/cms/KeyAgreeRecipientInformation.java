...
public class KeyAgreeRecipientInformation extends RecipientInformation {
    ...
    private KeyAgreeRecipientInfo f42info;
    ...
    KeyAgreeRecipientInformation(KeyAgreeRecipientInfo keyAgreeRecipientInfo, RecipientId recipientId, ASN1OctetString aSN1OctetString, AlgorithmIdentifier algorithmIdentifier, CMSSecureReadable cMSSecureReadable, AuthAttributesProvider authAttributesProvider) {
        ...
        this.f42info = keyAgreeRecipientInfo;
    ...
    public OriginatorIdentifierOrKey getOriginator() {
        return this.f42info.getOriginator();
    }

    @Override // org.bouncycastle.cms.RecipientInformation
    protected RecipientOperator getRecipientOperator(Recipient recipient) throws CMSException, IOException {
        KeyAgreeRecipient keyAgreeRecipient = (KeyAgreeRecipient) recipient;
        return keyAgreeRecipient.getRecipientOperator(this.keyEncAlg, this.messageAlgorithm, getSenderPublicKeyInfo(keyAgreeRecipient.getPrivateKeyAlgorithmIdentifier(), this.f42info.getOriginator()), this.f42info.getUserKeyingMaterial(), this.encryptedKey.getOctets());
    }

    public byte[] getUserKeyingMaterial() {
        ASN1OctetString userKeyingMaterial = this.f42info.getUserKeyingMaterial();
