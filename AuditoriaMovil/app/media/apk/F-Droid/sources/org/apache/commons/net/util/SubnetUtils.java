...
public class SubnetUtils {
    ...
    public final class SubnetInfo {
        ...
        private long networkLong() {
            return SubnetUtils.this.network & BodyPartID.bodyIdMax;
        }

        private long broadcastLong() {
            return SubnetUtils.this.broadcast & BodyPartID.bodyIdMax;
        }
    ...
    private int matchAddress(Matcher matcher) {
        ...
        for (int i2 = 1; i2 <= 4; i2++) {
            i |= (rangeCheck(Integer.parseInt(matcher.group(i2)), 0, GF2Field.MASK) & GF2Field.MASK) << ((4 - i2) * 8);
        }
        return i;
    }
