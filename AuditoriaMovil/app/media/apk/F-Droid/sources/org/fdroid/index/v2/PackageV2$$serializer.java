...
public final class PackageV2$$serializer implements GeneratedSerializer {
    ...
    public KSerializer[] childSerializers() {
        ...
        kSerializerArr = PackageV2.$childSerializers;
        return new KSerializer[]{MetadataV2$$serializer.INSTANCE, kSerializerArr[1]};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    public PackageV2 deserialize(Decoder decoder) {
        KSerializer[] kSerializerArr;
        Map map;
        ...
        if (beginStructure.decodeSequentially()) {
            metadataV2 = (MetadataV2) beginStructure.decodeSerializableElement(descriptor2, 0, MetadataV2$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    metadataV22 = (MetadataV2) beginStructure.decodeSerializableElement(descriptor2, 0, MetadataV2$$serializer.INSTANCE, metadataV22);
                    i2 |= 1;
    ...
    public void serialize(Encoder encoder, PackageV2 value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        PackageV2.write$Self$index_release(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
