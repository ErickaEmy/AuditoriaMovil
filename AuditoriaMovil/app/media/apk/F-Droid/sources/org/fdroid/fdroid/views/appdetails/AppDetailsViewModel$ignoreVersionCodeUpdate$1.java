...
public final class AppDetailsViewModel$ignoreVersionCodeUpdate$1 extends SuspendLambda implements Function2 {
    ...
    public AppDetailsViewModel$ignoreVersionCodeUpdate$1(AppDetailsViewModel appDetailsViewModel, long j, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new AppDetailsViewModel$ignoreVersionCodeUpdate$1(this.this$0, this.$versionCode, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((AppDetailsViewModel$ignoreVersionCodeUpdate$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (liveData != null && (appPrefs = (AppPrefs) liveData.getValue()) != null) {
                ...
                fDroidDatabase.getAppPrefsDao().update(appPrefs.toggleIgnoreVersionCodeUpdate(this.$versionCode));
