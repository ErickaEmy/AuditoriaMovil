...
public final class GlideOptions extends RequestOptions {
    ...
    public static GlideOptions bitmapTransform(Transformation transformation) {
    ...
    public static <T> GlideOptions option(Option option, T t) {
        return new GlideOptions().set(option, (Option) t);
    }
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    /* renamed from: clone */
    public GlideOptions mo2026clone() {
        return (GlideOptions) super.mo2026clone();
    }

    @Override // com.bumptech.glide.request.BaseRequestOptions
    public <Y> GlideOptions set(Option option, Y y) {
        return (GlideOptions) super.set(option, (Object) y);
    }
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    public GlideOptions transform(Transformation transformation) {
        return (GlideOptions) super.transform(transformation);
    }

    @Override // com.bumptech.glide.request.BaseRequestOptions
    @SafeVarargs
    public final GlideOptions transform(Transformation... transformationArr) {
    ...
    @SafeVarargs
    @Deprecated
    public final GlideOptions transforms(Transformation... transformationArr) {
        return (GlideOptions) super.transforms(transformationArr);
    }

    @Override // com.bumptech.glide.request.BaseRequestOptions
    public GlideOptions optionalTransform(Transformation transformation) {
        return (GlideOptions) super.optionalTransform(transformation);
    }

    @Override // com.bumptech.glide.request.BaseRequestOptions
    public <Y> GlideOptions optionalTransform(Class<Y> cls, Transformation transformation) {
        return (GlideOptions) super.optionalTransform((Class) cls, transformation);
    }

    @Override // com.bumptech.glide.request.BaseRequestOptions
    public <Y> GlideOptions transform(Class<Y> cls, Transformation transformation) {
        return (GlideOptions) super.transform((Class) cls, transformation);
    }
