...
public final class FileV2$$serializer implements GeneratedSerializer {
    ...
    public FileV2 deserialize(Decoder decoder) {
        int i;
        String str;
        String str2;
        Long l;
    ...
    public void serialize(Encoder encoder, FileV2 value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        FileV2.write$Self$index_release(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
