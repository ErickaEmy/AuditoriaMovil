...
public class AppStatusListItemController extends AppListItemController {
    ...
    public AppStatusListItemController(AppCompatActivity appCompatActivity, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: org.fdroid.fdroid.views.updates.items.AppStatusListItemController$1  reason: invalid class name */
    /* loaded from: classes2.dex */
            ...
            if (i != 1) {
                ...
                Snackbar.make(this.itemView, R.string.app_list__dismiss_installing_app, 0).setAction(R.string.undo, new View.OnClickListener() { // from class: org.fdroid.fdroid.views.updates.items.AppStatusListItemController$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        AppStatusListItemController.lambda$onDismissApp$0(AppUpdateStatusManager.this, appUpdateStatus, updatesAdapter, view);
                    }
                }).show();
            }
        }
