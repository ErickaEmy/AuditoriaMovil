...
public class ConnectivityMonitorService extends JobIntentService {
    ...
    public static void start(Context context) {
        ...
        JobIntentService.enqueueWork(context, ConnectivityMonitorService.class, 159559291, intent);
    }
                    ...
                    if (nextElement.getDisplayName().contains("wlan0") || nextElement.getDisplayName().contains("eth0") || nextElement.getDisplayName().contains("ap0")) {
                        ...
                        while (inetAddresses.hasMoreElements()) {
                            ...
                            if (!nextElement2.isLoopbackAddress() && !(nextElement2 instanceof Inet6Address)) {
                                Log.i(TAG, "FLAG_NET_DEVICE_AP_WITHOUT_INTERNET: " + nextElement.getDisplayName() + " " + nextElement2);
                                return 3;
                            }
                        }
                        continue;
