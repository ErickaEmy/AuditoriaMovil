...
public final class PermissionV2$$serializer implements GeneratedSerializer {
    ...
    public PermissionV2 deserialize(Decoder decoder) {
        String str;
        Integer num;
        int i;
        ...
        return new PermissionV2(i, str, num, (SerializationConstructorMarker) null);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(Encoder encoder, PermissionV2 value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        PermissionV2.write$Self$index_release(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
