...
public final class AppDetailsViewModel$toggleBetaReleaseChannel$1 extends SuspendLambda implements Function2 {
    int label;
    final /* synthetic */ AppDetailsViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppDetailsViewModel$toggleBetaReleaseChannel$1(AppDetailsViewModel appDetailsViewModel, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new AppDetailsViewModel$toggleBetaReleaseChannel$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((AppDetailsViewModel$toggleBetaReleaseChannel$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (liveData != null && (appPrefs = (AppPrefs) liveData.getValue()) != null) {
                ...
                fDroidDatabase.getAppPrefsDao().update(appPrefs.toggleReleaseChannel("Beta"));
