...
public final class EntryVerifier extends JarIndexVerifier {
    ...
    public EntryVerifier(File jarFile, String str, String str2) {
        super(jarFile, str, str2);
        Intrinsics.checkNotNullParameter(jarFile, "jarFile");
        this.jsonFileName = EntryVerifierKt.DATA_FILE_NAME;
    }
    ...
    protected void checkAttributes(Attributes attributes) throws SigningException {
        ...
        for (Object obj : keySet) {
            list = EntryVerifierKt.FORBIDDEN_DIGESTS;
