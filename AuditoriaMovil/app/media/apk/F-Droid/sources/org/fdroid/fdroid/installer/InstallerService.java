...
public class InstallerService extends JobIntentService {
    ...
    protected void onHandleWork(Intent intent) {
        ...
        Installer create = InstallerFactory.create(this, app, apk);
        if (ACTION_INSTALL.equals(intent.getAction())) {
            create.installPackage(intent.getData(), Uri.parse(intent.getStringExtra(DownloaderService.EXTRA_CANONICAL_URL)));
            ...
            new Thread() { // from class: org.fdroid.fdroid.installer.InstallerService.1
                ...
                public void run() {
                    ...
                    if (mainObbFile == null || (parentFile = mainObbFile.getParentFile()) == null || (listFiles = parentFile.listFiles((FileFilter) new WildcardFileFilter("*.obb"))) == null) {
                        return;
                    }
    ...
    private static void enqueueWork(Context context, Intent intent) {
        JobIntentService.enqueueWork(context, InstallerService.class, 8856468, intent);
    }
}
