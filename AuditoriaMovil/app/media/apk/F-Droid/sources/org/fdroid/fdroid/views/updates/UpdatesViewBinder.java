...
public class UpdatesViewBinder {
    ...
    public UpdatesViewBinder(final AppCompatActivity appCompatActivity, FrameLayout frameLayout) {
        ...
        this.emptyUpdatingProgress = (CircularProgressIndicator) inflate.findViewById(R.id.empty_updating_progress);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: org.fdroid.fdroid.views.updates.UpdatesViewBinder$$ExternalSyntheticLambda0
            ...
            public final void onRefresh() {
                UpdatesViewBinder.lambda$new$0(SwipeRefreshLayout.this, appCompatActivity);
            }
        });
        this.isUpdatingLiveData = FDroidApp.getRepoUpdateManager(appCompatActivity).isUpdatingLiveData();
    }
    ...
    public void updateEmptyState() {
        if (this.adapter.getItemCount() == 0) {
            ...
            setUpEmptyUpdatingProgress(((Boolean) FDroidApp.getRepoUpdateManager(this.activity).isUpdating().getValue()).booleanValue());
            this.isUpdatingLiveData.observe(this.activity, new Observer() { // from class: org.fdroid.fdroid.views.updates.UpdatesViewBinder$$ExternalSyntheticLambda1
                ...
                public final void onChanged(Object obj) {
                    UpdatesViewBinder.this.setUpEmptyUpdatingProgress(((Boolean) obj).booleanValue());
                }
            });
            return;
        }
