...
public final class LocalRepoManager {
    ...
    private LocalRepoManager(Context context) {
        ...
        SanitizedFile knownSanitized = SanitizedFile.knownSanitized(context.getFilesDir());
        this.webRoot = knownSanitized;
        SanitizedFile sanitizedFile = new SanitizedFile(knownSanitized, "fdroid");
        this.fdroidDir = sanitizedFile;
        SanitizedFile sanitizedFile2 = new SanitizedFile(knownSanitized, "FDROID");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void generateIndex(String str, String str2, String[] strArr) throws IOException {
