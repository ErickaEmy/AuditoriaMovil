...
public class PanicPreferencesFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        this.prefApp.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() { // from class: org.fdroid.fdroid.panic.PanicPreferencesFragment$$ExternalSyntheticLambda6
            @Override // androidx.preference.Preference.OnPreferenceChangeListener
            public final boolean onPreferenceChange(Preference preference, Object obj) {
                boolean lambda$onCreatePreferences$0;
                lambda$onCreatePreferences$0 = PanicPreferencesFragment.this.lambda$onCreatePreferences$0(preference, obj);
        ...
        if (arrayList.size() <= 1) {
            this.prefApp.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: org.fdroid.fdroid.panic.PanicPreferencesFragment$$ExternalSyntheticLambda0
                ...
                public final boolean onPreferenceClick(Preference preference) {
                    boolean lambda$showPanicApp$1;
                    lambda$showPanicApp$1 = PanicPreferencesFragment.this.lambda$showPanicApp$1(preference);
                    return lambda$showPanicApp$1;
                }
            });
        }
    ...
    private void showHideConfirmationDialog() {
        ...
        builder.setMessage(getString(R.string.panic_hide_warning_message, string, Integer.valueOf(HidingManager.getUnhidePin(requireActivity())), getString(R.string.hiding_calculator)));
        builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: org.fdroid.fdroid.panic.PanicPreferencesFragment$$ExternalSyntheticLambda3
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                PanicPreferencesFragment.this.lambda$showHideConfirmationDialog$4(dialogInterface, i);
            }
        });
        builder.setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() { // from class: org.fdroid.fdroid.panic.PanicPreferencesFragment$$ExternalSyntheticLambda4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.cancel();
            }
        });
        builder.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.fdroid.fdroid.panic.PanicPreferencesFragment$$ExternalSyntheticLambda5
            @Override // android.content.DialogInterface.OnCancelListener
            public final void onCancel(DialogInterface dialogInterface) {
                PanicPreferencesFragment.this.lambda$showHideConfirmationDialog$6(dialogInterface);
            }
        });
