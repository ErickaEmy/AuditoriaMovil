...
public final class ReleaseChannel extends RepoAttribute {
    ...
    /* compiled from: Repository.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lorg/fdroid/database/ReleaseChannel$Companion;", "", "()V", "TABLE", "", "database_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes2.dex */
    ...
    public static /* synthetic */ ReleaseChannel copy$default(ReleaseChannel releaseChannel, long j, String str, Map map, Map map2, Map map3, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            map4 = releaseChannel.icon;
        }
        Map map5 = map4;
        Map<String, String> map6 = map2;
        if ((i & 8) != 0) {
            map6 = releaseChannel.name;
        }
        Map map7 = map6;
        Map<String, String> map8 = map3;
        if ((i & 16) != 0) {
            map8 = releaseChannel.description;
        }
        return releaseChannel.copy(j2, str2, map5, map7, map8);
    }
    ...
    public final ReleaseChannel copy(long j, String id, Map<String, FileV2> icon, Map<String, String> name, Map<String, String> description) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(icon, "icon");
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(description, "description");
        return new ReleaseChannel(j, id, icon, name, description);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReleaseChannel) {
            ReleaseChannel releaseChannel = (ReleaseChannel) obj;
    ...
    public String toString() {
        ...
        return "ReleaseChannel(repoId=" + j + ", id=" + str + ", icon=" + map + ", name=" + map2 + ", description=" + map3 + ")";
    }
    ...
    public /* synthetic */ ReleaseChannel(long j, String str, Map map, Map map2, Map map3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, str, (i & 4) != 0 ? MapsKt__MapsKt.emptyMap() : map, map2, map3);
    }
