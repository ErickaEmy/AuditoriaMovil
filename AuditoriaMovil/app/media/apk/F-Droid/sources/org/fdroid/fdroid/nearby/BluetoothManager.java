...
public class BluetoothManager {
    ...
    public static void start(final Context context2) {
        ...
        handlerThread = new HandlerThread(TAG, 1) { // from class: org.fdroid.fdroid.nearby.BluetoothManager.1
            ...
            protected void onLooperPrepared() {
                ...
                for (BluetoothDevice bluetoothDevice : BluetoothManager.bluetoothAdapter.getBondedDevices()) {
                    BluetoothManager.sendFoundBroadcast(context2, bluetoothDevice);
                }
            }
        };
        handlerThread.start();
