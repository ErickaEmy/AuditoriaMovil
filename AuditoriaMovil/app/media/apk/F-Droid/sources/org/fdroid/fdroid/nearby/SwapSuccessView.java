...
public class SwapSuccessView extends SwapView {
    ...
    protected void onFinishInflate() {
        ...
        getActivity().getSwapService().getIndex().observe(getActivity(), new Observer() { // from class: org.fdroid.fdroid.nearby.SwapSuccessView$$ExternalSyntheticLambda0
            ...
            public final void onChanged(Object obj) {
                SwapSuccessView.this.onIndexReceived((IndexV1) obj);
            }
        });
    }
    ...
    public void onIndexReceived(IndexV1 indexV1) {
        ...
        HashMap hashMap = new HashMap(indexV1.getApps().size());
        ...
        for (AppV1 appV1 : indexV1.getApps()) {
            ...
            if (list != null && list.get(0) != null) {
                ...
                for (PermissionV1 permissionV1 : packageV1.getUsesPermission()) {
                    arrayList2.add(permissionV1.getName());
                }
            ...
            arrayList.add(app);
            hashMap.put(app.packageName, apk);
        }
        this.adapter.setApps(arrayList, hashMap);
    }
    ...
    public class AppListAdapter extends RecyclerView.Adapter {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
                    ...
                    switch (c) {
                        ...
                        case 4:
                            ...
                            if (intent.hasExtra(DownloaderService.EXTRA_ERROR_MESSAGE)) {
                                ...
                                Toast.makeText(context, intent.getStringExtra(DownloaderService.EXTRA_ERROR_MESSAGE) + " " + intent.getDataString(), 1).show();
                            } else {
            ...
            ViewHolder(View view) {
                ...
                this.iconView = (ImageView) view.findViewById(16908294);
            ...
            public void resetView() {
                ...
                Glide.with(this.iconView.getContext()).load(Utils.getGlideModel(SwapSuccessView.this.repo, this.app.iconFile)).apply((BaseRequestOptions) Utils.getAlwaysShowIconRequestOptions()).into(this.iconView);
                ...
                } else if (this.app.isInstalled(SwapSuccessView.this.getContext())) {
