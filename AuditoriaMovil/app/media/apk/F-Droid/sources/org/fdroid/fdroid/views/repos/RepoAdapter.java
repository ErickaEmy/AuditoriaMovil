...
public class RepoAdapter extends RecyclerView.Adapter {
    ...
    public RepoAdapter(RepoItemListener repoItemListener) {
    ...
    public void updateItems(List<Repository> list) {
        this.items.clear();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void updateRepoItem(Repository repository) {
        ...
        public void bind(final Repository repository) {
            this.rootView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.repos.RepoAdapter$RepoViewHolder$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    RepoAdapter.RepoViewHolder.this.lambda$bind$0(repository, view);
                }
            });
            ...
            this.switchView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.repos.RepoAdapter$RepoViewHolder$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    RepoAdapter.RepoViewHolder.this.lambda$bind$1(repository, view);
                }
            });
            ...
            if (icon == null) {
                ...
                Glide.with(this.imageView.getContext()).load(Utils.getGlideModel(repository, icon)).apply((BaseRequestOptions) Utils.getAlwaysShowIconRequestOptions()).into(this.imageView);
            }
