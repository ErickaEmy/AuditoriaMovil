...
public class AppDetailsRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public void updateItems(App app, List<Apk> list, AppPrefs appPrefs) {
        ...
        if (list != null) {
            for (Apk apk : list) {
                boolean z = apk.compatible || showIncompatibleVersions;
                String str = app.installedSigner;
                boolean z2 = str == null || showIncompatibleVersions || TextUtils.equals(str, apk.signer);
                if (z) {
        ...
        if (list != null) {
            Apk findSuggestedApk = app.findSuggestedApk(list, appPrefs);
            String str2 = app.installedSigner;
            if (str2 == null || (findSuggestedApk != null && str2.equals(findSuggestedApk.signer))) {
                this.suggestedApk = findSuggestedApk;
            }
        }
        addItem(0);
    ...
    public void setRepos(List<Repository> list, long j) {
        this.repos.clear();
    ...
    public void setShowVersions(boolean z, boolean z2) {
        ...
        int indexOf = this.items.indexOf(5);
        int i = indexOf + 1;
        if (!z) {
            if (removeAll) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 7:
                return new VersionsLoadingViewHolder(from.inflate(R.layout.app_details2_loading, viewGroup, false));
            case 8:
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        HeaderViewHolder(View view) {
            ...
            button.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$new$0(view2);
                }
            });
        }
        ...
        void setProgress(long j, long j2) {
            ...
            textView.setText(Utils.getFriendlySize(j) + " / " + Utils.getFriendlySize(j2));
        ...
        void bindModel() {
            ...
            if (AppDetailsRecyclerViewAdapter.this.app.lastUpdated != null) {
                String formatLastUpdated = Utils.formatLastUpdated(this.lastUpdateView.getContext().getResources(), AppDetailsRecyclerViewAdapter.this.app.lastUpdated);
                if (Preferences.get().expertMode() && AppDetailsRecyclerViewAdapter.this.suggestedApk != null && AppDetailsRecyclerViewAdapter.this.suggestedApk.apkFile != null && AppDetailsRecyclerViewAdapter.this.suggestedApk.apkFile.getSize() != null) {
                    formatLastUpdated = formatLastUpdated + " (" + Formatter.formatFileSize(AppDetailsRecyclerViewAdapter.this.context, AppDetailsRecyclerViewAdapter.this.suggestedApk.apkFile.getSize().longValue()) + ")";
                }
                this.lastUpdateView.setText(formatLastUpdated);
            ...
            if (AppDetailsRecyclerViewAdapter.this.app != null && AppDetailsRecyclerViewAdapter.this.preferredRepoId != null) {
                ...
                if (AppDetailsRecyclerViewAdapter.this.repos.size() > 1 || (repository != null && !defaultRepoAddresses.contains(repository.getAddress()))) {
                    ...
                    long longValue = AppDetailsRecyclerViewAdapter.this.preferredRepoId.longValue();
                    Consumer consumer = new Consumer() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda1
                        @Override // androidx.core.util.Consumer
                        public final void accept(Object obj) {
                            AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$1((Repository) obj);
                        }
                    };
                    ...
                    RepoChooserKt.setContentRepoChooser(composeView, list, j, longValue, consumer, new Consumer() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda2
                        @Override // androidx.core.util.Consumer
                        public final void accept(Object obj) {
                            AppDetailsRecyclerViewAdapter.AppDetailsRecyclerViewAdapterCallbacks.this.onPreferredRepoChanged(((Long) obj).longValue());
                        }
                    });
            ...
            if (AppDetailsRecyclerViewAdapter.this.suggestedApk == null && AppDetailsRecyclerViewAdapter.this.repos.size() > 1 && AppDetailsRecyclerViewAdapter.this.app.installedSigner != null && AppDetailsRecyclerViewAdapter.this.preferredRepoId != null && AppDetailsRecyclerViewAdapter.this.preferredRepoId.longValue() == AppDetailsRecyclerViewAdapter.this.app.repoId && !AppDetailsRecyclerViewAdapter.this.versionsLoading) {
                ...
                this.warningView.setBackgroundColor(ContextCompat.getColor(AppDetailsRecyclerViewAdapter.this.context, R.color.warning));
            ...
            Spanned fromHtml = HtmlCompat.fromHtml(AppDetailsRecyclerViewAdapter.this.app.description, 0, null, new Utils.HtmlTagHandler());
            ...
            this.descriptionView.post(new Runnable() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$2();
                }
            });
            ...
            this.buttonSecondaryView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$3(view2);
                }
            });
            if (AppDetailsRecyclerViewAdapter.this.callbacks.isAppDownloading()) {
                ...
                this.buttonPrimaryView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$4(view2);
                    }
                });
            } else if (AppDetailsRecyclerViewAdapter.this.app.isInstalled(AppDetailsRecyclerViewAdapter.this.context)) {
                if (AppDetailsRecyclerViewAdapter.this.app.canAndWantToUpdate(AppDetailsRecyclerViewAdapter.this.suggestedApk)) {
                    ...
                    this.buttonPrimaryView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda6
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                            AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$5(view2);
                        }
                    });
                } else {
                    ...
                    if (!AppDetailsRecyclerViewAdapter.this.context.getPackageName().equals(AppDetailsRecyclerViewAdapter.this.app.packageName) && AppDetailsRecyclerViewAdapter.this.context.getPackageManager().getLaunchIntentForPackage(AppDetailsRecyclerViewAdapter.this.app.packageName) != null) {
                        ...
                        this.buttonPrimaryView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda7
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view2) {
                                AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$6(view2);
                            }
                        });
                        ...
                        if (!installedMediaFile.toString().startsWith(AppDetailsRecyclerViewAdapter.this.context.getApplicationInfo().dataDir)) {
                            ...
                            if (!AppDetailsRecyclerViewAdapter.this.context.getPackageManager().queryIntentActivities(intent, 0).isEmpty()) {
                                ...
                                this.buttonPrimaryView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda8
                                    @Override // android.view.View.OnClickListener
                                    public final void onClick(View view2) {
                                        AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$7(intent, view2);
                                    }
                                });
                            } else {
                                this.buttonPrimaryView.setVisibility(8);
            ...
            this.progressCancel.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$HeaderViewHolder$$ExternalSyntheticLambda9
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    AppDetailsRecyclerViewAdapter.HeaderViewHolder.this.lambda$bindModel$8(view2);
                }
            });
        ...
        private void updateAntiFeaturesWarning() {
            ...
            } else if (this.descriptionIsExpanded) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public class DonateViewHolder extends AppDetailsViewHolder {
        ...
        public void bindModel() {
            ...
            if (appDetailsRecyclerViewAdapter.uriIsSetAndCanBeOpened(appDetailsRecyclerViewAdapter.app.getLiberapayUri())) {
            ...
            if (appDetailsRecyclerViewAdapter2.uriIsSetAndCanBeOpened(appDetailsRecyclerViewAdapter2.app.getOpenCollectiveUri())) {
        ...
        private void addDonateOption(int i, final String str) {
            ...
            if (i == R.layout.donate_generic) {
                ...
                ((TextView) inflate).setText(str.substring(8));
            }
            inflate.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$DonateViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AppDetailsRecyclerViewAdapter.DonateViewHolder.this.lambda$addDonateOption$0(str, view);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public static abstract class ExpandableLinearLayoutViewHolder extends AppDetailsViewHolder {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public class VersionsViewHolder extends ExpandableLinearLayoutViewHolder {
        ...
        public void bindModel() {
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$VersionsViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AppDetailsRecyclerViewAdapter.VersionsViewHolder.this.lambda$bindModel$0(view);
                }
            });
        ...
        public /* synthetic */ void lambda$bindModel$0(View view) {
            AppDetailsRecyclerViewAdapter appDetailsRecyclerViewAdapter = AppDetailsRecyclerViewAdapter.this;
            appDetailsRecyclerViewAdapter.setShowVersions(!appDetailsRecyclerViewAdapter.showVersions, true);
            updateExpandableItem(AppDetailsRecyclerViewAdapter.this.showVersions);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public class NoVersionsViewHolder extends AppDetailsViewHolder {
        final TextView headerView;
        ...
        NoVersionsViewHolder(View view) {
            ...
            DrawableCompat.setTint(mutate, Color.parseColor("#B4B4B4"));
            TextViewCompat.setCompoundDrawablesRelativeWithIntrinsicBounds(textView, mutate, (Drawable) null, (Drawable) null, (Drawable) null);
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$NoVersionsViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    AppDetailsRecyclerViewAdapter.NoVersionsViewHolder.this.lambda$new$0(view2);
                }
            });
        }
        ...
        private void explainIncompatibleVersions() {
            ...
            new AlertDialog.Builder(AppDetailsRecyclerViewAdapter.this.context).setTitle(string).setMessage(string2).setPositiveButton(R.string.menu_settings, new DialogInterface.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$NoVersionsViewHolder$$ExternalSyntheticLambda1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    AppDetailsRecyclerViewAdapter.NoVersionsViewHolder.this.lambda$explainIncompatibleVersions$1(dialogInterface, i);
                }
        ...
        public /* synthetic */ void lambda$explainIncompatibleVersions$1(DialogInterface dialogInterface, int i) {
            Intent intent = new Intent(AppDetailsRecyclerViewAdapter.this.context, MainActivity.class);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public class PermissionsViewHolder extends ExpandableLinearLayoutViewHolder {
        @Override // org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter.ExpandableLinearLayoutViewHolder
        protected int getIcon() {
        ...
        public void bindModel() {
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$PermissionsViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AppDetailsRecyclerViewAdapter.PermissionsViewHolder.this.lambda$bindModel$0(view);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public class LinksViewHolder extends ExpandableLinearLayoutViewHolder {
        @Override // org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter.ExpandableLinearLayoutViewHolder
        protected int getIcon() {
        ...
        public void bindModel() {
            ...
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$LinksViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AppDetailsRecyclerViewAdapter.LinksViewHolder.this.lambda$bindModel$0(view);
                }
            });
            ...
            if (!TextUtils.isEmpty(AppDetailsRecyclerViewAdapter.this.app.license)) {
                ...
                if (AppDetailsRecyclerViewAdapter.this.uriIsSetAndCanBeOpened(str2)) {
                    AppDetailsRecyclerViewAdapter appDetailsRecyclerViewAdapter = AppDetailsRecyclerViewAdapter.this;
                    appDetailsRecyclerViewAdapter.addLinkItemView(this.contentView, R.string.menu_license, R.drawable.ic_license, str2, appDetailsRecyclerViewAdapter.app.license);
                }
            }
            AppDetailsRecyclerViewAdapter appDetailsRecyclerViewAdapter2 = AppDetailsRecyclerViewAdapter.this;
    ...
    public class VersionViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindModel(final Apk apk) {
            ...
            boolean z = true;
            boolean z2 = apk.versionCode == AppDetailsRecyclerViewAdapter.this.app.installedVersionCode && TextUtils.equals(apk.signer, AppDetailsRecyclerViewAdapter.this.app.installedSigner);
            boolean equals = apk.equals(AppDetailsRecyclerViewAdapter.this.suggestedApk);
            boolean z3 = AppDetailsRecyclerViewAdapter.this.callbacks.isAppDownloading() && AppDetailsRecyclerViewAdapter.this.downloadedApk != null && AppDetailsRecyclerViewAdapter.this.downloadedApk.compareTo(apk) == 0 && TextUtils.equals(apk.getApkPath(), AppDetailsRecyclerViewAdapter.this.downloadedApk.getApkPath());
            boolean z4 = apk.versionCode == AppDetailsRecyclerViewAdapter.this.app.installedVersionCode && apk.compatible && apk.size == 0 && apk.maxSdkVersion == -1;
            this.version.setText(apk.versionName);
            this.statusSuggested.setVisibility((equals && apk.compatible) ? 0 : 8);
            ...
            showActionButton(this.buttonInstallUpgrade, z2, z3);
            if (isInstalled && !z2) {
            ...
            this.busyIndicator.setVisibility(z3 ? 0 : 8);
            ...
            if (!Boolean.TRUE.equals((Boolean) AppDetailsRecyclerViewAdapter.this.versionsExpandTracker.get(apk.getApkPath())) && !z3) {
                z = false;
            }
            expand(z);
            if (!z4) {
                ...
                this.itemView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$VersionViewHolder$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        AppDetailsRecyclerViewAdapter.VersionViewHolder.this.lambda$bindModel$0(view);
                    }
                });
            } else {
            ...
            if (apk.versionName != null) {
                this.itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$VersionViewHolder$$ExternalSyntheticLambda2
                    ...
                    public final boolean onLongClick(View view) {
                        boolean lambda$bindModel$1;
                        lambda$bindModel$1 = AppDetailsRecyclerViewAdapter.VersionViewHolder.this.lambda$bindModel$1(apk, view);
                        return lambda$bindModel$1;
                    }
                });
            }
        }
        ...
        private void showActionButton(Button button, boolean z, boolean z2) {
            ...
            z3 = (!this.apk.compatible || z || AppDetailsRecyclerViewAdapter.this.callbacks.isAppDownloading()) ? true : true;
            ...
            this.buttonAction.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$VersionViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AppDetailsRecyclerViewAdapter.VersionViewHolder.this.lambda$showActionButton$2(view);
                }
            });
        }
        ...
        private void toggleExpanded() {
            ...
            boolean equals = Boolean.FALSE.equals(AppDetailsRecyclerViewAdapter.this.versionsExpandTracker.get(this.apk.getApkPath()));
            expand(equals);
            if (equals) {
                LinearLayoutManager linearLayoutManager = (LinearLayoutManager) AppDetailsRecyclerViewAdapter.this.recyclerView.getLayoutManager();
    ...
    public void addLinkItemView(ViewGroup viewGroup, int i, int i2, final String str, String str2) {
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AppDetailsRecyclerViewAdapter.this.lambda$addLinkItemView$0(str, view);
            }
        });
        textView.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.fdroid.fdroid.views.AppDetailsRecyclerViewAdapter$$ExternalSyntheticLambda1
            @Override // android.view.View.OnLongClickListener
            public final boolean onLongClick(View view) {
                boolean lambda$addLinkItemView$1;
                lambda$addLinkItemView$1 = AppDetailsRecyclerViewAdapter.this.lambda$addLinkItemView$1(string, str, view);
                return lambda$addLinkItemView$1;
            }
        });
    }
