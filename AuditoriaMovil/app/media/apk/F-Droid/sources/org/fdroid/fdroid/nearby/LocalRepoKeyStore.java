...
public final class LocalRepoKeyStore {
    ...
    private LocalRepoKeyStore(Context context) throws InitException {
        ...
        try {
            ...
            if (this.keyStore.getKey(INDEX_CERT_ALIAS, "".toCharArray()) == null) {
                ...
                addToStore(INDEX_CERT_ALIAS, generateRandomKeypair, generateSelfSignedCertChain(generateRandomKeypair, new X500Name(DEFAULT_INDEX_CERT_INFO)));
            }
    ...
    private void addToStore(String str, KeyPair keyPair, Certificate certificate) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException, UnrecoverableKeyException {
    ...
    public static Certificate generateSelfSignedCertChain(KeyPair keyPair, X500Name x500Name) throws CertificateException, OperatorCreationException, IOException {
        return generateSelfSignedCertChain(keyPair, x500Name, null);
    }

    public static Certificate generateSelfSignedCertChain(KeyPair keyPair, X500Name x500Name, String str) throws CertificateException, OperatorCreationException, IOException {
        SecureRandom secureRandom = new SecureRandom();
        PrivateKey privateKey = keyPair.getPrivate();
        PublicKey publicKey = keyPair.getPublic();
        ContentSigner build = new JcaContentSignerBuilder(DEFAULT_SIG_ALG).build(privateKey);
        ...
        return new JcaX509CertificateConverter().getCertificate(x509v3CertificateBuilder.build(build));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes2.dex */
    public static final class KerplappKeyManager implements X509KeyManager {
