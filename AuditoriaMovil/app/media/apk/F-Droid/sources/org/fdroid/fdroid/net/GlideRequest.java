...
public class GlideRequest<TranscodeType> extends RequestBuilder {
    ...
    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2473load(Object obj) {
        return (GlideRequest) super.load(obj);
    }

    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2468load(Bitmap bitmap) {
        return (GlideRequest) super.load(bitmap);
    }

    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2469load(Drawable drawable) {
        return (GlideRequest) super.load(drawable);
    }

    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2474load(String str) {
        return (GlideRequest) super.load(str);
    }

    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2470load(Uri uri) {
        return (GlideRequest) super.load(uri);
    }

    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2471load(File file) {
        return (GlideRequest) super.load(file);
    }

    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2472load(Integer num) {
    ...
    @Deprecated
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2475load(URL url) {
        return (GlideRequest) super.load(url);
    }

    @Override // com.bumptech.glide.RequestBuilder
    /* renamed from: load */
    public GlideRequest<TranscodeType> m2476load(byte[] bArr) {
        return (GlideRequest) super.load(bArr);
    }

    @Override // com.bumptech.glide.RequestBuilder, com.bumptech.glide.request.BaseRequestOptions
    /* renamed from: clone */
    public GlideRequest<TranscodeType> mo2026clone() {
        return (GlideRequest) super.mo2026clone();
    }
}
