...
public interface RepoFetcher {
    Object fetchRepo(Uri uri, Repository repository, RepoPreviewReceiver repoPreviewReceiver, String str, Continuation continuation) throws IOException, SigningException, NotFoundException, SerializationException;
}
