...
public class UpdatesAdapter extends RecyclerView.Adapter {
    ...
    public UpdatesAdapter(AppCompatActivity appCompatActivity) {
        ...
        adapterDelegatesManager.addDelegate(new AppStatus.Delegate(appCompatActivity)).addDelegate(new UpdateableApp.Delegate(appCompatActivity)).addDelegate(new UpdateableAppsHeader.Delegate(appCompatActivity)).addDelegate(new KnownVulnApp.Delegate(appCompatActivity, new Runnable() { // from class: org.fdroid.fdroid.views.updates.UpdatesAdapter$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                UpdatesAdapter.this.loadUpdatableApps();
            }
        }));
    ...
    public void loadUpdatableApps() {
        ...
        this.disposable = Utils.runOffUiThread(new Supplier() { // from class: org.fdroid.fdroid.views.updates.UpdatesAdapter$$ExternalSyntheticLambda1
            @Override // androidx.core.util.Supplier
            public final Object get() {
                List lambda$loadUpdatableApps$0;
                lambda$loadUpdatableApps$0 = UpdatesAdapter.this.lambda$loadUpdatableApps$0(backendReleaseChannels);
                return lambda$loadUpdatableApps$0;
            }
        }, new Consumer() { // from class: org.fdroid.fdroid.views.updates.UpdatesAdapter$$ExternalSyntheticLambda2
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                UpdatesAdapter.this.onCanUpdateLoadFinished((List) obj);
            }
        });
    }
    ...
    private void populateAppStatuses() {
        ...
        Collections.sort(this.appsToShowStatus, new Comparator() { // from class: org.fdroid.fdroid.views.updates.UpdatesAdapter$$ExternalSyntheticLambda3
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int lambda$populateAppStatuses$1;
                lambda$populateAppStatuses$1 = UpdatesAdapter.lambda$populateAppStatuses$1((AppStatus) obj, (AppStatus) obj2);
                return lambda$populateAppStatuses$1;
            }
        });
    }
