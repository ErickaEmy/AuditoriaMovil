...
public class GlideRequests extends RequestManager {
    ...
    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2477load(Bitmap bitmap) {
        return (GlideRequest) super.load(bitmap);
    }

    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2478load(Drawable drawable) {
        return (GlideRequest) super.load(drawable);
    }

    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2483load(String str) {
        return (GlideRequest) super.load(str);
    }

    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2479load(Uri uri) {
        return (GlideRequest) super.load(uri);
    }

    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2480load(File file) {
        return (GlideRequest) super.load(file);
    }

    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2481load(Integer num) {
    ...
    @Deprecated
    /* renamed from: load */
    public GlideRequest<Drawable> m2484load(URL url) {
        return (GlideRequest) super.load(url);
    }

    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2485load(byte[] bArr) {
        return (GlideRequest) super.load(bArr);
    }

    @Override // com.bumptech.glide.RequestManager
    /* renamed from: load */
    public GlideRequest<Drawable> m2482load(Object obj) {
