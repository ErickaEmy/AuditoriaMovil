...
public class FileInstallerActivity extends FragmentActivity {
    ...
    private void showDialog() {
        new AlertDialog.Builder(this, R.style.Theme_App).setMessage(R.string.app_permission_storage).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: org.fdroid.fdroid.installer.FileInstallerActivity$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                FileInstallerActivity.this.lambda$showDialog$0(dialogInterface, i);
            }
            ...
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                FileInstallerActivity.this.lambda$showDialog$1(dialogInterface, i);
            }
        }).create().show();
    }
