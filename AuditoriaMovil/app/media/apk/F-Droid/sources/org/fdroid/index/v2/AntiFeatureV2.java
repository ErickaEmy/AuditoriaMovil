...
public final class AntiFeatureV2 {
    ...
    public static /* synthetic */ AntiFeatureV2 copy$default(AntiFeatureV2 antiFeatureV2, Map map, Map map2, Map map3, int i, Object obj) {
        if ((i & 1) != 0) {
            map = antiFeatureV2.icon;
        }
        if ((i & 2) != 0) {
            map2 = antiFeatureV2.name;
        }
        if ((i & 4) != 0) {
            map3 = antiFeatureV2.description;
        }
        return antiFeatureV2.copy(map, map2, map3);
    }
    ...
    public final AntiFeatureV2 copy(Map<String, FileV2> icon, Map<String, String> name, Map<String, String> description) {
        Intrinsics.checkNotNullParameter(icon, "icon");
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(description, "description");
        return new AntiFeatureV2(icon, name, description);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AntiFeatureV2) {
            AntiFeatureV2 antiFeatureV2 = (AntiFeatureV2) obj;
            return Intrinsics.areEqual(this.icon, antiFeatureV2.icon) && Intrinsics.areEqual(this.name, antiFeatureV2.name) && Intrinsics.areEqual(this.description, antiFeatureV2.description);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "AntiFeatureV2(icon=" + map + ", name=" + map2 + ", description=" + map3 + ")";
    }

    /* compiled from: IndexV2.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, d2 = {"Lorg/fdroid/index/v2/AntiFeatureV2$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lorg/fdroid/index/v2/AntiFeatureV2;", "index_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final KSerializer serializer() {
            return AntiFeatureV2$$serializer.INSTANCE;
        }
    }
    ...
    public /* synthetic */ AntiFeatureV2(int i, Map map, Map map2, Map map3, SerializationConstructorMarker serializationConstructorMarker) {
        Map<String, String> emptyMap;
        if (2 != (i & 2)) {
            PluginExceptionsKt.throwMissingFieldException(i, 2, AntiFeatureV2$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public AntiFeatureV2(Map<String, FileV2> icon, Map<String, String> name, Map<String, String> description) {
        Intrinsics.checkNotNullParameter(icon, "icon");
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(description, "description");
        this.icon = icon;
    ...
    */
    public static final /* synthetic */ void write$Self$index_release(org.fdroid.index.v2.AntiFeatureV2 r4, kotlinx.serialization.encoding.CompositeEncoder r5, kotlinx.serialization.descriptors.SerialDescriptor r6) {
        /*
            kotlinx.serialization.KSerializer[] r0 = org.fdroid.index.v2.AntiFeatureV2.$childSerializers
            r1 = 0
        ...
        L40:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.fdroid.index.v2.AntiFeatureV2.write$Self$index_release(org.fdroid.index.v2.AntiFeatureV2, kotlinx.serialization.encoding.CompositeEncoder, kotlinx.serialization.descriptors.SerialDescriptor):void");
    }

    public /* synthetic */ AntiFeatureV2(Map map, Map map2, Map map3, int i, DefaultConstructorMarker defaultConstructorMarker) {
