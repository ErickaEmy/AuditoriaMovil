...
public class AndroidContextUtil {
    ...
    public static boolean containsProperties(String str) {
        return str.contains(CoreConstants.DATA_DIR_KEY) || str.contains(CoreConstants.EXT_DIR_KEY) || str.contains(CoreConstants.PACKAGE_NAME_KEY) || str.contains(CoreConstants.VERSION_CODE_KEY) || str.contains(CoreConstants.VERSION_NAME_KEY);
    }
