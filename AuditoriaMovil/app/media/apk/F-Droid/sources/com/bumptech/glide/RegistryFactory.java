...
public abstract class RegistryFactory {
    /* JADX INFO: Access modifiers changed from: package-private */
    public static GlideSuppliers.GlideSupplier lazilyCreateAndInitializeRegistry(final Glide glide, final List list, final AppGlideModule appGlideModule) {
    ...
    private static void initializeDefaults(Context context, Registry registry, BitmapPool bitmapPool, ArrayPool arrayPool, GlideExperiments glideExperiments) {
        ...
        ModelLoaderFactory inputStreamFactory = DirectResourceLoader.inputStreamFactory(context);
        ModelLoaderFactory assetFileDescriptorFactory = DirectResourceLoader.assetFileDescriptorFactory(context);
        ModelLoaderFactory drawableFactory = DirectResourceLoader.drawableFactory(context);
        Class cls2 = Integer.TYPE;
        registry2.append(cls2, InputStream.class, inputStreamFactory).append(Integer.class, InputStream.class, inputStreamFactory).append(cls2, AssetFileDescriptor.class, assetFileDescriptorFactory).append(Integer.class, AssetFileDescriptor.class, assetFileDescriptorFactory).append(cls2, Drawable.class, drawableFactory).append(Integer.class, Drawable.class, drawableFactory).append(Uri.class, InputStream.class, ResourceUriLoader.newStreamFactory(context)).append(Uri.class, AssetFileDescriptor.class, ResourceUriLoader.newAssetFileDescriptorFactory(context));
        ...
        Class cls3 = cls;
        registry2.append(Integer.class, Uri.class, uriFactory).append(cls2, Uri.class, uriFactory).append(Integer.class, AssetFileDescriptor.class, assetFileDescriptorFactory2).append(cls2, AssetFileDescriptor.class, assetFileDescriptorFactory2).append(Integer.class, InputStream.class, streamFactory).append(cls2, InputStream.class, streamFactory);
        ...
        registry2.append(ByteBuffer.class, cls3, new BitmapDrawableDecoder(resources, byteBuffer));
    }
