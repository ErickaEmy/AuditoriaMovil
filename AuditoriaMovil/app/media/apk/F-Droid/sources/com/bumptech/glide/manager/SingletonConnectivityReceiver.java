...
final class SingletonConnectivityReceiver {
    ...
    private SingletonConnectivityReceiver(final Context context) {
        ...
        GlideSuppliers.GlideSupplier memorize = GlideSuppliers.memorize(new GlideSuppliers.GlideSupplier() { // from class: com.bumptech.glide.manager.SingletonConnectivityReceiver.1
