...
public abstract class BaseRequestOptions implements Cloneable {
    ...
    public BaseRequestOptions sizeMultiplier(float f) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().sizeMultiplier(f);
        }
        if (f < 0.0f || f > 1.0f) {
    ...
    public BaseRequestOptions useUnlimitedSourceGeneratorsPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().useUnlimitedSourceGeneratorsPool(z);
        }
    ...
    public BaseRequestOptions useAnimationPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().useAnimationPool(z);
        }
    ...
    public BaseRequestOptions onlyRetrieveFromCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().onlyRetrieveFromCache(z);
        }
    ...
    public BaseRequestOptions diskCacheStrategy(DiskCacheStrategy diskCacheStrategy) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().diskCacheStrategy(diskCacheStrategy);
        }
    ...
    public BaseRequestOptions priority(Priority priority) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().priority(priority);
        }
    ...
    public BaseRequestOptions placeholder(Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().placeholder(drawable);
        }
    ...
    public BaseRequestOptions placeholder(int i) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().placeholder(i);
        }
    ...
    public BaseRequestOptions fallback(Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().fallback(drawable);
        }
    ...
    public BaseRequestOptions error(Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().error(drawable);
        }
    ...
    public BaseRequestOptions theme(Resources.Theme theme) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().theme(theme);
        }
        this.theme = theme;
        if (theme != null) {
            this.fields |= 32768;
    ...
    public BaseRequestOptions skipMemoryCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().skipMemoryCache(true);
        }
        this.isCacheable = !z;
        this.fields |= 256;
        return selfOrThrowIfLocked();
    ...
    public BaseRequestOptions override(int i, int i2) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().override(i, i2);
        }
    ...
    public BaseRequestOptions signature(Key key) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().signature(key);
        }
    ...
    @Override // 
    /* renamed from: clone */
    public BaseRequestOptions mo2026clone() {
        try {
    ...
    public BaseRequestOptions set(Option option, Object obj) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().set(option, obj);
        }
    ...
    BaseRequestOptions removeOption(Option option) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().removeOption(option);
        }
    ...
    final BaseRequestOptions optionalTransform(DownsampleStrategy downsampleStrategy, Transformation transformation) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().optionalTransform(downsampleStrategy, transformation);
        }
    ...
    final BaseRequestOptions transform(DownsampleStrategy downsampleStrategy, Transformation transformation) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().transform(downsampleStrategy, transformation);
        }
        downsample(downsampleStrategy);
    ...
    BaseRequestOptions transform(Transformation transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().transform(transformation, z);
        }
    ...
    <Y> BaseRequestOptions transform(Class<Y> cls, Transformation transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().transform(cls, transformation, z);
        }
    ...
    public BaseRequestOptions dontTransform() {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().dontTransform();
        }
    ...
    public BaseRequestOptions apply(BaseRequestOptions baseRequestOptions) {
        if (this.isAutoCloneEnabled) {
            return mo2026clone().apply(baseRequestOptions);
        }
