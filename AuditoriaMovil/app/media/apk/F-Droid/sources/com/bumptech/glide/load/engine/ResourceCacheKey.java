...
final class ResourceCacheKey implements Key {
    ...
    public String toString() {
        return "ResourceCacheKey{sourceKey=" + this.sourceKey + ", signature=" + this.signature + ", width=" + this.width + ", height=" + this.height + ", decodedResourceClass=" + this.decodedResourceClass + ", transformation='" + this.transformation + CoreConstants.SINGLE_QUOTE_CHAR + ", options=" + this.options + CoreConstants.CURLY_RIGHT;
    }
}
