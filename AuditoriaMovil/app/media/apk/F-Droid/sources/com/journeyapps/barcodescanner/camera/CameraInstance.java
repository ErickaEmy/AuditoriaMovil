...
public class CameraInstance {
        ...
        if (this.open) {
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    CameraInstance.this.lambda$setTorch$0(z);
                }
            });
        }
    }
    ...
    public void requestPreview(final PreviewCallback previewCallback) {
        this.mainHandler.post(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                CameraInstance.this.lambda$requestPreview$3(previewCallback);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$requestPreview$3(final PreviewCallback previewCallback) {
        if (!this.open) {
            ...
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    CameraInstance.this.lambda$requestPreview$2(previewCallback);
                }
            });
        }
    }
