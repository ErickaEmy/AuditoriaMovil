...
public abstract class FloatingActionButtonImpl {
    ...
    public void hide(InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            createDefaultAnimator.addListener(new AnimatorListenerAdapter(z, internalVisibilityChangedListener) { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.1
            ...
            if (arrayList != null) {
                ...
                while (it.hasNext()) {
                    createDefaultAnimator.addListener((Animator.AnimatorListener) it.next());
                }
            }
    ...
    public void show(InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            createDefaultAnimator.addListener(new AnimatorListenerAdapter(z, internalVisibilityChangedListener) { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.2
                final /* synthetic */ boolean val$fromUser;
                final /* synthetic */ InternalVisibilityChangedListener val$listener;
    ...
    public void getPadding(Rect rect) {
        ...
        int max = Math.max(touchTargetPadding, (int) Math.ceil(elevation));
        int max2 = Math.max(touchTargetPadding, (int) Math.ceil(elevation * 1.5f));
