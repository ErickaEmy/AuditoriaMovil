...
public final class Detector {
    ...
    public DetectorResult detect() {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            int max = Math.max(transitionsBetween(resultPoint13, resultPoint).getTransitions(), transitionsBetween(resultPoint11, resultPoint).getTransitions());
            int i4 = max + 1;
            int i5 = (i4 & 1) == 1 ? max + 2 : i4;
            sampleGrid = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, resultPoint, i5, i5);
            resultPoint2 = resultPoint13;
        }
