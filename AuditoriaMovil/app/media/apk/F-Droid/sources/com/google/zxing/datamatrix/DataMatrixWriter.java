    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map map) {
        ...
        if (barcodeFormat == BarcodeFormat.DATA_MATRIX) {
            ...
            if (map != null) {
                ...
                ToolbarActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(map.get(EncodeHintType.MIN_SIZE));
                ToolbarActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(map.get(EncodeHintType.MAX_SIZE));
            }
