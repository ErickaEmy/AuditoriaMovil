...
public abstract class Detector {
    ...
    public static PDF417DetectorResult detect(BinaryBitmap binaryBitmap, Map map, boolean z) {
        BitMatrix blackMatrix = binaryBitmap.getBlackMatrix();
        List detect = detect(z, blackMatrix);
        if (detect.isEmpty()) {
            blackMatrix = blackMatrix.m2049clone();
    ...
    */
    private static java.util.List detect(boolean r8, com.google.zxing.common.BitMatrix r9) {
        /*
