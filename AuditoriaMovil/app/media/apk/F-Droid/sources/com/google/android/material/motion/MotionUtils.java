...
public abstract class MotionUtils {
    ...
    private static TimeInterpolator getLegacyThemeInterpolator(String str) {
        ...
        } else if (isLegacyEasingType(str, BonjourPeer.PATH)) {
            return PathInterpolatorCompat.create(PathParser.createPathFromPathData(getLegacyEasingContent(str, BonjourPeer.PATH)));
        } else {
    ...
    private static boolean isLegacyEasingAttribute(String str) {
        return isLegacyEasingType(str, "cubic-bezier") || isLegacyEasingType(str, BonjourPeer.PATH);
    }
