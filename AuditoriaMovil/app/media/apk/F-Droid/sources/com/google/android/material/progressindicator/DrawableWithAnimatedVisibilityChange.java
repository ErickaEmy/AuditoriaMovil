...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable {
    private static final Property GROW_FRACTION = new Property(Float.class, "growFraction") { // from class: com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange.3
    ...
    public void dispatchAnimationStart() {
        ...
        for (Animatable2Compat$AnimationCallback animatable2Compat$AnimationCallback2 : list) {
            animatable2Compat$AnimationCallback2.onAnimationStart(this);
        }
    }
    ...
    public void dispatchAnimationEnd() {
        ...
        for (Animatable2Compat$AnimationCallback animatable2Compat$AnimationCallback2 : list) {
            animatable2Compat$AnimationCallback2.onAnimationEnd(this);
        }
    }
