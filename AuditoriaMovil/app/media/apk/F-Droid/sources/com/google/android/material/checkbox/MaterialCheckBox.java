    ...
    */
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (m = AndroidAutofill$$ExternalSyntheticApiModelOutline1.m(getContext().getSystemService(AndroidAutofill$$ExternalSyntheticApiModelOutline0.m()))) != null) {
                m.notifyValueChanged(this);
            }
