...
public class ElevationOverlayProvider {
    ...
    public int compositeOverlay(int i, float f) {
        ...
        int layer = MaterialColors.layer(ColorUtils.setAlphaComponent(i, GF2Field.MASK), this.elevationOverlayColor, calculateOverlayAlphaFraction);
    ...
    private boolean isThemeSurfaceColor(int i) {
        return ColorUtils.setAlphaComponent(i, GF2Field.MASK) == this.colorSurface;
    }
}
