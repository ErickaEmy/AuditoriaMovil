...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void startPickerFragment() {
        ...
        getDateSelector();
        MaterialCalendar newInstance = MaterialCalendar.newInstance(null, themeResId, this.calendarConstraints, null);
        this.calendar = newInstance;
        PickerFragment pickerFragment = newInstance;
        if (this.inputMode == 1) {
            getDateSelector();
            pickerFragment = MaterialTextInputPicker.newInstance(null, themeResId, this.calendarConstraints);
        }
