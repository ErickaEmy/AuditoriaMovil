...
public final class MultiBrowseCarouselStrategy extends CarouselStrategy {
    ...
    public KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        ...
        int max = (ceil - ((int) Math.max(1.0d, Math.floor(((containerHeight - (CarouselStrategyHelper.maxValue(iArr4) * f3)) - (CarouselStrategyHelper.maxValue(iArr3) * smallSizeMax)) / min)))) + 1;
