...
public final class HttpTimeout$Plugin$install$1 extends SuspendLambda implements Function3 {
        ...
        if (!URLProtocolKt.isWebsocket(httpRequestBuilder.getUrl().getProtocol())) {
            ...
            if (httpTimeoutCapabilityConfiguration != null) {
                ...
                if (requestTimeoutMillis2 != null && requestTimeoutMillis2.longValue() != Preferences.UPDATE_INTERVAL_DISABLED) {
                    launch$default = BuildersKt__Builders_commonKt.launch$default(httpClient, null, null, new HttpTimeout$Plugin$install$1$1$killer$1(requestTimeoutMillis2, httpRequestBuilder, httpRequestBuilder.getExecutionContext(), null), 3, null);
