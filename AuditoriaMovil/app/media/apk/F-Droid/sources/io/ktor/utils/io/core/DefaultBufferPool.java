...
public final class DefaultBufferPool extends DefaultPool {
    ...
    public ChunkBuffer produceInstance() {
        return new ChunkBuffer(this.allocator.mo2055allocgFvZug(this.bufferSize), null, this, null);
    }
    ...
    public void disposeInstance(ChunkBuffer instance) {
        ...
        this.allocator.mo2056free3GNKZMM(instance.m2064getMemorySK3TCg8());
    ...
    public void validateInstance(ChunkBuffer instance) {
        ...
        if (instance.m2064getMemorySK3TCg8().limit() != this.bufferSize) {
            StringBuilder sb = new StringBuilder();
            sb.append("Buffer size mismatch. Expected: ");
            sb.append(this.bufferSize);
            sb.append(", actual: ");
            sb.append(instance.m2064getMemorySK3TCg8().limit());
            throw new IllegalStateException(sb.toString().toString());
        } else if (instance == ChunkBuffer.Companion.getEmpty()) {
