...
public abstract class GradientColorInflaterCompat {
    ...
    public static Shader createFromXmlInner(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        int namedInt = TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, BonjourPeer.TYPE, R$styleable.GradientColor_android_type, 0);
    ...
    */
    private static androidx.core.content.res.GradientColorInflaterCompat.ColorStops inflateChildElements(android.content.res.Resources r8, org.xmlpull.v1.XmlPullParser r9, android.util.AttributeSet r10, android.content.res.Resources.Theme r11) {
        /*
            int r0 = r9.getDepth()
            r1 = 1
            int r0 = r0 + r1
