...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl30 extends Impl {
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(WindowInsetsAnimationCompat$Impl30$$ExternalSyntheticApiModelOutline5.m(i, interpolator, j));
        }
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            WindowInsetsAnimationCompat$Impl30$$ExternalSyntheticApiModelOutline7.m();
            return WindowInsetsAnimationCompat$Impl30$$ExternalSyntheticApiModelOutline6.m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
