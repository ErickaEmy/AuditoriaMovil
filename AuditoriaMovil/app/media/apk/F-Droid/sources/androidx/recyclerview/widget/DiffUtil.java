...
public abstract class DiffUtil {
    private static final Comparator DIAGONAL_COMPARATOR = new Comparator() { // from class: androidx.recyclerview.widget.DiffUtil.1
    ...
    public static class DiffResult {
        ...
        private void addEdgeDiagonals() {
            Diagonal diagonal = this.mDiagonals.isEmpty() ? null : (Diagonal) this.mDiagonals.get(0);
        ...
        private void findMatchingAddition(int i) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                Diagonal diagonal = (Diagonal) this.mDiagonals.get(i3);
                while (i2 < diagonal.y) {
