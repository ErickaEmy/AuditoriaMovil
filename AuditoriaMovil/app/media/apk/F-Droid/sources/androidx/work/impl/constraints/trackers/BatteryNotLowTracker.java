...
public final class BatteryNotLowTracker extends BroadcastReceiverConstraintTracker {
    ...
    public Boolean readSystemState() {
        ...
        int intExtra = registerReceiver.getIntExtra(AppUpdateStatusManager.EXTRA_STATUS, -1);
        float intExtra2 = registerReceiver.getIntExtra(LoggerAction.LEVEL_ATTRIBUTE, -1) / registerReceiver.getIntExtra("scale", -1);
        boolean z = true;
