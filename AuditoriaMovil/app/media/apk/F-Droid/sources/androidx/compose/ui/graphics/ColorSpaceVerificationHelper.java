...
public final class ColorSpaceVerificationHelper {
        ...
        if (Intrinsics.areEqual(colorSpace, colorSpaces.getSrgb())) {
            ...
            if (colorSpace instanceof Rgb) {
                ...
                if (transferParameters2 != null) {
                    ...
                    transferParameters = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline0.m(transferParameters2.getA(), transferParameters2.getB(), transferParameters2.getC(), transferParameters2.getD(), transferParameters2.getE(), transferParameters2.getF(), transferParameters2.getGamma());
                } else {
                    transferParameters = null;
                }
                if (transferParameters != null) {
                    ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline4.m();
                    m = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline1.m(colorSpace.getName(), ((Rgb) colorSpace).getPrimaries$ui_graphics_release(), xyz$ui_graphics_release, transferParameters);
                } else {
                    ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline4.m();
                    ...
                    final Function1 oetf = rgb2.getOetf();
                    ...
                    final Function1 eotf = rgb2.getEotf();
                    m = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline2.m(name, primaries$ui_graphics_release, xyz$ui_graphics_release, doubleUnaryOperator, new DoubleUnaryOperator() { // from class: androidx.compose.ui.graphics.ColorSpaceVerificationHelper$$ExternalSyntheticLambda46
                        @Override // java.util.function.DoubleUnaryOperator
                        public final double applyAsDouble(double d) {
                ...
                colorSpace2 = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline19.m(m);
            } else {
    ...
    public static final androidx.compose.ui.graphics.colorspace.ColorSpace composeColorSpace(final ColorSpace colorSpace) {
        ...
        if (ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline25.m(colorSpace)) {
            transferParameters = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getTransferParameters();
            whitePoint = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getWhitePoint();
            if (whitePoint.length == 3) {
                whitePoint5 = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getWhitePoint();
                float f = whitePoint5[0];
                whitePoint6 = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getWhitePoint();
                float f2 = whitePoint6[1];
                whitePoint7 = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getWhitePoint();
                whitePoint2 = new WhitePoint(f, f2, whitePoint7[2]);
            } else {
                whitePoint3 = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getWhitePoint();
                float f3 = whitePoint3[0];
                whitePoint4 = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getWhitePoint();
            ...
            name = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getName();
            Intrinsics.checkNotNullExpressionValue(name, "this.name");
            primaries = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getPrimaries();
            Intrinsics.checkNotNullExpressionValue(primaries, "this.primaries");
            transform = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getTransform();
            ...
            id2 = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(colorSpace).getId();
    ...
    public static final double composeColorSpace$lambda$2(ColorSpace this_composeColorSpace, double d) {
        ...
        oetf = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(this_composeColorSpace).getOetf();
    ...
    public static final double composeColorSpace$lambda$3(ColorSpace this_composeColorSpace, double d) {
        ...
        double applyAsDouble;
        Intrinsics.checkNotNullParameter(this_composeColorSpace, "$this_composeColorSpace");
        eotf = ColorSpaceVerificationHelper$$ExternalSyntheticApiModelOutline26.m(this_composeColorSpace).getEotf();
