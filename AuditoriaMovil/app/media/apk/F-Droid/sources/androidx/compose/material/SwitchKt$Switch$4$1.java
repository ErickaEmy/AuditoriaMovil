...
final class SwitchKt$Switch$4$1 extends SuspendLambda implements Function2 {
    ...
    public SwitchKt$Switch$4$1(boolean z, AnchoredDraggableState anchoredDraggableState, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (this.$checked != ((Boolean) this.$anchoredDraggableState.getCurrentValue()).booleanValue()) {
