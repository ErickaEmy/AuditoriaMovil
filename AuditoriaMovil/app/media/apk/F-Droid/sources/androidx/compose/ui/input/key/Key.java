...
public final class Key {
    ...
    private static final long TvZoomMode = Key_androidKt.Key(GF2Field.MASK);
    ...
    public static final /* synthetic */ Key m1115boximpl(long j) {
        return new Key(j);
    }
    ...
    public static boolean m1117equalsimpl(long j, Object obj) {
        return (obj instanceof Key) && j == ((Key) obj).m1121unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1117equalsimpl(this.keyCode, obj);
    }

    public int hashCode() {
        return m1119hashCodeimpl(this.keyCode);
    }
    ...
    public static final class Companion {
        ...
        public final long m1122getBackEK5gGoQ() {
            return Key.Back;
        }

        /* renamed from: getDirectionUp-EK5gGoQ  reason: not valid java name */
        public final long m1127getDirectionUpEK5gGoQ() {
            return Key.DirectionUp;
        }

        /* renamed from: getDirectionDown-EK5gGoQ  reason: not valid java name */
        public final long m1124getDirectionDownEK5gGoQ() {
            return Key.DirectionDown;
        }

        /* renamed from: getDirectionLeft-EK5gGoQ  reason: not valid java name */
        public final long m1125getDirectionLeftEK5gGoQ() {
            return Key.DirectionLeft;
        }

        /* renamed from: getDirectionRight-EK5gGoQ  reason: not valid java name */
        public final long m1126getDirectionRightEK5gGoQ() {
            return Key.DirectionRight;
        }

        /* renamed from: getDirectionCenter-EK5gGoQ  reason: not valid java name */
        public final long m1123getDirectionCenterEK5gGoQ() {
            return Key.DirectionCenter;
        }

        /* renamed from: getTab-EK5gGoQ  reason: not valid java name */
        public final long m1131getTabEK5gGoQ() {
            return Key.Tab;
        }

        /* renamed from: getEnter-EK5gGoQ  reason: not valid java name */
        public final long m1128getEnterEK5gGoQ() {
            return Key.Enter;
        }

        /* renamed from: getEscape-EK5gGoQ  reason: not valid java name */
        public final long m1129getEscapeEK5gGoQ() {
            return Key.Escape;
        }

        /* renamed from: getNumPadEnter-EK5gGoQ  reason: not valid java name */
        public final long m1130getNumPadEnterEK5gGoQ() {
    ...
    public String toString() {
        return m1120toStringimpl(this.keyCode);
    }
}
