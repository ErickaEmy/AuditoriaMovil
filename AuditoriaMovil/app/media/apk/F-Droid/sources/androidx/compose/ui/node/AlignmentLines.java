...
public abstract class AlignmentLines {
    ...
    protected abstract long mo1288calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        ...
        while (true) {
            Offset = mo1288calculatePositionInParentR5De75A(nodeCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            roundToInt = MathKt__MathJVMKt.roundToInt(Offset.m710getYimpl(Offset));
        } else {
            roundToInt = MathKt__MathJVMKt.roundToInt(Offset.m709getXimpl(Offset));
        }
