...
public final class FloatSpringSpec implements FloatAnimationSpec {
    ...
    public float getValueFromNanos(long j, float f, float f2, float f3) {
        ...
        return Motion.m35getValueimpl(this.spring.m37updateValuesIJZedt4$animation_core_release(f, f3, j / 1000000));
    }

    @Override // androidx.compose.animation.core.FloatAnimationSpec
    public float getVelocityFromNanos(long j, float f, float f2, float f3) {
        this.spring.setFinalPosition(f2);
        return Motion.m36getVelocityimpl(this.spring.m37updateValuesIJZedt4$animation_core_release(f, f3, j / 1000000));
    }
