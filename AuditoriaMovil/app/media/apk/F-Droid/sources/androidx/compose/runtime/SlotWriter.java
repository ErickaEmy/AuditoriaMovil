...
public final class SlotWriter {
    ...
    public final void advanceBy(int i) {
        ...
        if (!(i >= 0)) {
            ...
            if (!z) {
                ComposerKt.composeRuntimeError(("Cannot seek outside the current group (" + this.parent + CoreConstants.DASH_CHAR + this.currentGroupEnd + CoreConstants.RIGHT_PARENTHESIS_CHAR).toString());
                throw new KotlinNothingValueException();
            }
    ...
    public final void moveGroup(int i) {
        ...
        if (!(i >= 0)) {
            ...
            ArraysKt___ArraysJvmKt.copyInto(iArr, iArr, groupIndexToAddress(i2) * 5, groupIndexToAddress, (groupSize * 5) + groupIndexToAddress);
            if (i9 > 0) {
                Object[] objArr = this.slots;
                ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, i7, dataIndexToDataAddress(dataIndex + i9), dataIndexToDataAddress(dataIndex2 + i9));
            }
    ...
    public static final class Companion {
        ...
        public final List moveGroup(SlotWriter slotWriter, int i, SlotWriter slotWriter2, boolean z, boolean z2, boolean z3) {
            ...
            ArraysKt___ArraysJvmKt.copyInto(slotWriter.groups, iArr, currentGroup * 5, i * 5, i3 * 5);
            Object[] objArr = slotWriter2.slots;
            int i5 = slotWriter2.currentSlot;
            ArraysKt___ArraysJvmKt.copyInto(slotWriter.slots, objArr, i5, dataIndex, dataIndex2);
    ...
    public final List moveFrom(SlotTable table, int i, boolean z) {
        int groupSize;
        Intrinsics.checkNotNullParameter(table, "table");
    ...
    */
    public final java.util.List moveIntoGroupFrom(int r13, androidx.compose.runtime.SlotTable r14, int r15) {
        /*
            r12 = this;
        ...
        L15:
            ...
            r5 = r15
            r6 = r12
            java.util.List r14 = androidx.compose.runtime.SlotWriter.Companion.moveGroup$default(r3, r4, r5, r6, r7, r8, r9, r10, r11)     // Catch: java.lang.Throwable -> L4a
            r13.close()
            r12.endInsert()
            r12.endGroup()
            r12.currentGroup = r0
    ...
    */
    ...
    private final void updateAnchors(int i, int i2) {
        ...
        if (i < i2) {
            for (locationOf2 = SlotTableKt.locationOf(this.anchors, i, capacity); locationOf2 < this.anchors.size(); locationOf2++) {
                Object obj = this.anchors.get(locationOf2);
        ...
        for (locationOf = SlotTableKt.locationOf(this.anchors, i2, capacity); locationOf < this.anchors.size(); locationOf++) {
            Object obj2 = this.anchors.get(locationOf);
            ...
            anchor2.setLocation$runtime_release(-(capacity - location$runtime_release2));
        }
    }
    ...
    private final boolean removeAnchors(int i, int i2) {
        ...
        int i5 = 0;
        while (locationOf >= 0) {
            Object obj = this.anchors.get(locationOf);
            Intrinsics.checkNotNullExpressionValue(obj, "anchors[index]");
            Anchor anchor = (Anchor) obj;
