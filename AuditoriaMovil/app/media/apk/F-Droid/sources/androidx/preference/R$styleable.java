...
public abstract class R$styleable {
    ...
    public static int[] BackgroundStyle = {16843534, R.attr.selectableItemBackground};
    public static int[] CheckBoxPreference = {16843247, 16843248, 16843249, R.attr.disableDependentsState, R.attr.summaryOff, R.attr.summaryOn};
    public static int[] DialogPreference = {16843250, 16843251, 16843252, 16843253, 16843254, 16843255, R.attr.dialogIcon, R.attr.dialogLayout, R.attr.dialogMessage, R.attr.dialogTitle, R.attr.negativeButtonText, R.attr.positiveButtonText};
    public static int[] EditTextPreference = {R.attr.useSimpleSummaryProvider};
    public static int[] ListPreference = {16842930, 16843256, R.attr.entries, R.attr.entryValues, R.attr.useSimpleSummaryProvider};
    public static int[] MultiSelectListPreference = {16842930, 16843256, R.attr.entries, R.attr.entryValues};
    ...
    public static int[] PreferenceFragment = {16842994, 16843049, 16843050, R.attr.allowDividerAfterLastItem};
    public static int[] PreferenceFragmentCompat = {16842994, 16843049, 16843050, R.attr.allowDividerAfterLastItem};
    public static int[] PreferenceGroup = {16843239, R.attr.initialExpandedChildrenCount, R.attr.orderingFromXml};
    public static int[] PreferenceImageView = {16843039, 16843040, R.attr.maxHeight, R.attr.maxWidth};
    ...
    public static int[] SeekBarPreference = {16842994, 16843062, R.attr.adjustable, R.attr.min, R.attr.seekBarIncrement, R.attr.showSeekBarValue, R.attr.updatesContinuously};
    public static int[] SwitchPreference = {16843247, 16843248, 16843249, 16843627, 16843628, R.attr.disableDependentsState, R.attr.summaryOff, R.attr.summaryOn, R.attr.switchTextOff, R.attr.switchTextOn};
    public static int[] SwitchPreferenceCompat = {16843247, 16843248, 16843249, 16843627, 16843628, R.attr.disableDependentsState, R.attr.summaryOff, R.attr.summaryOn, R.attr.switchTextOff, R.attr.switchTextOn};
}
