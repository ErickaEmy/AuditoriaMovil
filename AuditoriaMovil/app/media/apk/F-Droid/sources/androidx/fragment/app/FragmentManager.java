...
public abstract class FragmentManager {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void executeOpsTogether(java.util.ArrayList r18, java.util.ArrayList r19, int r20, int r21) {
        /*
    ...
    private void reportBackStackChanged() {
        ...
        ToolbarActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(this.mBackStackChangeListeners.get(0));
        throw null;
    }
    ...
    public void attachController(FragmentHostCallback fragmentHostCallback, FragmentContainer fragmentContainer, final Fragment fragment) {
        ...
        if (fragmentHostCallback2 instanceof ActivityResultRegistryOwner) {
            ...
            this.mRequestPermissions = activityResultRegistry.register(str2 + "RequestPermissions", new ActivityResultContracts$RequestMultiplePermissions(), new ActivityResultCallback() { // from class: androidx.fragment.app.FragmentManager.11
                @Override // androidx.activity.result.ActivityResultCallback
