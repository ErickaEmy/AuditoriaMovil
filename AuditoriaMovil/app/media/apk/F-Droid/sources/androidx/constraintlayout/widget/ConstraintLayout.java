...
public class ConstraintLayout extends ViewGroup {
            ...
            if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                ...
                if (i8 == 1) {
                    ...
                    if (i9 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i9 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        ...
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z || ((z && z2) || constraintWidget.isResolvedHorizontally())) {
                ...
                if (i10 == 1) {
                    ...
                    if (i11 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i11 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        ...
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z3 || ((z3 && z4) || constraintWidget.isResolvedVertically())) {
    ...
    protected void applyConstraintsFromLayoutParams(boolean z, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray sparseArray) {
