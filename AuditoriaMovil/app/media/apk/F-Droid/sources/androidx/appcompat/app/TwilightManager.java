...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - CoreConstants.MILLIS_IN_ONE_DAY, location.getLatitude(), location.getLongitude());
        ...
        if (j2 == -1 || j3 == -1) {
            ...
            j = j4 + CoreConstants.MILLIS_IN_ONE_MINUTE;
        }
