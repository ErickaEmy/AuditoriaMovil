...
public class SwitchCompat extends CompoundButton {
    ...
    private static final Property THUMB_POS = new Property(Float.class, "thumbPos") { // from class: androidx.appcompat.widget.SwitchCompat.1
    ...
    */
    ...
    private void setupEmojiCompatLoadCallback() {
        if (this.mAppCompatEmojiTextHelper.isEnabled() && EmojiCompat.isConfigured()) {
            EmojiCompat.get();
            throw null;
        }
    }
