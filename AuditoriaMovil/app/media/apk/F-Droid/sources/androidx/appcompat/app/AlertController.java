...
public class AlertController {
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (!z || !canTextInput(view)) {
            this.mWindow.setFlags(PKIFailureInfo.unsupportedVersion, PKIFailureInfo.unsupportedVersion);
        }
        if (z) {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                listAdapter = new ArrayAdapter(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
