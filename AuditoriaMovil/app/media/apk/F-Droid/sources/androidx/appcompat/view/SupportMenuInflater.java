    ...
    */
    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemAlphabeticModifiers = obtainStyledAttributes.getInt(R$styleable.MenuItem_alphabeticModifiers, PKIFailureInfo.certConfirmed);
            this.itemNumericShortcut = getShortcut(obtainStyledAttributes.getString(R$styleable.MenuItem_android_numericShortcut));
            this.itemNumericModifiers = obtainStyledAttributes.getInt(R$styleable.MenuItem_numericModifiers, PKIFailureInfo.certConfirmed);
