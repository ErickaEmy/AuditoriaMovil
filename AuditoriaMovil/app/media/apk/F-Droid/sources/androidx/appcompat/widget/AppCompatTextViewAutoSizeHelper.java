    ...
    public void autoSizeText() {
        if (isAutoSizeEnabled()) {
            if (this.mNeedsAutoSizeText) {
                ...
                int measuredWidth = this.mImpl.isHorizontallyScrollable(this.mTextView) ? PKIFailureInfo.badCertTemplate : (this.mTextView.getMeasuredWidth() - this.mTextView.getTotalPaddingLeft()) - this.mTextView.getTotalPaddingRight();
