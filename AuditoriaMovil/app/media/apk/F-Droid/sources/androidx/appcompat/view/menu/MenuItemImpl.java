...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    private int mShortcutNumericModifiers = PKIFailureInfo.certConfirmed;
    private int mShortcutAlphabeticModifiers = PKIFailureInfo.certConfirmed;
    ...
    public String getShortcutLabel() {
        ...
        appendModifier(sb, i, PKIFailureInfo.notAuthorized, resources.getString(R$string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i, PKIFailureInfo.certConfirmed, resources.getString(R$string.abc_menu_ctrl_shortcut_label));
