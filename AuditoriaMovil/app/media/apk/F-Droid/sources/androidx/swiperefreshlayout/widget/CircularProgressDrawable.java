...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        return ((i3 + ((int) ((((i2 >> 24) & GF2Field.MASK) - i3) * f))) << 24) | ((i4 + ((int) ((((i2 >> 16) & GF2Field.MASK) - i4) * f))) << 16) | ((i5 + ((int) ((((i2 >> 8) & GF2Field.MASK) - i5) * f))) << 8) | (i6 + ((int) (f * ((i2 & GF2Field.MASK) - i6))));
    }
