...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild {
        ...
        this.mRefreshListener = new Animation.AnimationListener() { // from class: androidx.swiperefreshlayout.widget.SwipeRefreshLayout.1
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (swipeRefreshLayout.mRefreshing) {
                    swipeRefreshLayout.mProgress.setAlpha(GF2Field.MASK);
    ...
    private void startScaleUpAnimation(Animation.AnimationListener animationListener) {
        ...
        this.mProgress.setAlpha(GF2Field.MASK);
    ...
    private void startProgressAlphaMaxAnimation() {
        this.mAlphaMaxAnimation = startAlphaAnimation(this.mProgress.getAlpha(), GF2Field.MASK);
    }
