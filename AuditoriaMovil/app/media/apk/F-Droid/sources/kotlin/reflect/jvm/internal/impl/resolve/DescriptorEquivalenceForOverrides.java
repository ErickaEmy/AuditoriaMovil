...
public final class DescriptorEquivalenceForOverrides {
    ...
    public final boolean areTypeParametersEquivalent(TypeParameterDescriptor a, TypeParameterDescriptor b, boolean z, Function2 equivalentCallables) {
        Intrinsics.checkNotNullParameter(a, "a");
        Intrinsics.checkNotNullParameter(b, "b");
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$0(boolean z, final CallableDescriptor a, final CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor mo2222getDeclarationDescriptor = c1.mo2222getDeclarationDescriptor();
        ClassifierDescriptor mo2222getDeclarationDescriptor2 = c2.mo2222getDeclarationDescriptor();
        if ((mo2222getDeclarationDescriptor instanceof TypeParameterDescriptor) && (mo2222getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) mo2222getDeclarationDescriptor, (TypeParameterDescriptor) mo2222getDeclarationDescriptor2, z, new Function2() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1$1
