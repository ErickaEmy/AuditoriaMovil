...
public class JavaMethodDescriptor extends SimpleFunctionDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public static final CallableDescriptor.UserDataKey ORIGINAL_VALUE_PARAMETER_FOR_EXTENSION_RECEIVER = new CallableDescriptor.UserDataKey() { // from class: kotlin.reflect.jvm.internal.impl.load.java.descriptors.JavaMethodDescriptor.1
    };
    public static final CallableDescriptor.UserDataKey HAS_ERASED_VALUE_PARAMETERS = new CallableDescriptor.UserDataKey() { // from class: kotlin.reflect.jvm.internal.impl.load.java.descriptors.JavaMethodDescriptor.2
    };
    ...
    public SimpleFunctionDescriptorImpl initialize(ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List list, List list2, List list3, KotlinType kotlinType, Modality modality, DescriptorVisibility descriptorVisibility, Map map) {
        if (list == null) {
            $$$reportNull$$$0(9);
        }
        if (list2 == null) {
    ...
    public JavaMethodDescriptor enhance(KotlinType kotlinType, List list, KotlinType kotlinType2, Pair pair) {
        if (list == null) {
            $$$reportNull$$$0(19);
        }
        if (kotlinType2 == null) {
        ...
        if (pair != null) {
            javaMethodDescriptor.putInUserDataMap((CallableDescriptor.UserDataKey) pair.getFirst(), pair.getSecond());
        }
