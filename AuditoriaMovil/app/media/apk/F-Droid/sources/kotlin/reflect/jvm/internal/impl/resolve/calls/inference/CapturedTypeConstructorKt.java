    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(final TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt$wrapWithCapturingSubstitution$2
            ...
            public TypeProjection mo2227get(KotlinType key) {
                ...
                TypeProjection mo2227get = super.mo2227get(key);
                if (mo2227get != null) {
                    ClassifierDescriptor mo2222getDeclarationDescriptor = key.getConstructor().mo2222getDeclarationDescriptor();
                    createCapturedIfNeeded = CapturedTypeConstructorKt.createCapturedIfNeeded(mo2227get, mo2222getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo2222getDeclarationDescriptor : null);
