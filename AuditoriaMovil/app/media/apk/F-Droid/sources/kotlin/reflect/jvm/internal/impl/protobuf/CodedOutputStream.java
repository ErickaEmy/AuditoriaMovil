...
public final class CodedOutputStream {
    ...
    public static int computePreferredBufferSize(int i) {
        return i > 4096 ? PKIFailureInfo.certConfirmed : i;
    }
    ...
    public void writeRawLittleEndian32(int i) {
        writeRawByte(i & GF2Field.MASK);
        writeRawByte((i >> 8) & GF2Field.MASK);
        writeRawByte((i >> 16) & GF2Field.MASK);
        writeRawByte((i >> 24) & GF2Field.MASK);
    }

    public void writeRawLittleEndian64(long j) {
        writeRawByte(((int) j) & GF2Field.MASK);
        writeRawByte(((int) (j >> 8)) & GF2Field.MASK);
        writeRawByte(((int) (j >> 16)) & GF2Field.MASK);
        writeRawByte(((int) (j >> 24)) & GF2Field.MASK);
        writeRawByte(((int) (j >> 32)) & GF2Field.MASK);
        writeRawByte(((int) (j >> 40)) & GF2Field.MASK);
        writeRawByte(((int) (j >> 48)) & GF2Field.MASK);
        writeRawByte(((int) (j >> 56)) & GF2Field.MASK);
    }
}
