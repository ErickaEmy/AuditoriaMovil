...
public abstract class Flags {
    ...
    */
    ...
    static {
        ...
        FlagField after = FlagField.after(booleanFirst2, ProtoBuf$Visibility.values());
        VISIBILITY = after;
        FlagField after2 = FlagField.after(after, ProtoBuf$Modality.values());
        MODALITY = after2;
        FlagField after3 = FlagField.after(after2, ProtoBuf$Class.Kind.values());
        CLASS_KIND = after3;
        ...
        FlagField after4 = FlagField.after(after2, ProtoBuf$MemberKind.values());
        MEMBER_KIND = after4;
    ...
    /* loaded from: classes2.dex */
    public static class EnumLiteFlagField extends FlagField {
        private final Internal.EnumLite[] values;
        ...
        public EnumLiteFlagField(int i, Internal.EnumLite[] enumLiteArr) {
            super(i, bitWidth(enumLiteArr));
            this.values = enumLiteArr;
        }

        private static int bitWidth(Object[] objArr) {
            if (objArr == null) {
                $$$reportNull$$$0(0);
            }
