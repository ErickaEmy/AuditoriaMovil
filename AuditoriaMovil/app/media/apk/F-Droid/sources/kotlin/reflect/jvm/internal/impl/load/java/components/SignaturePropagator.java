...
public interface SignaturePropagator {
    ...
    void reportSignatureErrors(CallableMemberDescriptor callableMemberDescriptor, List list);

    PropagatedSignature resolvePropagatedSignature(JavaMethod javaMethod, ClassDescriptor classDescriptor, KotlinType kotlinType, KotlinType kotlinType2, List list, List list2);
    ...
    public static class PropagatedSignature {
        ...
        public PropagatedSignature(KotlinType kotlinType, KotlinType kotlinType2, List list, List list2, List list3, boolean z) {
            if (kotlinType == null) {
                $$$reportNull$$$0(0);
            }
            if (list == null) {
        ...
        public List getErrors() {
            List list = this.signatureErrors;
            if (list == null) {
                $$$reportNull$$$0(7);
            }
            return list;
