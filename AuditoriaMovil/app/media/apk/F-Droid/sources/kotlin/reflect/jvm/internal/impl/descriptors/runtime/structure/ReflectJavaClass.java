...
public final class ReflectJavaClass extends ReflectJavaElement implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaClass {
    ...
    public List getInnerClassNames() {
        ...
        filterNot = SequencesKt___SequencesKt.filterNot(asSequence, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.ReflectJavaClass$innerClassNames$1
        ...
        mapNotNull = SequencesKt___SequencesKt.mapNotNull(filterNot, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.ReflectJavaClass$innerClassNames$2
            @Override // kotlin.jvm.functions.Function1
    ...
    public List getMethods() {
        ...
        filter = SequencesKt___SequencesKt.filter(asSequence, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.ReflectJavaClass$methods$1
