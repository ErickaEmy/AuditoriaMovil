...
public class DeserializedPackageMemberScope extends DeserializedMemberScope {
    ...
    */
    ...
    public List getContributedDescriptors(DescriptorKindFilter kindFilter, Function1 nameFilter) {
        ...
        Intrinsics.checkNotNullParameter(nameFilter, "nameFilter");
        Collection computeDescriptors = computeDescriptors(kindFilter, nameFilter, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
        ...
        plus = CollectionsKt___CollectionsKt.plus(computeDescriptors, (Iterable) arrayList);
        return plus;
    }
    ...
    public ClassifierDescriptor mo2224getContributedClassifier(Name name, LookupLocation location) {
        ...
        return super.mo2224getContributedClassifier(name, location);
    }
