...
public final class OperatorNameConventions {
    ...
    static {
        ...
        plus = SetsKt___SetsKt.plus(of3, (Iterable) of4);
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(identifier31, identifier32), TuplesKt.to(identifier37, identifier38));
        MOD_OPERATORS_REPLACEMENT = mapOf;
        of8 = SetsKt__SetsJVMKt.setOf(identifier11);
