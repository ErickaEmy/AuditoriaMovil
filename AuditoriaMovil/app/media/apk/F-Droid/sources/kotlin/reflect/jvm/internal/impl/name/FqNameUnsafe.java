...
public final class FqNameUnsafe {
    ...
    private static final Function1 STRING_TO_NAME = new Function1() { // from class: kotlin.reflect.jvm.internal.impl.name.FqNameUnsafe.1
    ...
    public List pathSegments() {
        List emptyList = isRoot() ? Collections.emptyList() : ArraysKt.map(SPLIT_BY_DOTS.split(this.fqName), STRING_TO_NAME);
        if (emptyList == null) {
            $$$reportNull$$$0(14);
        }
        return emptyList;
