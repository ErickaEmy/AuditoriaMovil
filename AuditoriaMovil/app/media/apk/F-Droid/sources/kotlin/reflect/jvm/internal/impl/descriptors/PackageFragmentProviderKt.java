...
public abstract class PackageFragmentProviderKt {
    public static final List packageFragments(PackageFragmentProvider packageFragmentProvider, FqName fqName) {
    ...
    public static final void collectPackageFragmentsOptimizedIfPossible(PackageFragmentProvider packageFragmentProvider, FqName fqName, Collection packageFragments) {
        Intrinsics.checkNotNullParameter(packageFragmentProvider, "<this>");
        Intrinsics.checkNotNullParameter(fqName, "fqName");
