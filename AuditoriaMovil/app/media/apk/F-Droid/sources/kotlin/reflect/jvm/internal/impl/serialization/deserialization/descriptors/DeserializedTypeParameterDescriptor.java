...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    */
    ...
    protected List resolveUpperBounds() {
        ...
        for (ProtoBuf$Type protoBuf$Type : upperBounds) {
            arrayList.add(typeDeserializer.type(protoBuf$Type));
        }
        return arrayList;
    }
    ...
    public Void mo2225reportSupertypeLoopError(KotlinType type) {
