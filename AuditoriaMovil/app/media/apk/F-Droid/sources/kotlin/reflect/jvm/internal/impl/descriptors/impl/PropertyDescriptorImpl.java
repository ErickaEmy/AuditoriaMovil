...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    */
    ...
    public void setType(KotlinType kotlinType, List list, ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List list2) {
        if (kotlinType == null) {
            $$$reportNull$$$0(17);
        }
        if (list == null) {
    ...
    public class CopyConfiguration {
        ...
        private List newTypeParameters = null;
    ...
    public Collection getOverriddenDescriptors() {
        Collection collection = this.overriddenProperties;
        if (collection == null) {
