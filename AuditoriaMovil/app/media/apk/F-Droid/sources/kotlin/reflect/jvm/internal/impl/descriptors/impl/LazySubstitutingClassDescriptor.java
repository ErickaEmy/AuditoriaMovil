    ...
    */
    ...
    private TypeSubstitutor getSubstitutor() {
        ...
        if (this.newSubstitutor == null) {
            if (this.originalSubstitutor.isEmpty()) {
                ...
                filter = CollectionsKt___CollectionsKt.filter(this.typeConstructorParameters, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.LazySubstitutingClassDescriptor.1
    ...
    public TypeConstructor getTypeConstructor() {
        ...
        if (this.typeConstructor == null) {
            ...
            Collection<KotlinType> mo2223getSupertypes = typeConstructor.mo2223getSupertypes();
    ...
    public ClassDescriptor mo2186getCompanionObjectDescriptor() {
        return this.original.mo2186getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo2187getUnsubstitutedPrimaryConstructor() {
        return this.original.mo2187getUnsubstitutedPrimaryConstructor();
    }
    ...
    public List getDeclaredTypeParameters() {
        getSubstitutor();
        List list = this.declaredTypeParameters;
        if (list == null) {
            $$$reportNull$$$0(30);
        }
        return list;
    ...
    public ValueClassRepresentation getValueClassRepresentation() {
        ...
        return valueClassRepresentation.mapUnderlyingType(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.LazySubstitutingClassDescriptor.2
            @Override // kotlin.jvm.functions.Function1
