...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    public FunctionDescriptorImpl initialize(ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List list, List list2, List list3, KotlinType kotlinType, Modality modality, DescriptorVisibility descriptorVisibility) {
        List list4;
        List list5;
        if (list == null) {
            $$$reportNull$$$0(5);
    ...
    public List getContextReceiverParameters() {
        List list = this.contextReceiverParameters;
        if (list == null) {
            $$$reportNull$$$0(13);
        }
        return list;
    ...
    public Collection getOverriddenDescriptors() {
        ...
        Collection collection = this.overriddenFunctions;
        if (collection == null) {
    ...
    public List getValueParameters() {
        List list = this.unsubstitutedValueParameters;
        if (list == null) {
            $$$reportNull$$$0(19);
        }
        return list;
    ...
    /* loaded from: classes2.dex */
    public class CopyConfiguration implements FunctionDescriptor.CopyBuilder {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor.CopyBuilder
        public CopyConfiguration setTypeParameters(List list) {
            if (list == null) {
                $$$reportNull$$$0(21);
            }
        ...
        @Override // kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor.CopyBuilder
        public CopyConfiguration setValueParameters(List list) {
            if (list == null) {
                $$$reportNull$$$0(19);
            }
    ...
    public FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        FunctionDescriptorImpl createSubstitutedCopy = createSubstitutedCopy(declarationDescriptor, functionDescriptor, copyConfiguration.kind, copyConfiguration.name, annotations2, getSourceToUseForCopy(copyConfiguration.preserveSourceElement, functionDescriptor));
        ...
        List substitutedValueParameters = getSubstitutedValueParameters(createSubstitutedCopy, copyConfiguration.newValueParameterDescriptors, substituteTypeParameters, copyConfiguration.dropOriginalInContainingParts, copyConfiguration.preserveSourceElement, zArr);
        ...
        if (z || !copyConfiguration.justForTypeSubstitution) {
            ...
            if (!copyConfiguration.userDataMap.isEmpty() || this.userDataMap != null) {
                Map map = copyConfiguration.userDataMap;
                Map map2 = this.userDataMap;
                if (map2 != null) {
            ...
            if (copyConfiguration.copyOverrides && !getOriginal().getOverriddenDescriptors().isEmpty()) {
                if (copyConfiguration.substitution.isEmpty()) {
                    ...
                    createSubstitutedCopy.lazyOverriddenFunctionsTask = new Function0() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.1
    ...
    public static List getSubstitutedValueParameters(FunctionDescriptor functionDescriptor, List list, TypeSubstitutor typeSubstitutor) {
        if (list == null) {
            $$$reportNull$$$0(28);
        }
        if (typeSubstitutor == null) {
    ...
    public static List getSubstitutedValueParameters(FunctionDescriptor functionDescriptor, List list, TypeSubstitutor typeSubstitutor, boolean z, boolean z2, boolean[] zArr) {
        Function0 function0;
        if (list == null) {
            $$$reportNull$$$0(30);
        }
        ...
        while (it.hasNext()) {
            ...
            if (valueParameterDescriptor instanceof ValueParameterDescriptorImpl.WithDestructuringDeclaration) {
                final List destructuringVariables = ((ValueParameterDescriptorImpl.WithDestructuringDeclaration) valueParameterDescriptor).getDestructuringVariables();
    ...
    public void putInUserDataMap(CallableDescriptor.UserDataKey userDataKey, Object obj) {
