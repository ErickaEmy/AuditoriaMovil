...
public final class JavaDefaultQualifiers {
    ...
    public int hashCode() {
        return (((this.nullabilityQualifier.hashCode() * 31) + this.qualifierApplicabilityTypes.hashCode()) * 31) + ClickableElement$$ExternalSyntheticBackport0.m(this.definitelyNotNull);
    }
