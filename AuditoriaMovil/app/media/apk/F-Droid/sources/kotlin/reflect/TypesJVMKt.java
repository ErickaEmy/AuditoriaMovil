...
public abstract class TypesJVMKt {
    ...
    public static final Type computeJavaType(KType kType, boolean z) {
        ...
        if (classifier instanceof KClass) {
            ...
            if (javaObjectType.isArray()) {
                ...
                singleOrNull = CollectionsKt___CollectionsKt.singleOrNull(arguments);
    ...
    private static final Type createPossiblyInnerType(Class cls, List list) {
        ...
        if (declaringClass == null) {
            ...
            for (KTypeProjection kTypeProjection : subList) {
                arrayList3.add(getJavaType(kTypeProjection));
            }
