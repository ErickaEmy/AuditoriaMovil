...
public class JavaClassConstructorDescriptor extends ClassConstructorDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public JavaClassConstructorDescriptor enhance(KotlinType kotlinType, List list, KotlinType kotlinType2, Pair pair) {
        List emptyList;
        if (list == null) {
            $$$reportNull$$$0(16);
        }
        ...
        if (pair != null) {
            createSubstitutedCopy.putInUserDataMap((CallableDescriptor.UserDataKey) pair.getFirst(), pair.getSecond());
        }
