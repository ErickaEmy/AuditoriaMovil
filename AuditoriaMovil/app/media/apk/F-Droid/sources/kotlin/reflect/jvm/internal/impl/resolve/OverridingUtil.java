...
public class OverridingUtil {
    ...
    */
    ...
    public static Set filterOutOverridden(Set set) {
        if (set == null) {
            $$$reportNull$$$0(8);
        }
        return filterOverrides(set, !set.isEmpty() && DescriptorUtilsKt.isTypeRefinementEnabled(DescriptorUtilsKt.getModule((DeclarationDescriptor) set.iterator().next())), null, new Function2() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.2
    ...
    public static Set filterOverrides(Set set, boolean z, Function0 function0, Function2 function2) {
        if (set == null) {
            $$$reportNull$$$0(9);
        }
        if (function2 == null) {
    ...
    public static boolean overrides(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z, boolean z2) {
        ...
        if (callableDescriptor.equals(callableDescriptor2) || !DescriptorEquivalenceForOverrides.INSTANCE.areEquivalent(callableDescriptor.getOriginal(), callableDescriptor2.getOriginal(), z, z2)) {
            CallableDescriptor original = callableDescriptor2.getOriginal();
            for (CallableDescriptor callableDescriptor3 : DescriptorUtils.getAllOverriddenDescriptors(callableDescriptor)) {
                if (DescriptorEquivalenceForOverrides.INSTANCE.areEquivalent(original, callableDescriptor3, z, z2)) {
                    return true;
                }
            }
            return false;
    ...
    public static Set getOverriddenDeclarations(CallableMemberDescriptor callableMemberDescriptor) {
    ...
    private static void collectOverriddenDeclarations(CallableMemberDescriptor callableMemberDescriptor, Set set) {
        if (callableMemberDescriptor == null) {
            $$$reportNull$$$0(17);
        }
        if (set == null) {
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z) {
        ...
        for (int i2 = 0; i2 < typeParameters.size(); i2++) {
            if (!areTypeParametersEquivalent((TypeParameterDescriptor) typeParameters.get(i2), (TypeParameterDescriptor) typeParameters2.get(i2), createTypeCheckerState)) {
    ...
    private TypeCheckerState createTypeCheckerState(List list, List list2) {
        if (list == null) {
            $$$reportNull$$$0(42);
        }
        if (list2 == null) {
    ...
    */
    ...
    public void generateOverridesInFunctionGroup(Name name, Collection collection, Collection collection2, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        if (name == null) {
            $$$reportNull$$$0(52);
        }
        if (collection == null) {
    ...
    private Collection extractAndBindOverridesForMember(CallableMemberDescriptor callableMemberDescriptor, Collection collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        if (callableMemberDescriptor == null) {
            $$$reportNull$$$0(59);
        }
        if (collection == null) {
    ...
    private static boolean allHasSameContainingDeclaration(Collection collection) {
        boolean all;
        if (collection == null) {
            $$$reportNull$$$0(63);
        }
        ...
        all = CollectionsKt___CollectionsKt.all(collection, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.3
    ...
    private static void createAndBindFakeOverrides(ClassDescriptor classDescriptor, Collection collection, OverridingStrategy overridingStrategy) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(64);
        }
        if (collection == null) {
        ...
        if (allHasSameContainingDeclaration(collection)) {
            Iterator it = collection.iterator();
            while (it.hasNext()) {
                createAndBindFakeOverride(Collections.singleton((CallableMemberDescriptor) it.next()), classDescriptor, overridingStrategy);
            }
            return;
        }
    ...
    private static boolean isMoreSpecificThenAllOf(CallableDescriptor callableDescriptor, Collection collection) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(71);
        }
        if (collection == null) {
    ...
    public static Object selectMostSpecificMember(Collection collection, Function1 function1) {
        ...
        if (arrayList.isEmpty()) {
            ...
            first3 = CollectionsKt___CollectionsKt.first((Iterable) arrayList);
            if (first3 == null) {
                $$$reportNull$$$0(82);
            }
            return first3;
            ...
            while (true) {
                ...
                obj = it.next();
                if (!FlexibleTypesKt.isFlexible(((CallableDescriptor) function1.invoke(obj)).getReturnType())) {
                    break;
                }
            }
            if (obj != null) {
            ...
            first2 = CollectionsKt___CollectionsKt.first((Iterable) arrayList);
            if (first2 == null) {
                $$$reportNull$$$0(84);
            }
            return first2;
    ...
    private static void createAndBindFakeOverride(Collection collection, ClassDescriptor classDescriptor, OverridingStrategy overridingStrategy) {
        if (collection == null) {
            $$$reportNull$$$0(85);
        }
        if (classDescriptor == null) {
        ...
        Collection filterVisibleFakeOverrides = filterVisibleFakeOverrides(classDescriptor, collection);
        boolean isEmpty = filterVisibleFakeOverrides.isEmpty();
        if (!isEmpty) {
            collection = filterVisibleFakeOverrides;
        }
        CallableMemberDescriptor copy = ((CallableMemberDescriptor) selectMostSpecificMember(collection, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.4
            @Override // kotlin.jvm.functions.Function1
    ...
    private static Modality determineModalityForFakeOverride(Collection collection, ClassDescriptor classDescriptor) {
        if (collection == null) {
            $$$reportNull$$$0(88);
        }
        if (classDescriptor == null) {
    ...
    private static Modality getMinimalModality(Collection collection, boolean z, Modality modality) {
        if (collection == null) {
            $$$reportNull$$$0(93);
        }
        if (modality == null) {
    ...
    public static Collection filterVisibleFakeOverrides(final ClassDescriptor classDescriptor, Collection collection) {
        List filter;
        if (classDescriptor == null) {
            $$$reportNull$$$0(96);
        }
        ...
        filter = CollectionsKt___CollectionsKt.filter(collection, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.5
            @Override // kotlin.jvm.functions.Function1
            public Boolean invoke(CallableMemberDescriptor callableMemberDescriptor) {
                boolean z = false;
    ...
    public static Collection extractMembersOverridableInBothWays(Object obj, Collection collection, Function1 function1, Function1 function12) {
        if (obj == null) {
            $$$reportNull$$$0(99);
        }
        if (collection == null) {
    ...
    private static Collection extractMembersOverridableInBothWays(final CallableMemberDescriptor callableMemberDescriptor, Queue queue, final OverridingStrategy overridingStrategy) {
        if (callableMemberDescriptor == null) {
            $$$reportNull$$$0(104);
        }
        if (queue == null) {
        ...
        return extractMembersOverridableInBothWays(callableMemberDescriptor, queue, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.6
            @Override // kotlin.jvm.functions.Function1
            public CallableDescriptor invoke(CallableMemberDescriptor callableMemberDescriptor2) {
                return callableMemberDescriptor2;
            }
        }, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtil.7
            @Override // kotlin.jvm.functions.Function1
    ...
    public static void resolveUnknownVisibilityForMember(CallableMemberDescriptor callableMemberDescriptor, Function1 function1) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static kotlin.reflect.jvm.internal.impl.descriptors.DescriptorVisibility findMaxVisibility(java.util.Collection r5) {
        /*
            if (r5 != 0) goto L7
