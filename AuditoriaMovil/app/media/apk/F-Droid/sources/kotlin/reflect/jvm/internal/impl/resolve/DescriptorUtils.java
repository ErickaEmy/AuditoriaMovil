...
public abstract class DescriptorUtils {
    ...
    public static DeclarationDescriptor getParentOfType(DeclarationDescriptor declarationDescriptor, Class cls) {
        if (cls == null) {
            $$$reportNull$$$0(18);
        }
    ...
    public static DeclarationDescriptor getParentOfType(DeclarationDescriptor declarationDescriptor, Class cls, boolean z) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (declarationDescriptor == null) {
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(mo2222getDeclarationDescriptor);
    }
    ...
    public static boolean isDirectSubclass(ClassDescriptor classDescriptor, ClassDescriptor classDescriptor2) {
        ...
        for (KotlinType kotlinType : classDescriptor.getTypeConstructor().mo2223getSupertypes()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        ClassifierDescriptor mo2222getDeclarationDescriptor = kotlinType.getConstructor().mo2222getDeclarationDescriptor();
        if (mo2222getDeclarationDescriptor != null) {
            DeclarationDescriptor original = mo2222getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        for (KotlinType kotlinType2 : kotlinType.getConstructor().mo2223getSupertypes()) {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo2222getDeclarationDescriptor();
        if (classDescriptor == null) {
            $$$reportNull$$$0(47);
        }
    ...
    public static CallableMemberDescriptor unwrapFakeOverride(CallableMemberDescriptor callableMemberDescriptor) {
        ...
        while (callableMemberDescriptor.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            ...
            callableMemberDescriptor = (CallableMemberDescriptor) overriddenDescriptors.iterator().next();
        }
    ...
    public static DeclarationDescriptorWithVisibility unwrapFakeOverrideToAnyDeclaration(DeclarationDescriptorWithVisibility declarationDescriptorWithVisibility) {
        ...
        if (declarationDescriptorWithVisibility instanceof CallableMemberDescriptor) {
            return unwrapFakeOverride((CallableMemberDescriptor) declarationDescriptorWithVisibility);
        }
        if (declarationDescriptorWithVisibility == null) {
            $$$reportNull$$$0(65);
        }
    ...
    public static Set getAllOverriddenDescriptors(CallableDescriptor callableDescriptor) {
        ...
        collectAllOverriddenDescriptors(callableDescriptor.getOriginal(), linkedHashSet);
        return linkedHashSet;
    }

    private static void collectAllOverriddenDescriptors(CallableDescriptor callableDescriptor, Set set) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(73);
        }
        if (set == null) {
