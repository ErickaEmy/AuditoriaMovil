...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    */
    ...
    public abstract ClassDescriptor mo2222getDeclarationDescriptor();
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo2222getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    protected boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo2222getDeclarationDescriptor(), classifierDescriptor);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
    protected Collection getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo2222getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo2186getCompanionObjectDescriptor = classDescriptor.mo2186getCompanionObjectDescriptor();
        if (z && mo2186getCompanionObjectDescriptor != null) {
            smartList.add(mo2186getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo2222getDeclarationDescriptor())) {
            return null;
        }
