...
public class ClassConstructorDescriptorImpl extends FunctionDescriptorImpl implements ClassConstructorDescriptor {
    ...
    */
    ...
    public ClassConstructorDescriptorImpl initialize(List list, DescriptorVisibility descriptorVisibility, List list2) {
        if (list == null) {
            $$$reportNull$$$0(10);
        }
    ...
    public ClassConstructorDescriptorImpl initialize(List list, DescriptorVisibility descriptorVisibility) {
        if (list == null) {
            $$$reportNull$$$0(13);
        }
        if (descriptorVisibility == null) {
    ...
    private List calculateContextReceiverParameters() {
        ...
        if (!containingDeclaration.getContextReceivers().isEmpty()) {
            List contextReceivers = containingDeclaration.getContextReceivers();
