...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    protected abstract void mo2225reportSupertypeLoopError(KotlinType kotlinType);
    ...
    public AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z, int i, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
        ...
        this.reified = z;
        this.index = i;
        this.typeConstructor = storageManager.createLazyValue(new Function0() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.1
        ...
        this.defaultType = storageManager.createLazyValue(new Function0() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.2
            @Override // kotlin.jvm.functions.Function0
            public SimpleType invoke() {
                return KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(TypeAttributes.Companion.getEmpty(), AbstractTypeParameterDescriptor.this.getTypeConstructor(), Collections.emptyList(), false, new LazyScopeAdapter(new Function0() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.2.1
                    @Override // kotlin.jvm.functions.Function0
    ...
    public List getUpperBounds() {
        List mo2223getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo2223getSupertypes();
        if (mo2223getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
    ...
    protected List processBoundsWithoutCycles(List list) {
        if (list == null) {
            $$$reportNull$$$0(12);
        }
        if (list == null) {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo2225reportSupertypeLoopError(kotlinType);
        }
