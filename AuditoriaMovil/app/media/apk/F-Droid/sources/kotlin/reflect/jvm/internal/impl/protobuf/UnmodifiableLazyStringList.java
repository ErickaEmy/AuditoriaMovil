...
public class UnmodifiableLazyStringList extends AbstractList implements RandomAccess, LazyStringList {
    ...
    public ListIterator listIterator(int i) {
        return new ListIterator(i) { // from class: kotlin.reflect.jvm.internal.impl.protobuf.UnmodifiableLazyStringList.1
            ListIterator iter;
    ...
    public Iterator iterator() {
        return new Iterator() { // from class: kotlin.reflect.jvm.internal.impl.protobuf.UnmodifiableLazyStringList.2
            Iterator iter;
