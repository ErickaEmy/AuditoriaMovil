...
public abstract class AnnotationUtilKt {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(final KotlinBuiltIns kotlinBuiltIns, String message, String replaceWith, String level, boolean z) {
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(REPLACE_WITH_EXPRESSION_NAME, new StringValue(replaceWith)), TuplesKt.to(name, new ArrayValue(emptyList, new Function1() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationUtilKt$createDeprecatedAnnotation$replaceWithAnnotation$1
        ...
        BuiltInAnnotationDescriptor builtInAnnotationDescriptor = new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, mapOf, false, 8, null);
        ...
        return new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName2, mapOf2, z);
    }

    static {
        Name identifier = Name.identifier(ErrorDialogActivity.EXTRA_MESSAGE);
        Intrinsics.checkNotNullExpressionValue(identifier, "identifier(...)");
        ...
        Name identifier3 = Name.identifier(LoggerAction.LEVEL_ATTRIBUTE);
