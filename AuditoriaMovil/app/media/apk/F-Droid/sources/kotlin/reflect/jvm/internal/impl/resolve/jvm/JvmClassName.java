...
public class JvmClassName {
    ...
    public static JvmClassName byClassId(ClassId classId) {
        ...
        String replace = classId.getRelativeClassName().asString().replace(CoreConstants.DOT, CoreConstants.DOLLAR);
        if (packageFqName.isRoot()) {
            return new JvmClassName(replace);
        }
        return new JvmClassName(packageFqName.asString().replace(CoreConstants.DOT, '/') + "/" + replace);
    }
    ...
    public FqName getPackageFqName() {
        ...
        return new FqName(this.internalName.substring(0, lastIndexOf).replace('/', CoreConstants.DOT));
    }
