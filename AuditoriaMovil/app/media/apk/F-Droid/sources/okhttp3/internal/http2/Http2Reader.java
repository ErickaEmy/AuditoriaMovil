...
public final class Http2Reader implements Closeable {
    ...
    public final boolean nextFrame(boolean z, Handler handler) {
        ...
        try {
            ...
            int and2 = Util.and(this.source.readByte(), (int) GF2Field.MASK);
    ...
    private final void readHeaders(Handler handler, int i, int i2, int i3) {
        ...
        boolean z = (i2 & 1) != 0;
        int and = (i2 & 8) != 0 ? Util.and(this.source.readByte(), (int) GF2Field.MASK) : 0;
        if ((i2 & 32) != 0) {
    ...
    private final void readPriority(Handler handler, int i) {
        ...
        handler.priority(i, readInt & Integer.MAX_VALUE, Util.and(this.source.readByte(), (int) GF2Field.MASK) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    public static final class ContinuationSource implements Source {
        ...
        private final void readContinuationHeader() {
            ...
            int and = Util.and(this.source.readByte(), (int) GF2Field.MASK);
            this.flags = Util.and(this.source.readByte(), (int) GF2Field.MASK);
