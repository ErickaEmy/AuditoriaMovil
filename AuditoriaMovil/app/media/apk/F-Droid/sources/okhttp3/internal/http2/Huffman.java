...
public final class Huffman {
    ...
    public final void encode(ByteString source, BufferedSink sink) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            int and = Util.and(source.getByte(i2), (int) GF2Field.MASK);
            int i3 = CODES[and];
    ...
    public final int encodedLength(ByteString bytes) {
        ...
        for (int i = 0; i < size; i++) {
            j += CODE_BIT_COUNTS[Util.and(bytes.getByte(i), (int) GF2Field.MASK)];
        }
        return (int) ((j + 7) >> 3);
    }
    ...
    public final void decode(BufferedSource source, long j, BufferedSink sink) {
        ...
        for (long j2 = 0; j2 < j; j2++) {
            i = (i << 8) | Util.and(source.readByte(), (int) GF2Field.MASK);
            i2 += 8;
            while (i2 >= 8) {
                int i3 = (i >>> (i2 - 8)) & GF2Field.MASK;
        ...
        while (i2 > 0) {
            int i4 = (i << (8 - i2)) & GF2Field.MASK;
            Node[] children2 = node.getChildren();
            Intrinsics.checkNotNull(children2);
            Node node2 = children2[i4];
