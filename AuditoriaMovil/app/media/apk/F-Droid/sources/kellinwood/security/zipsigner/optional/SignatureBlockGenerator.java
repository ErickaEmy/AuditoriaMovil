...
public class SignatureBlockGenerator {
    public static byte[] generate(KeySet keySet, byte[] bArr) {
        try {
            ...
            ContentSigner build = new JcaContentSignerBuilder(keySet.getSignatureAlgorithm()).setProvider(bouncyCastleProvider).build(keySet.getPrivateKey());
            ...
            cMSSignedDataGenerator.addSignerInfoGenerator(jcaSignerInfoGeneratorBuilder.build(build, keySet.getPublicKey()));
