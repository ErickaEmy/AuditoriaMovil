...
public final class UndispatchedKt {
    ...
    public static final <T, R> Object startUndispatchedOrReturnIgnoreTimeout(ScopeCoroutine<? super T> scopeCoroutine, R r2, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        Object completedExceptionally;
        Throwable recoverFromStackFrame;
        ...
        if (makeCompletingOnce$kotlinx_coroutines_core instanceof CompletedExceptionally) {
            ...
            if ((th2 instanceof TimeoutCancellationException) && ((TimeoutCancellationException) th2).coroutine == scopeCoroutine) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation2 instanceof CoroutineStackFrame)) {
                    recoverFromStackFrame = StackTraceRecoveryKt.recoverFromStackFrame(th2, (CoroutineStackFrame) continuation2);
                    throw recoverFromStackFrame;
                }
                throw th2;
            }
