...
public class LockFreeLinkedListNode {
    ...
    public static abstract class CondAddOp extends AtomicOp<LockFreeLinkedListNode> {
        ...
        public void complete(LockFreeLinkedListNode lockFreeLinkedListNode, Object obj) {
            ...
            if (lockFreeLinkedListNode2 != null && n3.y(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, lockFreeLinkedListNode2) && z2) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0042, code lost:
        if (r.n3.y(r4, r3, r2, ((kotlinx.coroutines.internal.Removed) r5).ref) != false) goto L23;
     */
    /*
    ...
    */
    ...
    public final void finishAdd(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        } while (!n3.y(_prev$FU, lockFreeLinkedListNode, lockFreeLinkedListNode2, this));
        if (isRemoved()) {
    ...
    public final boolean addOneIfEmpty(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        while (getNext() == this) {
            if (n3.y(_next$FU, this, this, lockFreeLinkedListNode)) {
    ...
    public final LockFreeLinkedListNode getPrevNode() {
        ...
        if (correctPrev == null) {
            return findPrevNonRemoved((LockFreeLinkedListNode) _prev$FU.get(this));
        }
        return correctPrev;
    }
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        } while (!n3.y(_next$FU, this, next, lockFreeLinkedListNode.removed()));
        lockFreeLinkedListNode.correctPrev(null);
        return null;
    }
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2, CondAddOp condAddOp) {
        ...
        if (!n3.y(atomicReferenceFieldUpdater, this, lockFreeLinkedListNode2, condAddOp)) {
            return 0;
        }
