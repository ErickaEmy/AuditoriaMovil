...
public final class ChannelSegment<E> extends Segment<ChannelSegment<E>> {
    ...
    public ChannelSegment(long j2, ChannelSegment<E> channelSegment, BufferedChannel<E> bufferedChannel, int i) {
        super(j2, channelSegment, i);
    ...
    */
    ...
    public final void onCancelledRequest(int i, boolean z2) {
        if (z2) {
    ...
    public final void storeElement$kotlinx_coroutines_core(int i, E e2) {
        setElementLazy(i, e2);
    }
}
