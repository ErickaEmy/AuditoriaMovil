...
public final class ChannelFlowTransformLatest$flowCollect$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public AnonymousClass2(ChannelFlowTransformLatest<T, R> channelFlowTransformLatest, FlowCollector<? super R> flowCollector, T t2, Continuation<? super AnonymousClass2> continuation) {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i != 0) {
                    ...
                    T t2 = this.$value;
                    this.label = 1;
                    if (function3.invoke(obj2, t2, this) == coroutine_suspended) {
