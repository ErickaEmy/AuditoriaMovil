...
public class gv extends AutoCompleteTextView {

    /* renamed from: fb  reason: collision with root package name */
    public static final int[] f14721fb = {16843126};

    /* renamed from: v  reason: collision with root package name */
    public final z f14722v;
    public final v y;
    ...
    public gv(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        x.y(this, getContext());
        hw x42 = hw.x4(getContext(), attributeSet, f14721fb, i, 0);
        if (x42.co(0)) {
