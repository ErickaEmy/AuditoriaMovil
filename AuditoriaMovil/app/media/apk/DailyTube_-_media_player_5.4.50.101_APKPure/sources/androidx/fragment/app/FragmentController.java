...
public class FragmentController {
    ...
    public static FragmentController createController(@NonNull FragmentHostCallback<?> fragmentHostCallback) {
        return new FragmentController((FragmentHostCallback) s.s(fragmentHostCallback, "callbacks == null"));
    }
    ...
    @Nullable
    @Deprecated
    public z.s<String, y> retainLoaderNonConfig() {
        return null;
    }
    ...
    @Deprecated
    public void restoreLoaderNonConfig(@SuppressLint({"UnknownNullness"}) z.s<String, y> sVar) {
    }
}
