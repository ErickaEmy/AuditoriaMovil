...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if ("fragment".equals(str)) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f2550gv);
            if (attributeValue == null) {
                attributeValue = obtainStyledAttributes.getString(R$styleable.f2555v);
            }
            int resourceId = obtainStyledAttributes.getResourceId(R$styleable.f2546a, -1);
            String string = obtainStyledAttributes.getString(R$styleable.f2549fb);
