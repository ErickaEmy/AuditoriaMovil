...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public DialogFragment() {
        ...
        this.mBackStackId = -1;
        this.mObserver = new fh<co>() { // from class: androidx.fragment.app.DialogFragment.4
            @Override // y5.fh
            @SuppressLint({"SyntheticAccessor"})
            public void onChanged(co coVar) {
                if (coVar == null || !DialogFragment.this.mShowsDialog) {
                    return;
                }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        getViewLifecycleOwnerLiveData().c5(this.mObserver);
        if (!this.mShownByMe) {
    ...
    public void onDetach() {
        ...
        getViewLifecycleOwnerLiveData().tl(this.mObserver);
    }
