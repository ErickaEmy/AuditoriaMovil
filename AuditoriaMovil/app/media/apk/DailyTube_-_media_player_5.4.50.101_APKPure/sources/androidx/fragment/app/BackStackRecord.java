...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    */
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i5) {
        super.doAddOp(i, fragment, str, i5);
                ...
                if (i5 != 2) {
                    if (i5 != 3 && i5 != 6) {
                        ...
                        if (fragment3 == fragment2) {
                            this.mOps.add(i, new FragmentTransaction.Op(9, fragment3));
                            i++;
                            fragment2 = null;
                        }
                    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull v.zn znVar) {
        if (fragment.mFragmentManager == this.mManager) {
            ...
            } else if (znVar != v.zn.DESTROYED) {
                return super.setMaxLifecycle(fragment, znVar);
            } else {
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i5) {
        if (i5 == i) {
            return false;
        }
        int size = this.mOps.size();
        ...
        for (int i8 = 0; i8 < size; i8++) {
            Fragment fragment = this.mOps.get(i8).mFragment;
            ...
            if (i10 != 0 && i10 != i6) {
                for (int i11 = i; i11 < i5; i11++) {
                    ...
                    for (int i12 = 0; i12 < size2; i12++) {
                        Fragment fragment2 = backStackRecord.mOps.get(i12).mFragment;
