...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, co, k5, gv, y {
    ...
    androidx.savedstate.y mSavedStateRegistryController;
    @Nullable
    ...
    d0<co> mViewLifecycleOwnerLiveData;
    @NonNull
    String mWho;
    ...
    public static class AnimationInfo {
        ...
        tl mEnterTransitionCallback;
        boolean mEnterTransitionPostponed;
        int mExitAnim;
        Object mExitTransition;
        tl mExitTransitionCallback;
        View mFocusedView;
    ...
    public Fragment() {
        ...
        this.mMaxState = v.zn.RESUMED;
        this.mViewLifecycleOwnerLiveData = new d0<>();
    ...
    private int getMinimumMaxLifecycleState() {
        v.zn znVar = this.mMaxState;
        if (znVar != v.zn.INITIALIZED && this.mParentFragment != null) {
            return Math.min(znVar.ordinal(), this.mParentFragment.getMinimumMaxLifecycleState());
        }
        return znVar.ordinal();
    }
    ...
    @NonNull
    private <I, O> n3<I> prepareCallInternal(@NonNull final fb.y<I, O> yVar, @NonNull final p.y<Void, ActivityResultRegistry> yVar2, @NonNull final a.y<O> yVar3) {
        if (this.mState <= 1) {
            ...
            registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.8
                ...
                public void onPreAttached() {
                    atomicReference.set(((ActivityResultRegistry) yVar2.apply(null)).i9(Fragment.this.generateActivityResultKey(), Fragment.this, yVar, yVar3));
                }
            });
            return new n3<I>() { // from class: androidx.fragment.app.Fragment.9
                @Override // a.n3
                @NonNull
                ...
                @Override // a.n3
                public void launch(I i, @Nullable zn znVar) {
                    n3 n3Var = (n3) atomicReference.get();
                    if (n3Var != null) {
                        n3Var.launch(i, znVar);
                        return;
                    }
                ...
                public void unregister() {
                    n3 n3Var = (n3) atomicReference.getAndSet(null);
                    if (n3Var != null) {
                        n3Var.unregister();
                    }
                }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        if (getContext() != null) {
            xg.y.n3(this).y(str, fileDescriptor, printWriter, strArr);
        }
        printWriter.print(str);
    ...
    public tl getEnterTransitionCallback() {
        AnimationInfo animationInfo = this.mAnimationInfo;
        if (animationInfo == null) {
            return null;
        }
    ...
    public tl getExitTransitionCallback() {
        AnimationInfo animationInfo = this.mAnimationInfo;
        if (animationInfo == null) {
            return null;
        }
    ...
    @NonNull
    public co getViewLifecycleOwner() {
    ...
    @NonNull
    public LiveData<co> getViewLifecycleOwnerLiveData() {
    ...
    public b getViewModelStore() {
        if (this.mFragmentManager != null) {
            if (getMinimumMaxLifecycleState() != v.zn.INITIALIZED.ordinal()) {
    ...
    @Nullable
    public Animation onCreateAnimation(int i, boolean z2, int i5) {
        return null;
    }

    @Nullable
    public Animator onCreateAnimator(int i, boolean z2, int i5) {
        return null;
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        this.mState = 1;
        this.mCalled = false;
        this.mLifecycleRegistry.y(new a() { // from class: androidx.fragment.app.Fragment.5
            @Override // androidx.lifecycle.a
            public void onStateChanged(@NonNull co coVar, @NonNull v.n3 n3Var) {
                View view;
                if (n3Var == v.n3.ON_STOP && (view = Fragment.this.mView) != null) {
        ...
        if (this.mCalled) {
            this.mLifecycleRegistry.s(v.n3.ON_CREATE);
            return;
        }
    ...
    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (onCreateView != null) {
            ...
            yt.n3(this.mView, this.mViewLifecycleOwner);
            vl.y(this.mView, this.mViewLifecycleOwner);
            g.n3.y(this.mView, this.mViewLifecycleOwner);
            this.mViewLifecycleOwnerLiveData.xc(this.mViewLifecycleOwner);
    ...
    public void performDestroy() {
        ...
        this.mLifecycleRegistry.s(v.n3.ON_DESTROY);
        this.mState = 0;
        this.mCalled = false;
    ...
    public void performDestroyView() {
        ...
        if (this.mView != null && this.mViewLifecycleOwner.getLifecycle().n3().y(v.zn.CREATED)) {
            this.mViewLifecycleOwner.handleLifecycleEvent(v.n3.ON_DESTROY);
        }
        this.mState = 1;
        this.mCalled = false;
        onDestroyView();
    ...
    public void performPause() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleOwner.handleLifecycleEvent(v.n3.ON_PAUSE);
        }
        this.mLifecycleRegistry.s(v.n3.ON_PAUSE);
        this.mState = 6;
        this.mCalled = false;
        onPause();
        if (this.mCalled) {
    ...
    public void performResume() {
        ...
        onResume();
        if (this.mCalled) {
            fb fbVar = this.mLifecycleRegistry;
            v.n3 n3Var = v.n3.ON_RESUME;
            fbVar.s(n3Var);
            if (this.mView != null) {
                this.mViewLifecycleOwner.handleLifecycleEvent(n3Var);
            }
    ...
    public void performStop() {
        ...
        if (this.mView != null) {
            this.mViewLifecycleOwner.handleLifecycleEvent(v.n3.ON_STOP);
        }
        this.mLifecycleRegistry.s(v.n3.ON_STOP);
        this.mState = 4;
        this.mCalled = false;
        onStop();
        if (this.mCalled) {
    ...
    @NonNull
    public final <I, O> n3<I> registerForActivityResult(@NonNull fb.y<I, O> yVar, @NonNull a.y<O> yVar2) {
        return prepareCallInternal(yVar, new p.y<Void, ActivityResultRegistry>() { // from class: androidx.fragment.app.Fragment.6
            @Override // p.y
            public ActivityResultRegistry apply(Void r3) {
                Fragment fragment = Fragment.this;
                FragmentHostCallback<?> fragmentHostCallback = fragment.mHost;
                if (fragmentHostCallback instanceof a.zn) {
                    return ((a.zn) fragmentHostCallback).getActivityResultRegistry();
                }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (this.mCalled) {
            if (this.mView != null) {
                this.mViewLifecycleOwner.handleLifecycleEvent(v.n3.ON_CREATE);
                return;
            }
            return;
        }
    ...
    public void setAnimations(int i, int i5, int i6, int i8) {
        ...
        ensureAnimationInfo().mExitAnim = i5;
        ensureAnimationInfo().mPopEnterAnim = i6;
    ...
    public void setPostOnViewCreatedAlpha(float f4) {
        ensureAnimationInfo().mPostOnViewCreatedAlpha = f4;
    }
    ...
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i, @Nullable Intent intent, int i5, int i6, int i8, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost != null) {
            FragmentManager.isLoggingEnabled(2);
            getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i, intent, i5, i6, i8, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
    ...
    @NonNull
    public final <I, O> n3<I> registerForActivityResult(@NonNull fb.y<I, O> yVar, @NonNull final ActivityResultRegistry activityResultRegistry, @NonNull a.y<O> yVar2) {
        return prepareCallInternal(yVar, new p.y<Void, ActivityResultRegistry>() { // from class: androidx.fragment.app.Fragment.7
            @Override // p.y
    ...
    public LayoutInflater getLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (fragmentHostCallback != null) {
            ...
            hw.fb.y(onGetLayoutInflater, this.mChildFragmentManager.getLayoutInflaterFactory());
            return onGetLayoutInflater;
        }
