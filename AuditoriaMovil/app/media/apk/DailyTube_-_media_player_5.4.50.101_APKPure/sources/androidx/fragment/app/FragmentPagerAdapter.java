...
public abstract class FragmentPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup viewGroup, int i) {
        ...
        if (findFragmentByTag != this.mCurrentPrimaryItem) {
            ...
            if (this.mBehavior == 1) {
                this.mCurTransaction.setMaxLifecycle(findFragmentByTag, v.zn.STARTED);
            } else {
        ...
        if (fragment != fragment2) {
            if (fragment2 != null) {
                ...
                if (this.mBehavior == 1) {
                    ...
                    this.mCurTransaction.setMaxLifecycle(this.mCurrentPrimaryItem, v.zn.STARTED);
                } else {
            ...
            if (this.mBehavior == 1) {
                ...
                this.mCurTransaction.setMaxLifecycle(fragment, v.zn.RESUMED);
            } else {
