...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.fragment.app.ListFragment.2
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j2) {
            ListFragment.this.onListItemClick((ListView) adapterView, view, i, j2);
        }
    };
    ...
    public void onListItemClick(@NonNull ListView listView, @NonNull View view, int i, long j2) {
    }
