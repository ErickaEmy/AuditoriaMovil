...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    @Deprecated
    public void onStartIntentSenderFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i, @Nullable Intent intent, int i5, int i6, int i8, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i == -1) {
            n3.rz(this.mActivity, intentSender, i, intent, i5, i6, i8, bundle);
            return;
        }
    ...
    public void onStartActivityFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) Intent intent, int i, @Nullable Bundle bundle) {
        if (i == -1) {
            y.xc(this.mContext, intent, bundle);
            return;
        }
    ...
    public FragmentHostCallback(@Nullable Activity activity, @NonNull Context context, @NonNull Handler handler, int i) {
        ...
        this.mContext = (Context) s.s(context, "context == null");
        this.mHandler = (Handler) s.s(handler, "handler == null");
