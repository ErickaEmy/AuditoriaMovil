...
public abstract class FragmentTransitionImpl {
        ...
        for (int i = size; i < list.size(); i++) {
            ...
            if (view2 instanceof ViewGroup) {
                ...
                for (int i5 = 0; i5 < childCount; i5++) {
                    ...
                    if (!containedBeforeIndex(list, childAt, size) && i4.yt(childAt) != null) {
                        list.add(childAt);
                    }
                }
            }
    ...
    public void scheduleNameReset(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        co.y(viewGroup, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.3
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
                    View view = (View) arrayList.get(i);
                    i4.gq(view, (String) map.get(i4.yt(view)));
                }
            }
        });
    }
    ...
    public void setNameOverridesOrdered(View view, final ArrayList<View> arrayList, final Map<String, String> map) {
        co.y(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.2
            @Override // java.lang.Runnable
            public void run() {
                int size = arrayList.size();
                for (int i = 0; i < size; i++) {
                    View view2 = (View) arrayList.get(i);
                    String yt2 = i4.yt(view2);
                    if (yt2 != null) {
                        i4.gq(view2, FragmentTransitionImpl.findKeyForValue(map, yt2));
                    }
                }
            }
        });
    ...
    public void setNameOverridesReordered(View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (yt2 != null) {
                i4.gq(view2, null);
                String str = map.get(yt2);
                int i5 = 0;
                while (true) {
                    if (i5 >= size) {
                        break;
                    } else if (str.equals(arrayList3.get(i5))) {
                        i4.gq(arrayList2.get(i5), yt2);
                        break;
                    } else {
                        i5++;
                    }
        ...
        co.y(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.1
            @Override // java.lang.Runnable
            public void run() {
                for (int i6 = 0; i6 < size; i6++) {
                    i4.gq((View) arrayList2.get(i6), (String) arrayList3.get(i6));
                    i4.gq((View) arrayList.get(i6), (String) arrayList4.get(i6));
                }
            }
        });
    }
