    ...
    public static int fh(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return fh(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }

    public final void d0(View view, int i, int i5, int i6, int i8) {
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.LinearLayoutCompat$y r15 = (androidx.appcompat.widget.LinearLayoutCompat.y) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = hw.i4.ta(r17)
            int r2 = hw.v.n3(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
    ...
    public final boolean rz(int i, int i5) {
        int i6;
        int i8;
        int i10;
        int i11;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == R$id.f744hw) {
                    view = childAt;
                } else if (id == R$id.f739f) {
                    view2 = childAt;
                } else if ((id != R$id.f758tl && id != R$id.f766xc) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            i8 = fh(view2);
            i10 = view2.getMeasuredHeight() - i8;
            paddingTop += i8;
        ...
        setMeasuredDimension(View.resolveSizeAndState(i15 + getPaddingLeft() + getPaddingRight(), i, i6), View.resolveSizeAndState(paddingTop, i5, 0));
        if (mode2 != 1073741824) {
            t(childCount, i5);
            return true;
        }
    ...
    public final void t(int i, int i5) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            ...
            if (childAt.getVisibility() != 8) {
                LinearLayoutCompat.y yVar = (LinearLayoutCompat.y) childAt.getLayoutParams();
                if (((LinearLayout.LayoutParams) yVar).width == -1) {
                    int i8 = ((LinearLayout.LayoutParams) yVar).height;
                    ((LinearLayout.LayoutParams) yVar).height = childAt.getMeasuredHeight();
