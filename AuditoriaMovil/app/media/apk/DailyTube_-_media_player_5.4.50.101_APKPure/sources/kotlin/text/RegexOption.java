...
public final class RegexOption {
    ...
    public static final RegexOption CANON_EQ = new RegexOption("CANON_EQ", 6, NotificationCompat.FLAG_HIGH_PRIORITY, 0, 2, null);
    ...
    private RegexOption(String str, int i, int i5, int i6) {
        this.value = i5;
        this.mask = i6;
    }
    ...
    public /* synthetic */ RegexOption(String str, int i, int i5, int i6, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i, i5, (i8 & 2) != 0 ? i5 : i6);
    }
}
