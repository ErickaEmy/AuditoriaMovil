...
public enum J5 {
    ...
    A06(A01(431, 15, 117)),
    A08(A01(457, 5, 6)),
    A0P(A01(680, 14, R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)),
    A0D(A01(490, 10, 22)),
    A0N(A01(635, 25, R.styleable.AppCompatTheme_toolbarStyle)),
    A0O(A01(660, 20, 107)),
    A0F(A01(512, 37, 57)),
    A0E(A01(500, 12, 14)),
    A0Q(A01(694, 5, 109)),
    ...
    A04(A01(790, 5, 30)),
    A0M(A01(617, 18, 15)),
    A05(A01(401, 12, R.styleable.AppCompatTheme_textAppearancePopupMenuHeader)),
    A07(A01(446, 11, 118)),
    A0T(A01(729, 15, 32)),
    A0U(A01(714, 15, 4)),
    A0R(A01(699, 11, 73)),
    A09(A01(413, 18, R.styleable.AppCompatTheme_textColorAlertDialogListItem)),
    A0X(A01(769, 21, 25)),
    A0C(A01(755, 9, R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)),
    A0L(A01(601, 16, 96)),
    A0B(A01(467, 23, 54)),
    A0I(A01(570, 6, 97)),
    A0A(A01(462, 5, 24)),
    ...
    public static J5 A00(String str) {
        J5[] values;
        for (J5 j52 : values()) {
            if (j52.A00.equalsIgnoreCase(str)) {
                return j52;
            }
        }
        String[] strArr = A02;
