...
public abstract class AbstractC1262bm implements C0B {
    ...
    public abstract boolean A08(File file, long j2, int i);

    static {
        A04();
        A03 = AbstractC1262bm.class.getSimpleName();
    }
    ...
    public void AGh(final File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC1262bm.this.A06(this.A00);
                return null;
            }
        });
    }
