...
public abstract class NY extends WebView {
    ...
    public NY(Activity activity, C1116Yn c1116Yn) {
        super(activity);
        A03(c1116Yn);
    }

    public NY(C1116Yn c1116Yn) {
        super(c1116Yn);
        A03(c1116Yn);
    }
    ...
    private void A03(C04447f c04447f) {
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        AbstractC0825Ne.A04(this);
        ...
        if (c04447f.A04().A8z() && Build.VERSION.SDK_INT >= 19) {
