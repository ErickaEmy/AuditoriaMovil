...
public abstract class AbstractC1267br {
    ...
    public static final <T> void A02(Appendable appendable, T t2, GV<? super T, ? extends CharSequence> gv2) {
        C1270bu.A07(appendable, A00(0, 6, 6));
        if (gv2 != null) {
            appendable.append(gv2.A8v(t2));
            return;
        }
