...
public final class RE {
    ...
    */
    public static int A08(java.util.Vector<android.graphics.Rect> r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.RE.A08(java.util.Vector):int");
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static RF A0E(View view, int i, C1116Yn c1116Yn) {
        if (view == null) {
            A0N(null, false, A0H(353, 16, 31));
            return new RF(C0Q.A08);
        }
        boolean A2H = C0705Ih.A2H(c1116Yn);
        String A0H2 = A0H(415, 37, R.styleable.AppCompatTheme_toolbarStyle);
            ...
            if (A0H[4].charAt(15) == 'A') {
                ...
                try {
                    ...
                    if (A0H[1].length() == 16) {
                        ...
                        if (i5 >= 17) {
                            ((WindowManager) c1116Yn.getSystemService(A0H(594, 6, 109))).getDefaultDisplay().getRealMetrics(new DisplayMetrics());
                        } else {
                            Resources resources = c1116Yn.getResources();
                            if (A0H[5].length() != 11) {
    ...
    public static String A0H(int i, int i5, int i6) {
    ...
    public RE(View view, int i, int i5, boolean z2, WeakReference<RD> weakReference, C1116Yn c1116Yn) {
    ...
    public RE(View view, int i, WeakReference<RD> weakReference, C1116Yn c1116Yn) {
        this(view, i, 0, false, weakReference, c1116Yn);
    }

    public RE(View view, int i, boolean z2, WeakReference<RD> weakReference, C1116Yn c1116Yn) {
        this(view, i, 0, z2, weakReference, c1116Yn);
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
            ...
            boolean z2 = true;
            int childIndex = !(childAt instanceof C0896Px);
    ...
    public static void A0N(View view, boolean z2, String str) {
        if (BuildConfigApi.isDebug()) {
            String str2 = A0H(240, 5, R.styleable.AppCompatTheme_textColorAlertDialogListItem) + view + A0H(9, 4, 108) + (z2 ? A0H(579, 8, 81) : A0H(565, 12, 121)) + A0H(13, 14, 76) + str;
        }
    }
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        hashMap.put(A0H(592, 2, 68), C0774Lf.A05(this.A03));
