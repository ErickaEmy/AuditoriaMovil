...
public class C04356v<E> extends AbstractC04346u<E>.IteratorImpl implements ListIterator<E> {
    public static byte[] A01;
    public final /* synthetic */ AbstractC04346u<E> A00;
    ...
    public C04356v(AbstractC04346u abstractC04346u, int i) {
        super(abstractC04346u);
        this.A00 = abstractC04346u;
        AbstractC04346u.A02.A04(i, abstractC04346u.size());
        A05(i);
    }
    ...
    public final E previous() {
        if (hasPrevious()) {
            AbstractC04346u<E> abstractC04346u = this.A00;
            A05(A04() - 1);
            return abstractC04346u.get(A04());
        }
