...
public final class C04547t {
    ...
    public C04547t(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
        options.remove(null);
        this.A00 = num;
        this.A01 = num2;
    ...
    public C04547t(String[] strArr, Integer num, Integer num2) {
    ...
    public static C04547t A00(String str) {
        if (str == null) {
            return null;
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        ...
        return new C04547t(linkedHashSet, num, num2, str);
    }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof C04547t) {
            C04547t c04547t = (C04547t) obj;
            ...
            A06[0] = "YHhc40Na8nm";
            Integer num2 = c04547t.A00;
            if (num == num2 || (num != null && num.equals(num2))) {
                Integer num3 = this.A01;
                Integer num4 = c04547t.A01;
                return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c04547t.A03);
            }
            return false;
        }
        return false;
