...
public final class C1P implements Serializable {
    ...
    public C1P(int i, int i5, int i6, int i8, int i10, int i11, int i12, int i13, int i14) {
        this.A00 = i;
        this.A01 = i5;
        this.A02 = i6;
        this.A03 = i8;
    ...
    public static C1P A01(JSONObject jSONObject) {
        return new C1P(A00(jSONObject, A02(37, 12, 6), A0A), A00(jSONObject, A02(57, 10, 7), A0B), A00(jSONObject, A02(135, 14, 4), -16777216), A00(jSONObject, A02(49, 8, 80), A0C), A00(jSONObject, A02(67, 9, 50), A0D), A00(jSONObject, A02(76, 20, 86), -1), A00(jSONObject, A02(96, 14, 62), -1), A00(jSONObject, A02(R.styleable.AppCompatTheme_textColorAlertDialogListItem, 25, 32), A0F), A00(jSONObject, A02(149, 11, 123), -16777216));
    }
