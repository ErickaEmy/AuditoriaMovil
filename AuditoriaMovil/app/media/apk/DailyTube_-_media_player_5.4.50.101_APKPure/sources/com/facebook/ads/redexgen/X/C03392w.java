...
public final class C03392w<K, V> implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    ...
    public int A00;
    public final /* synthetic */ AbstractC03412y A03;
    ...
    public C03392w(AbstractC03412y abstractC03412y) {
        this.A03 = abstractC03412y;
        this.A00 = abstractC03412y.A04() - 1;
    }
    ...
    public final boolean equals(Object obj) {
        if (this.A02) {
            if (obj instanceof Map.Entry) {
                ...
                return AbstractC03342r.A04(entry.getKey(), this.A03.A0B(this.A01, 0)) && AbstractC03342r.A04(entry.getValue(), this.A03.A0B(this.A01, 1));
            }
            return false;
        }
    ...
    public final String toString() {
        return getKey() + A01(0, 1, R.styleable.AppCompatTheme_tooltipFrameBackground) + getValue();
    }
}
