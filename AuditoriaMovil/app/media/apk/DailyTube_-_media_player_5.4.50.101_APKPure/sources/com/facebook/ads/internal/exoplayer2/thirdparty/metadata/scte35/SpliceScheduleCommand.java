...
import com.facebook.ads.redexgen.X.C0594Ds;
...
public final class SpliceScheduleCommand extends SpliceCommand {
    ...
    public static final Parcelable.Creator<SpliceScheduleCommand> CREATOR = new C0594Ds();
    ...
    public /* synthetic */ SpliceScheduleCommand(Parcel parcel, C0594Ds c0594Ds) {
        this(parcel);
    }
    ...
    public static SpliceScheduleCommand A00(C0697Hz c0697Hz) {
        int A0E = c0697Hz.A0E();
        ArrayList arrayList = new ArrayList(A0E);
        for (int i = 0; i < A0E; i++) {
            Du A03 = Du.A03(c0697Hz);
