...
public final class JZ {
    ...
    public final int A02 = R.styleable.AppCompatTheme_textAppearancePopupMenuHeader;
    public final int A04 = 107;
    public final int A05 = 108;
    public final int A06 = 109;
    public final int A01 = R.styleable.AppCompatTheme_textColorAlertDialogListItem;
    public final boolean A0E = false;
    public long A00 = -1;
    public final List<JY> A0D = new LinkedList();

    public JZ(C04447f c04447f, JX jx) {
        int nativeViewabilityHistorySamplingRate = Ij.A0D(c04447f);
        if (nativeViewabilityHistorySamplingRate < 1) {
            this.A0F = false;
        } else {
            this.A0F = c04447f.A08().A00() < 1.0d / ((double) nativeViewabilityHistorySamplingRate);
        }
        this.A0B = jx;
    }
    ...
    public final void A04() {
        ...
        A03(new JY(A01(), R.styleable.AppCompatTheme_textColorAlertDialogListItem, A00(), null));
    }
    ...
    public final void A05() {
        ...
        A03(new JY(A01(), R.styleable.AppCompatTheme_textAppearancePopupMenuHeader, A00(), null));
    }
    ...
    public final void A0C(C04447f c04447f, String str) {
        if (!this.A0F) {
            return;
        }
        A03(new JY(A01(), 103, A00(), null));
        ExecutorC0788Lt.A06.execute(new JW(this, str, c04447f));
    }
}
