...
public class GoogleApiAvailabilityLight {
    ...
    @Nullable
    @KeepForSdk
    public PendingIntent getErrorResolutionPendingIntent(@NonNull Context context, int i, int i5) {
        return getErrorResolutionPendingIntent(context, i, i5, null);
    }
    ...
    public Intent getErrorResolutionIntent(@Nullable Context context, int i, @Nullable String str) {
        if (i != 1 && i != 2) {
            ...
            Uri fromParts = Uri.fromParts("package", GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_PACKAGE, null);
            ...
            Uri.Builder appendQueryParameter = Uri.parse("market://details").buildUpon().appendQueryParameter("id", GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_PACKAGE);
    ...
    @ShowFirstParty
    @KeepForSdk
    public PendingIntent getErrorResolutionPendingIntent(@NonNull Context context, int i, int i5, @Nullable String str) {
