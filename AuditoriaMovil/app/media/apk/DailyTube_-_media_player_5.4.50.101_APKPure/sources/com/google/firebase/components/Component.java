...
public final class Component<T> {
    ...
    public static class Builder<T> {
        ...
        private Builder<T> setInstantiation(int i) {
            ...
            Preconditions.checkState(z2, "Instantiation type has already been set.");
        ...
        public Component<T> build() {
            ...
            Preconditions.checkState(z2, "Missing required property: factory.");
    ...
    public static <T> Component<T> intoSet(T t2, Class<T> cls) {
        return intoSetBuilder(cls).factory(Component$$Lambda$3.lambdaFactory$(t2)).build();
    }
    ...
    public static <T> Component<T> of(Class<T> cls, T t2) {
        return builder(cls).factory(Component$$Lambda$1.lambdaFactory$(t2)).build();
    }
    ...
    private Component(Set<Class<? super T>> set, Set<Dependency> set2, int i, int i5, ComponentFactory<T> componentFactory, Set<Class<?>> set3) {
    ...
    public static <T> Component<T> of(T t2, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(Component$$Lambda$2.lambdaFactory$(t2)).build();
    }
}
