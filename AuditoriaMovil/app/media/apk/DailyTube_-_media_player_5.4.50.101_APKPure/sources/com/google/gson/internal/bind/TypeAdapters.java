...
public final class TypeAdapters {
    ...
    public static /* synthetic */ class AnonymousClass36 {
        ...
        static {
            ...
            try {
                y[JsonToken.NULL.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                y[JsonToken.BEGIN_ARRAY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                y[JsonToken.BEGIN_OBJECT.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                y[JsonToken.END_DOCUMENT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                y[JsonToken.NAME.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                y[JsonToken.END_OBJECT.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                y[JsonToken.END_ARRAY.ordinal()] = 10;
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        public final Map<String, T> y = new HashMap();

        /* renamed from: n3  reason: collision with root package name */
        public final Map<T, String> f6273n3 = new HashMap();
        ...
        public T read(JsonReader jsonReader) throws IOException {
            ...
            return this.y.get(jsonReader.nextString());
        }

        public void write(JsonWriter jsonWriter, T t2) throws IOException {
            jsonWriter.value(t2 == null ? null : this.f6273n3.get(t2));
        }
    }
    ...
    static {
            ...
            */
            public java.util.BitSet read(com.google.gson.stream.JsonReader r8) throws java.io.IOException {
                ...
                Le:
                    ...
                    if (r1 == r4) goto L75
                    int[] r4 = com.google.gson.internal.bind.TypeAdapters.AnonymousClass36.y
                    int r5 = r1.ordinal()
                    r4 = r4[r5]
                    r5 = 1
                    if (r4 == r5) goto L63
        ...
        TypeAdapter<Number> typeAdapter5 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                JsonToken peek = jsonReader.peek();
                int i = AnonymousClass36.y[peek.ordinal()];
                if (i == 1 || i == 3) {
        ...
        TypeAdapter<Calendar> typeAdapter14 = new TypeAdapter<Calendar>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public Calendar read(JsonReader jsonReader) throws IOException {
                ...
                return new GregorianCalendar(i, i5, i6, i8, i10, i11);
            }
        ...
        TypeAdapter<JsonElement> typeAdapter16 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.29
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                switch (AnonymousClass36.y[jsonReader.peek().ordinal()]) {
                    case 1:
