...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i, int i5) throws InvalidProtocolBufferException;

    MessageType parseFrom(byte[] bArr, int i, int i5, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
    ...
    MessageType parsePartialFrom(byte[] bArr, int i, int i5) throws InvalidProtocolBufferException;

    MessageType parsePartialFrom(byte[] bArr, int i, int i5, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
