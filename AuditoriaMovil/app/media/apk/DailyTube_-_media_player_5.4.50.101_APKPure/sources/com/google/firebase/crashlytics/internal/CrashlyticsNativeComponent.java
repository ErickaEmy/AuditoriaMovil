...
public interface CrashlyticsNativeComponent {
    ...
    void writeSessionDevice(@NonNull String str, int i, @NonNull String str2, int i5, long j2, long j4, boolean z2, int i6, @NonNull String str3, @NonNull String str4);

    void writeSessionOs(@NonNull String str, @NonNull String str2, @NonNull String str3, boolean z2);
}
