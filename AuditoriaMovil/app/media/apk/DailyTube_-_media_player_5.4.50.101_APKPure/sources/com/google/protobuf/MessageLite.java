...
public interface MessageLite extends MessageLiteOrBuilder {
    ...
    public interface Builder extends MessageLiteOrBuilder, Cloneable {
        ...
        @CanIgnoreReturnValue
        Builder mergeFrom(byte[] bArr, int i, int i5) throws InvalidProtocolBufferException;

        @CanIgnoreReturnValue
        Builder mergeFrom(byte[] bArr, int i, int i5, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
