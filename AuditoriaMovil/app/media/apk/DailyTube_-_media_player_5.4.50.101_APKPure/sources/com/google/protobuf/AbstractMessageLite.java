...
public abstract class AbstractMessageLite<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite {
    ...
    public static abstract class Builder<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite.Builder {
        ...
        public static final class LimitedInputStream extends FilterInputStream {
            ...
            public long skip(long j2) throws IOException {
                int skip = (int) super.skip(Math.min(j2, this.y));
                if (skip >= 0) {
                    this.y -= skip;
                }
                return skip;
    ...
    public void writeDelimitedTo(OutputStream outputStream) throws IOException {
        ...
        CodedOutputStream newInstance = CodedOutputStream.newInstance(outputStream, CodedOutputStream.fb(CodedOutputStream.computeUInt32SizeNoTag(serializedSize) + serializedSize));
    ...
    public void writeTo(OutputStream outputStream) throws IOException {
        CodedOutputStream newInstance = CodedOutputStream.newInstance(outputStream, CodedOutputStream.fb(getSerializedSize()));
        writeTo(newInstance);
        newInstance.flush();
    }
