...
public final class SqlDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public final DateFormat y = new SimpleDateFormat("MMM d, yyyy");
    ...
    public synchronized Date read(JsonReader jsonReader) throws IOException {
        ...
        try {
            return new Date(this.y.parse(jsonReader.nextString()).getTime());
    ...
    public synchronized void write(JsonWriter jsonWriter, Date date) throws IOException {
        jsonWriter.value(date == null ? null : this.y.format((java.util.Date) date));
    }
}
