...
public class ConnectionTracker {
    ...
    private final boolean zzc(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i, boolean z2, Executor executor) {
        ComponentName component = intent.getComponent();
        if (component != null) {
            String packageName = component.getPackageName();
            GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_PACKAGE.equals(packageName);
            try {
