...
public final class FieldType {
    ...
    public static final /* synthetic */ FieldType[] f6430fb;

    /* renamed from: v  reason: collision with root package name */
    public static final Type[] f6431v;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        public static final /* synthetic */ int[] f6432n3;
        ...
        static {
            ...
            try {
                f6432n3[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f6432n3[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                y[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                y[Collection.SCALAR.ordinal()] = 3;
    ...
    public FieldType(String str, int i, int i5, Collection collection, JavaType javaType) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i6 = AnonymousClass1.f6432n3[javaType.ordinal()]) == 1 || i6 == 2 || i6 == 3) ? false : false;
    }

    public static FieldType forId(int i) {
        if (i >= 0) {
            FieldType[] fieldTypeArr = y;
    ...
    public static Type gv(Class<?> cls, Type[] typeArr) {
        while (true) {
            int i = 0;
            if (cls != List.class) {
                Type y2 = y(cls);
                if (y2 instanceof ParameterizedType) {
                    ParameterizedType parameterizedType = (ParameterizedType) y2;
    ...
    public static FieldType[] values() {
        return (FieldType[]) f6430fb.clone();
    }
    ...
    public final boolean v(Field field) {
        ...
        Type gv2 = gv(type, typeArr);
        if (!(gv2 instanceof Class)) {
            return true;
        }
        return this.elementType.isAssignableFrom((Class) gv2);
    }
}
