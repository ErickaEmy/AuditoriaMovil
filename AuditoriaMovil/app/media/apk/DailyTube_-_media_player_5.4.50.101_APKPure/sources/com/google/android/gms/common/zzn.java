...
public final class zzn {
    ...
    public static zzx zza(String str, zzj zzjVar, boolean z2, boolean z3) {
    ...
    public static /* synthetic */ String zzd(boolean z2, String str, zzj zzjVar) throws Exception {
        String str2;
        if (!z2 && zzh(str, zzjVar, true, false).zza) {
        ...
        return String.format("%s: pkg=%s, sha256=%s, atk=%s, ver=%s", str2, str, Hex.bytesToStringLowercase(zza2.digest(zzjVar.zzf())), Boolean.valueOf(z2), "12451000.false");
    }
    ...
    private static zzx zzh(final String str, final zzj zzjVar, final boolean z2, boolean z3) {
        try {
            ...
            try {
                if (zze.zzh(new zzs(str, zzjVar, z2, z3), ObjectWrapper.wrap(zzg.getPackageManager()))) {
                    return zzx.zzb();
                }
