...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                y[WireFormat.FieldType.FIXED32.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                y[WireFormat.FieldType.BOOL.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                y[WireFormat.FieldType.UINT32.ordinal()] = 9;
            ...
            try {
                y[WireFormat.FieldType.SFIXED64.ordinal()] = 11;
    ...
    public void a(Object obj) {
        zn(obj).makeImmutable();
    }

    @Override // com.google.protobuf.ExtensionSchema
    public void c5(ByteString byteString, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<GeneratedMessageLite.ExtensionDescriptor> fieldSet) throws IOException {
        ...
        fieldSet.setField(generatedExtension.f6444gv, newBuilderForType.buildPartial());
        newCodedInput.checkLastTagWas(0);
    }

    @Override // com.google.protobuf.ExtensionSchema
    public <UT, UB> UB fb(Object obj, Reader reader, Object obj2, ExtensionRegistryLite extensionRegistryLite, FieldSet<GeneratedMessageLite.ExtensionDescriptor> fieldSet, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) throws IOException {
        Object valueOf;
        Object field;
        ArrayList arrayList;
        ...
        if (generatedExtension.f6444gv.isRepeated() && generatedExtension.f6444gv.isPacked()) {
            switch (AnonymousClass1.y[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 14:
                    ...
                    ub = (UB) SchemaUtil.c(obj, number, arrayList, generatedExtension.f6444gv.getEnumType(), ub, unknownFieldSchema);
                    break;
                default:
                    throw new IllegalStateException("Type cannot be packed: " + generatedExtension.f6444gv.getLiteType());
            }
            fieldSet.setField(generatedExtension.f6444gv, arrayList);
        } else {
            if (generatedExtension.getLiteType() == WireFormat.FieldType.ENUM) {
                int readInt32 = reader.readInt32();
                if (generatedExtension.f6444gv.getEnumType().findValueByNumber(readInt32) == null) {
                    return (UB) SchemaUtil.ud(obj, number, readInt32, ub, unknownFieldSchema);
                }
                ...
                switch (AnonymousClass1.y[generatedExtension.getLiteType().ordinal()]) {
                        ...
                        if (!generatedExtension.isRepeated()) {
                            ...
                            if (field2 instanceof GeneratedMessageLite) {
                                ...
                                if (!((GeneratedMessageLite) field2).isMutable()) {
                                    ...
                                    fieldSet.setField(generatedExtension.f6444gv, newInstance);
                                    field2 = newInstance;
                                }
                    ...
                    case 18:
                        if (!generatedExtension.isRepeated()) {
                            Object field3 = fieldSet.getField(generatedExtension.f6444gv);
                            if (field3 instanceof GeneratedMessageLite) {
                                ...
                                if (!((GeneratedMessageLite) field3).isMutable()) {
                                    ...
                                    fieldSet.setField(generatedExtension.f6444gv, newInstance2);
                                    field3 = newInstance2;
                                }
            ...
            if (generatedExtension.isRepeated()) {
                fieldSet.addRepeatedField(generatedExtension.f6444gv, valueOf);
            } else {
                int i = AnonymousClass1.y[generatedExtension.getLiteType().ordinal()];
                if ((i == 17 || i == 18) && (field = fieldSet.getField(generatedExtension.f6444gv)) != null) {
                    valueOf = Internal.gv(field, valueOf);
                }
                fieldSet.setField(generatedExtension.f6444gv, valueOf);
            }
        }
        return ub;
    }
    ...
    @Override // com.google.protobuf.ExtensionSchema
    public FieldSet<GeneratedMessageLite.ExtensionDescriptor> gv(Object obj) {
        return ((GeneratedMessageLite.ExtendableMessage) obj).ensureExtensionsAreMutable();
    }

    @Override // com.google.protobuf.ExtensionSchema
    public void i9(Writer writer, Map.Entry<?, ?> entry) throws IOException {
        GeneratedMessageLite.ExtensionDescriptor extensionDescriptor = (GeneratedMessageLite.ExtensionDescriptor) entry.getKey();
        if (extensionDescriptor.isRepeated()) {
            switch (AnonymousClass1.y[extensionDescriptor.getLiteType().ordinal()]) {
                case 1:
    ...
    @Override // com.google.protobuf.ExtensionSchema
    public Object n3(ExtensionRegistryLite extensionRegistryLite, MessageLite messageLite, int i) {
        return extensionRegistryLite.findLiteExtensionByNumber(messageLite, i);
    }

    @Override // com.google.protobuf.ExtensionSchema
    public void s(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<GeneratedMessageLite.ExtensionDescriptor> fieldSet) throws IOException {
        GeneratedMessageLite.GeneratedExtension generatedExtension = (GeneratedMessageLite.GeneratedExtension) obj;
        fieldSet.setField(generatedExtension.f6444gv, reader.readMessage(generatedExtension.getMessageDefaultInstance().getClass(), extensionRegistryLite));
    }

    @Override // com.google.protobuf.ExtensionSchema
    public boolean v(MessageLite messageLite) {
        return messageLite instanceof GeneratedMessageLite.ExtendableMessage;
    }

    @Override // com.google.protobuf.ExtensionSchema
    public int y(Map.Entry<?, ?> entry) {
        return ((GeneratedMessageLite.ExtensionDescriptor) entry.getKey()).getNumber();
    }

    @Override // com.google.protobuf.ExtensionSchema
    public FieldSet<GeneratedMessageLite.ExtensionDescriptor> zn(Object obj) {
