...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
    ...
    public final TypeAdapter<E> f6221n3;
    public final Class<E> y;

    public ArrayTypeAdapter(Gson gson, TypeAdapter<E> typeAdapter, Class<E> cls) {
        this.f6221n3 = new TypeAdapterRuntimeTypeWrapper(gson, typeAdapter, cls);
        this.y = cls;
    }
    ...
    public Object read(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            arrayList.add(this.f6221n3.read(jsonReader));
        }
        jsonReader.endArray();
    ...
    public void write(JsonWriter jsonWriter, Object obj) throws IOException {
        ...
        for (int i = 0; i < length; i++) {
            this.f6221n3.write(jsonWriter, Array.get(obj, i));
        }
        jsonWriter.endArray();
    }
}
