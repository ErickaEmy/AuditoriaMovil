...
public final class TimeTypeAdapter extends TypeAdapter<Time> {
    ...
    public final DateFormat y = new SimpleDateFormat("hh:mm:ss a");
    ...
    public synchronized Time read(JsonReader jsonReader) throws IOException {
        ...
        try {
            return new Time(this.y.parse(jsonReader.nextString()).getTime());
    ...
    public synchronized void write(JsonWriter jsonWriter, Time time) throws IOException {
        jsonWriter.value(time == null ? null : this.y.format((Date) time));
    }
}
