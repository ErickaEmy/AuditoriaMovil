...
public class AbtExperimentInfo {
    ...
    public AbtExperimentInfo(String str, String str2, String str3, Date date, long j2, long j4) {
        this.experimentId = str;
        this.variantId = str2;
        this.triggerEventName = str3;
        this.experimentStartTime = date;
        this.triggerTimeoutInMillis = j2;
        this.timeToLiveInMillis = j4;
    }
    ...
    public Map<String, String> toStringMap() {
        ...
        hashMap.put("experimentStartTime", protoTimestampStringParser.format(this.experimentStartTime));
        hashMap.put("triggerTimeoutMillis", Long.toString(this.triggerTimeoutInMillis));
